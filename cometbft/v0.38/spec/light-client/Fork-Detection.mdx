---
noindex: true
canonical: 'https://docs.cosmos.network/cometbft/latest/spec/light-client/Fork-Detection'
order: 1
parent:
...
### [detection.md](https://github.com/cometbft/cometbft/blob/v0.38.x/spec/light-client/detection/detection_003_reviewed.md)
...
### [discussions.md](https://github.com/cometbft/cometbft/blob/v0.38.x/spec/light-client/detection/discussions.md)
...
### [req-ibc-detection.md](https://github.com/cometbft/cometbft/blob/v0.38.x/spec/light-client/detection/req-ibc-detection.md)
...
### [draft-functions.md](https://github.com/cometbft/cometbft/blob/v0.38.x/spec/light-client/detection/draft-functions.md)
