---
noindex: true
canonical: 'https://docs.cosmos.network/cometbft/latest/spec/consensus/Creating-Proposal'
...
[relevant part of the spec](/cometbft/v0.38/spec/abci/Methods#prepareproposal)
