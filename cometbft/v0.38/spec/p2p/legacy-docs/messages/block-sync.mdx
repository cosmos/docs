---
noindex: true
canonical: 'https://docs.cosmos.network/cometbft/latest/spec/p2p/legacy-docs/messages/block-sync'
title: Block Sync
order: 2
---
{/* trigger rebuild */}
...
| Name      | Type                                                           | Description                     | Field Number |
|-----------|----------------------------------------------------------------|---------------------------------|--------------|
| Block     | [Block](/cometbft/v0.38/spec/core/Data_structures#block)                   | Requested Block                 | 1            |
| ExtCommit | [ExtendedCommit](/cometbft/v0.38/spec/core/Data_structures#extendedcommit) | Sender's LastCommit information | 2            |
