---
noindex: true
canonical: 'https://docs.cosmos.network/cometbft/latest/spec/p2p/reactor-api/Reactors'
title: Reactors
order: 1
---
...
- [Reactor API](/cometbft/v0.38/spec/p2p/reactor-api/Reactor-Api): documents the [`p2p.Reactor`][reactor-interface]
...
- [P2P API](/cometbft/v0.38/spec/p2p/reactor-api/API-for-Reactors): documents the interface provided by the p2p
