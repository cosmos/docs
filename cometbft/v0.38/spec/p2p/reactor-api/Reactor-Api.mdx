---
noindex: true
canonical: 'https://docs.cosmos.network/cometbft/latest/spec/p2p/reactor-api/Reactor-Api'
title: Reactor API
order: 2
---
...
This specification is accompanied by the [`reactor.qnt`](https://github.com/cometbft/cometbft/blob/v0.38.x/spec/p2p/reactor-api/reactor.qnt) file,
...
with an ABCI++ application, available [here](/cometbft/v0.38/spec/abci/CometBFTs-expected-behavior).
...
documented in the companion [API for Reactors](/cometbft/v0.38/spec/p2p/reactor-api/API-for-Reactors#switch-api) document.
...
The companion [API for Reactors](/cometbft/v0.38/spec/p2p/reactor-api/API-for-Reactors#peer-api) documents the methods
