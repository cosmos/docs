...
and Amnesia. These attacks are exhaustive. You can find a more detailed overview of this [here](../light-client/Accountability.mdx#the-misbehavior-of-faulty-validators)
