---
noindex: true
canonical: 'https://docs.cosmos.network/cometbft/latest/docs/guides/Creating-a-built-in-application-in-Go'
...
If that is the way you wish to proceed, use the [Creating an application in Go](/cometbft/v0.38/docs/guides/Creating-an-application-in-Go) guide instead of this one.
