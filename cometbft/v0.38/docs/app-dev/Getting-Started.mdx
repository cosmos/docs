...
[here](/cometbft/v0.38/docs/guides/Install-CometBFT). If you have never run CometBFT
before, use:
...
details, see [the guide on using CometBFT](/cometbft/v0.38/docs/core/Using-CometBFT).
