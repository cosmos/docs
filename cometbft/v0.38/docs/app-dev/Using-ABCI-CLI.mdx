---
noindex: true
canonical: 'https://docs.cosmos.network/cometbft/latest/docs/app-dev/Using-ABCI-CLI'
...
Running `abci-cli console` should drop you into an interactive console for
...
[getting started guide](/cometbft/v0.38/docs/app-dev/Getting-Started).
