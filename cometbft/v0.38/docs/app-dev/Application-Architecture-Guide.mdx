---
noindex: true
canonical: 'https://docs.cosmos.network/cometbft/latest/docs/app-dev/Application-Architecture-Guide'
...
- [CometBFT RPC Docs](/cometbft/v0.38/api-reference/rpc/index)
- [CometBFT in Production](/cometbft/v0.38/docs/core/Running-in-production)
- [ABCI spec](/cometbft/v0.38/spec/abci/Overview)
