...
details on `Events`, see the [ABCI][/cometbft/v0.38/spec/abci/Outline#events] documentation.
...
Check out the [RPC API reference](/cometbft/v0.38/api-reference/rpc/index) for the `tx_search` endpoint
...
Check out the [RPC API documentation](/cometbft/v0.38/api-reference/rpc/index) for more information
