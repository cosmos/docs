...
Lib-p2p is a great and widely-used piece of software that includes many ready-to-use peer-to-peer networking features,
and has implementations in many programming languages and network protocols (tpc, quic, websockets, ...).
...
- Stream/message handling is less effective at scaling with bursty traffic,
...
more resilient under sustained congestion and bursty traffic.

In our benchmarks, together with additional performance improvements across the stack, we have reached over ~2000 TPS, 
