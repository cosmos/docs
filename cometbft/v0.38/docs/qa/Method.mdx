---
noindex: true
canonical: 'https://docs.cosmos.network/cometbft/latest/docs/qa/Method'
title: Method
order: 1
---
...
7. On a different shell:
    ...
    * `X` and `Y` should reflect a load below the saturation point (see, e.g.,
      [this paragraph](/cometbft/v0.38/docs/qa/TMCore-QA-34#finding-the-saturation-point) for further info).
