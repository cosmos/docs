...
![mempoool-cumulative](/cometbft/v0.38/docs/qa/img38/200nodes/mempool_size.png)
...
For further details on these plots, see the [this section](/cometbft/v0.38/docs/qa/TMCore-QA-34#peers-2).
