...
transactions](/cometbft/v0.38/docs/app-dev/Indexing-Transactions) for for details.
...
Validators are supposed to setup [Sentry Node Architecture](/cometbft/v0.38/docs/core/Validators)
