---
noindex: true
canonical: 'https://docs.cosmos.network/cometbft/latest/docs/core/Subscribing-to-events-via-Websocket'
...
NOTE: If your node's RPC endpoint is TLS-enabled, use the scheme `wss` instead of `ws`.
...
Check out [the API docs](/cometbft/v0.38/api-reference/rpc/index) for
more information on query syntax and other options.

You can also use tags, given you have included them in the FinalizeBlock
...
While CometBFT imposes no restrictions on the application with regard to the type of
