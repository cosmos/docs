...
![P2P Reactors](../images/p2p-reactors.png)
...
- [Reactor API](/cometbft/latest/spec/p2p/reactor-api/Reactor-Api): documents the [`p2p.Reactor`][reactor-interface]
...
- [P2P API](/cometbft/latest/spec/p2p/reactor-api/API-for-Reactors): documents the interface provided by the p2p
