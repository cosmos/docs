...
| Name      | Type                                                           | Description                     | Field Number |
|-----------|----------------------------------------------------------------|---------------------------------|--------------|
| Block     | [Block](/cometbft/latest/spec/core/Data_structures#block)                   | Requested Block                 | 1            |
| ExtCommit | [ExtendedCommit](/cometbft/latest/spec/core/Data_structures#extendedcommit) | Sender's LastCommit information | 2            |
