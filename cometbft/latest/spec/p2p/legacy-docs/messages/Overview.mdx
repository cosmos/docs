...
There are two parts to the P2P messages, the message and the channel. The channel is message specific and messages are specific to components of CometBFT. When a node connect to a peer it will tell the other node which channels are available. This notifies the peer what services the connecting node offers. You can read more on channels in [connection.md](/cometbft/latest/spec/p2p/legacy-docs/P2P-Multiplex-Connection)

- [Block Sync](/cometbft/latest/spec/p2p/legacy-docs/messages/block-sync)
- [Mempool](/cometbft/latest/spec/p2p/legacy-docs/messages/mempool)
- [Evidence](/cometbft/latest/spec/p2p/legacy-docs/messages/evidence)
- [State Sync](/cometbft/latest/spec/p2p/legacy-docs/messages/state-sync)
- [Pex](/cometbft/latest/spec/p2p/legacy-docs/messages/Peer-Exchange)
- [Consensus](/cometbft/latest/spec/p2p/legacy-docs/messages/consensus)
