...
| Name          | Type                                                    | Description                          | Field Number |
|---------------|---------------------------------------------------------|--------------------------------------|--------------|
| light_block   | [LightBlock](/cometbft/latest/spec/core/Data_structures#lightblock)  | Light block at the height requested  | 1            |

State sync will use [light client verification](/cometbft/latest/spec/light-client/verification) to verify
the light blocks.
...
|----------|--------|---------------------------------|--------------|
| height   | uint64 | Height of the consensus params  | 1            |
| consensus_params | [ConsensusParams](/cometbft/latest/spec/core/Data_structures#blockparams) | Consensus params at the height requested | 2 |
