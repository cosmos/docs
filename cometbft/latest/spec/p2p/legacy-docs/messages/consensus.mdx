...
|----------|----------------------------------------------------|----------------------------------------|--------------|
| proposal | [Proposal](/cometbft/latest/spec/core/Data_structures#proposal) | Proposed Block to come to consensus on | 1            |
...
| Name | Type                                       | Description               | Field Number |
|------|--------------------------------------------|---------------------------|--------------|
| vote | [Vote](/cometbft/latest/spec/core/Data_structures#vote) | Vote for a proposed Block | 1            |
...
| part   | [Part](/cometbft/latest/spec/core/Data_structures#part) | A part of the block.                   | 3            |
...
| height                | int64                                                        | Height of corresponding block          | 1            |
| round                 | int32                                                        | Round of voting to finalize the block. | 2            |
| block_part_set_header | [PartSetHeader](/cometbft/latest/spec/core/Data_structures#partsetheader) |                                        | 3            |
| block_parts           | int32                                                        |                                        | 4            |
| is_commit             | bool                                                         |                                        | 5            |
...
| height | int64                                                            | Height of corresponding block          | 1            |
| round  | int32                                                            | Round of voting to finalize the block. | 2            |
| type   | [SignedMessageType](/cometbft/latest/spec/core/Data_structures#signedmsgtype) |                                        | 3            |
| index  | int32                                                            |                                        | 4            |
...
| round    | int32                                                            | Round of voting to finalize the block. | 2            |
| type     | [SignedMessageType](/cometbft/latest/spec/core/Data_structures#signedmsgtype) |                                        | 3            |
| block_id | [BlockID](/cometbft/latest/spec/core/Data_structures#blockid)                 |                                        | 4            |
