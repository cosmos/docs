...
[here](https://github.com/cometbft/cometbft/blob/v0.40.x/spec/light-client/detection/detection_003_reviewed.md), involves comparison
...
[validation criteria](https://github.com/cometbft/cometbft/blob/v0.40.x/spec/light-client/verification/verification_001_published.md)
