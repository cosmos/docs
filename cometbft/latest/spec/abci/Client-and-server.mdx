...
[Basic Concepts](/cometbft/latest/spec/abci/Outline),
[Methods](/cometbft/latest/spec/abci/Methods),
[Application Requirements](/cometbft/latest/spec/abci/Requirements-for-the-Application), and
[Expected Behavior](/cometbft/latest/spec/abci/CometBFTs-expected-behavior).
...
[Connections](/cometbft/latest/spec/abci/abci++_app_requirements)), when CometBFT issues a request to the
...
[Go](https://github.com/cometbft/cometbft/tree/v0.40.x/abci/server),
