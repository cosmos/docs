...
For further details, see [this paragraph](/cometbft/latest/docs/qa/TMCore-QA-34#finding-the-saturation-point)
...
[this paragraph](/cometbft/latest/docs/qa/TMCore-QA-34#finding-the-saturation-point) in the baseline version.
...
![all-latencies](/cometbft/latest/docs/qa/img37/200nodes_tm037/v037_200node_latencies.png)

The data seen in the plot is similar to that of the baseline.

![all-latencies-bl](/cometbft/latest/docs/qa/img34/v034_200node_latencies.png)

Therefore, for further details on these plots,
see [this paragraph](/cometbft/latest/docs/qa/CometBFT-QA-34#examining-latencies) in the baseline version.
...
![latency-vs-throughput](/cometbft/latest/docs/qa/img37/200nodes_tm037/v037_latency_throughput.png)

This is similar to the baseline plot:

![latency-vs-throughput-bl](/cometbft/latest/docs/qa/img34/v034_latency_throughput.png)
...
![mempool-cumulative](/cometbft/latest/docs/qa/img37/200nodes_tm037/v037_r200c2_mempool_size.png)
...
![mempool-avg](/cometbft/latest/docs/qa/img37/200nodes_tm037/v037_r200c2_mempool_size_avg.png)
...
![mempool-cumulative-bl](/cometbft/latest/docs/qa/img34/v034_r200c2_mempool_size.png)

![mempool-avg-bl](/cometbft/latest/docs/qa/img34/v034_r200c2_mempool_size_avg.png)
...
![peers](/cometbft/latest/docs/qa/img37/200nodes_tm037/v037_r200c2_peers.png)
...
![peers-bl](/cometbft/latest/docs/qa/img34/v034_r200c2_peers.png)

#### Consensus Rounds per Height

Most heights took just one round, but some nodes needed to advance to round 1 at some point.

![rounds](/cometbft/latest/docs/qa/img37/200nodes_tm037/v037_r200c2_rounds.png)

**This plot yields slightly better results than the baseline**:

![rounds-bl](/cometbft/latest/docs/qa/img34/v034_r200c2_rounds.png)

#### Blocks Produced per Minute, Transactions Processed per Minute

The blocks produced per minute are the gradient of this plot.

![heights](/cometbft/latest/docs/qa/img37/200nodes_tm037/v037_r200c2_heights.png)
...
![total-txs](/cometbft/latest/docs/qa/img37/200nodes_tm037/v037_r200c2_total-txs.png)
...
![heights-bl](/cometbft/latest/docs/qa/img34/v034_r200c2_heights.png)

![total-txs](/cometbft/latest/docs/qa/img34/v034_r200c2_total-txs.png)

#### Memory Resident Set Size

Resident Set Size of all monitored processes is plotted below.

![rss](/cometbft/latest/docs/qa/img37/200nodes_tm037/v037_r200c2_rss.png)

The average over all processes oscillates around 380 MiB and does not demonstrate unconstrained growth.

![rss-avg](/cometbft/latest/docs/qa/img37/200nodes_tm037/v037_r200c2_rss_avg.png)

**These plots yield similar results to the baseline**:

![rss-bl](/cometbft/latest/docs/qa/img34/v034_r200c2_rss.png)

![rss-avg-bl](/cometbft/latest/docs/qa/img34/v034_r200c2_rss_avg.png)
...
![load1](/cometbft/latest/docs/qa/img37/200nodes_tm037/v037_r200c2_load1.png)

It is contained below 5 on most nodes.

**This plot yields similar results to the baseline**:

![load1](/cometbft/latest/docs/qa/img34/v034_r200c2_load1.png)
...
See this paragraph in the [baseline report](/cometbft/latest/docs/qa/Method#rotating-node-testnet) for further details.
...
![rotating-all-latencies-bl](/cometbft/latest/docs/qa/img34/v034_rotating_latencies_uniq.png)
...
![rotating-heights](/cometbft/latest/docs/qa/img37/200nodes_tm037/v037_rotating_heights.png)
...
![rotating-heights-bl](/cometbft/latest/docs/qa/img34/v034_rotating_heights.png)
...
![rotating-heights-ephe](/cometbft/latest/docs/qa/img37/200nodes_tm037/v037_rotating_heights_ephe.png)

![rotating-heights-ephe-bl](/cometbft/latest/docs/qa/img34/v034_rotating_heights_ephe.png)
...
![rotating-total-txs](/cometbft/latest/docs/qa/img37/200nodes_tm037/v037_rotating_total-txs.png)
...
![rotating-total-txs-bl](/cometbft/latest/docs/qa/img34/v034_rotating_total-txs.png)

#### Peers

The plot below shows the evolution of the number of peers throughout the experiment.

![rotating-peers](/cometbft/latest/docs/qa/img37/200nodes_tm037/v037_rotating_peers.png)

This is the baseline plot, for comparison.

![rotating-peers-bl](/cometbft/latest/docs/qa/img34/v034_rotating_peers.png)
...
![rotating-rss-avg](/cometbft/latest/docs/qa/img37/200nodes_tm037/v037_rotating_rss_avg.png)

![rotating-rss-avg-bl](/cometbft/latest/docs/qa/img34/v034_rotating_rss_avg.png)
...
![rotating-load1](/cometbft/latest/docs/qa/img37/200nodes_tm037/v037_rotating_load1.png)

![rotating-load1-bl](/cometbft/latest/docs/qa/img34/v034_rotating_load1.png)
