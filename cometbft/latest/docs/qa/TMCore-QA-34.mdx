...
![load-load-runner](/cometbft/latest/docs/qa/img34/v034_r200c2_load-runner.png)
...
![all-latencies](/cometbft/latest/docs/qa/img34/v034_200node_latencies.png)
...
![all-latencies-zoomed](/cometbft/latest/docs/qa/img34/v034_200node_latencies_zoomed.png)
...
![latency-vs-throughput](/cometbft/latest/docs/qa/img34/v034_latency_throughput.png)
...
![mempool-cumulative](/cometbft/latest/docs/qa/img34/v034_r200c2_mempool_size.png)

The plot below shows the evolution of the average over all full nodes, which oscillates between 1500 and 2000
outstanding transactions.

![mempool-avg](/cometbft/latest/docs/qa/img34/v034_r200c2_mempool_size_avg.png)
...
![rss](/cometbft/latest/docs/qa/img34/v034_r200c2_rss.png)

The average over all processes oscillates around 1.2 GiB and does not demonstrate unconstrained growth.

![rss-avg](/cometbft/latest/docs/qa/img34/v034_r200c2_rss_avg.png)
...
![rotating-all-latencies](/cometbft/latest/docs/qa/img34/v034_rotating_latencies.png)
...
![rotating-all-latencies-uniq](/cometbft/latest/docs/qa/img34/v034_rotating_latencies_uniq.png)
...
![rotating-heights](/cometbft/latest/docs/qa/img34/v034_rotating_heights.png)
...
![rotating-heights-ephe](/cometbft/latest/docs/qa/img34/v034_rotating_heights_ephe.png)

The transactions processed per minute are the gradient of this plot.

![rotating-total-txs](/cometbft/latest/docs/qa/img34/v034_rotating_total-txs.png)
...
![rotating-peers](/cometbft/latest/docs/qa/img34/v034_rotating_peers.png)
...
![rotating-rss-avg](/cometbft/latest/docs/qa/img34/v034_rotating_rss_avg.png)
...
![rotating-load1](/cometbft/latest/docs/qa/img34/v034_rotating_load1.png)
