...
See the [install guide](/cometbft/latest/docs/guides/Install-CometBFT).
...
Then, `ssh` into each machine and install CometBFT following the [instructions](/cometbft/latest/docs/guides/Install-CometBFT).
...
Persistent peers can also be specified in the `config.toml`. See [here](/cometbft/latest/docs/core/configuration) for more information about configuration options.
