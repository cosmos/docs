...
<Warning>
  Use only alongside [AdaptiveSync](/cometbft/latest/docs/core/block-sync#adaptivesync)
</Warning>
...
- [lp2p](https://github.com/cometbft/cometbft/tree/v0.40.x/lp2p)
- [internal/autopool](https://github.com/cometbft/cometbft/tree/v0.40.x/internal/autopool)
