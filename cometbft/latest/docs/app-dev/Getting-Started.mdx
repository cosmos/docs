...
[here](/cometbft/latest/docs/guides/Install-CometBFT). If you have never run CometBFT
before, use:
...
details, see [the guide on using CometBFT](/cometbft/latest/docs/core/Using-CometBFT).
