...
Check out the [RPC API reference](/cometbft/latest/api-reference/rpc/index) for the `tx_search` endpoint
...
Check out the [RPC API documentation](/cometbft/latest/api-reference/rpc/index) for more information
...
[abci-events]: /cometbft/latest/spec/abci/abci++_basic_concepts#events
