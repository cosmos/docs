...
Further information on [`Validator`'s](/cometbft/next/spec/core/Data_structures#validator),
[`ValidatorSet`'s](/cometbft/next/spec/core/Data_structures#validatorset) and
[`ConsensusParams`'s](/cometbft/next/spec/core/Data_structures#consensusparams) can
be found in [data structures](/cometbft/next/spec/core/Data_structures)
...
[`Consensus`](/cometbft/next/spec/core/Data_structures#version) contains the protocol version for the blockchain and the
application.
