...
- `validator`
      - `pub_key_types`: Defines which curves are to be accepted as a valid validator consensus key. CometBFT supports ed25519, secp256k1, secp256k1eth, bls12_381, and ml_dsa_65. The default is ed25519 alone, and bls12_381 requires a binary built with the `bls12381` build tag.
