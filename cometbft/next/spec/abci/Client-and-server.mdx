...
[Basic Concepts](/cometbft/next/spec/abci/Outline),
[Methods](/cometbft/next/spec/abci/Methods),
[Application Requirements](/cometbft/next/spec/abci/Requirements-for-the-Application), and
[Expected Behavior](/cometbft/next/spec/abci/CometBFTs-expected-behavior).
...
[Connections](/cometbft/next/spec/abci/abci++_app_requirements)), when CometBFT issues a request to the
