...
Since, as stated in the [Methods](/cometbft/next/spec/abci/Methods#extendvote) section, `ResponseExtendVote`
...
[`ExecTxResult`](/cometbft/next/spec/abci/Methods#exectxresult) in
[`ResponseFinalizeBlock`](/cometbft/next/spec/abci/Methods#finalizeblock). The list of transaction
results MUST respect the same order as the list of transactions delivered via
[`RequestFinalizeBlock`](/cometbft/next/spec/abci/Methods#finalizeblock).
This section discusses the fields inside this structure, along with the fields in
[`ResponseCheckTx`](/cometbft/next/spec/abci/Methods#checktx),
...
[`InitChain`](/cometbft/next/spec/abci/Methods#initchain), and may update it during
[`FinalizeBlock`](/cometbft/next/spec/abci/Methods#finalizeblock). In both cases, a structure of type
[`ValidatorUpdate`](/cometbft/next/spec/abci/Methods#validatorupdate) is returned.
...
at block `H+2` (see Section [Methods](/cometbft/next/spec/abci/Methods)).
...
[`InitChain`](/cometbft/next/spec/abci/Methods#initchain), and updated in
[`FinalizeBlock`](/cometbft/next/spec/abci/Methods#finalizeblock).
...
[timeout parameters](/cometbft/next/docs/core/configuration#consensus-timeouts-explained)
...
[`InitChain`](/cometbft/next/spec/abci/Methods#initchain),
...
[methods](/cometbft/next/spec/abci/Methods) section.
...
There is a newly introduced [**consensus parameter**](/cometbft/next/spec/abci/Requirements-for-the-Application#consensus-parameters): `VoteExtensionsEnableHeight`.
...
Corollary, [CometBFT will decide](/cometbft/next/spec/abci/CometBFTs-expected-behavior#handling-upgrades-to-abci-2-0) which data to store, and require for successful operations, based on the current height
of the chain.
