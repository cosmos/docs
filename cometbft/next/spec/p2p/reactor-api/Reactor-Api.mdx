...
with an ABCI++ application, available [here](/cometbft/next/spec/abci/CometBFTs-expected-behavior).
...
documented in the companion [API for Reactors](/cometbft/next/spec/p2p/reactor-api/API-for-Reactors#switch-api) document.
...
The companion [API for Reactors](/cometbft/next/spec/p2p/reactor-api/API-for-Reactors#peer-api) documents the methods
