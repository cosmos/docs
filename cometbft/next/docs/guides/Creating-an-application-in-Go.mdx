...
this way.
If that is the way you wish to proceed, use the [Creating a built-in application in Go](/cometbft/next/docs/guides/Creating-a-built-in-application-in-Go) guide instead of this one.
