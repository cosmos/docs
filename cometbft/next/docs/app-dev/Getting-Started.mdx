...
[here](/cometbft/next/docs/guides/Install-CometBFT). If you have never run CometBFT
before, use:
...
details, see [the guide on using CometBFT](/cometbft/next/docs/core/Using-CometBFT).
