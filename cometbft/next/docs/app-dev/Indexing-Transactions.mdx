...
details on `Events`, see the [ABCI][/cometbft/next/spec/abci/Outline#events] documentation.
...
Check out the [RPC API reference](/cometbft/next/api-reference/rpc/index) for the `tx_search` endpoint
...
Check out the [RPC API documentation](/cometbft/next/api-reference/rpc/index) for more information
...
[abci-events]: /cometbft/next/spec/abci/abci++_basic_concepts#events
