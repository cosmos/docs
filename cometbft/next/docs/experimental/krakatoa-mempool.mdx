---
noindex: true
canonical: 'https://docs.cosmos.network/cometbft/latest/docs/experimental/krakatoa-mempool'
order: 2
...
- [Mempool](/cometbft/next/docs/core/mempool) - Overview of CometBFT mempool types
