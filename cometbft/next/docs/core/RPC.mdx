...
<Card title="RPC API Reference" icon="book" href="/cometbft/next/api-reference/rpc/index">
...
See the [Configuration](/cometbft/next/docs/core/configuration) page for more details on RPC configuration options.
