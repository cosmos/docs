...
The method to identify the saturation point is explained [here](/cometbft/next/docs/qa/TMCore-QA-34#finding-the-saturation-point) and its application to the baseline is described [here](/cometbft/next/docs/qa/TMCore-QA-37#finding-the-saturation-point).
...
![latencies](/cometbft/next/docs/qa/img37/200nodes_cmt037/all_experiments.png)
...
![latencies](/cometbft/next/docs/qa/img37/200nodes_cmt037/e_75cb89a8-f876-4698-82f3-8aaab0b361af.png)
...
![mempoool-cumulative](/cometbft/next/docs/qa/img37/200nodes_cmt037/mempool_size.png)
...
![mempool-avg](/cometbft/next/docs/qa/img37/200nodes_cmt037/avg_mempool_size.png)
...
![mempool-cumulative-baseline](/cometbft/next/docs/qa/img37/200nodes_tm037/mempool_size.png)

![mempool-avg-baseline](/cometbft/next/docs/qa/img37/200nodes_tm037/avg_mempool_size.png)
...
![peers](/cometbft/next/docs/qa/img37/200nodes_tm037/peers.png)
...
![rounds](/cometbft/next/docs/qa/img37/200nodes_tm037/rounds.png)
...
![heights](/cometbft/next/docs/qa/img37/200nodes_cmt037/block_rate.png)
...
![total-txs](/cometbft/next/docs/qa/img37/200nodes_cmt037/total_txs_rate.png)

The baseline experienced a similar behavior, shown in the following two graphs.
The first depicts the block rate.

![heights-baseline](/cometbft/next/docs/qa/img37/200nodes_tm037/block_rate_regular.png)

The second plots the transaction rate.

![total-txs-baseline](/cometbft/next/docs/qa/img37/200nodes_tm037/total_txs_rate_regular.png)
...
![rss](/cometbft/next/docs/qa/img37/200nodes_tm037/memory.png)
...
![load1](/cometbft/next/docs/qa/img37/200nodes_cmt037/cpu.png)

A similar behavior was seen in the baseline.

![load1-baseline](/cometbft/next/docs/qa/img37/200nodes_tm037/cpu.png)
