...
[here](/cometbft/next/docs/qa/CometBFT-QA-34#saturation-point) and its application to the baseline
is described [here](/cometbft/next/docs/qa/TMCore-QA-37#finding-the-saturation-point).
...
![latency-1-400](/cometbft/next/docs/qa/img38/200nodes/e_de676ecf-038e-443f-a26a-27915f29e312.png)

For reference, the following figure shows the latencies of one of the
experiments for `c=2,r=200` in the baseline.

![latency-2-200-37](/cometbft/next/docs/qa/img37/200nodes_cmt037/e_75cb89a8-f876-4698-82f3-8aaab0b361af.png)
...
![mempool-cumulative](/cometbft/next/docs/qa/img38/200nodes/mempool_size.png)
...
![mempool-avg](/cometbft/next/docs/qa/img38/200nodes/avg_mempool_size.png)
...
![mempool-cumulative-baseline](/cometbft/next/docs/qa/img37/200nodes_cmt037/mempool_size.png)

![mempool-avg-baseline](/cometbft/next/docs/qa/img37/200nodes_cmt037/avg_mempool_size.png)
...
![peers](/cometbft/next/docs/qa/img38/200nodes/peers.png)

Just as in the baseline, shown next, the fact that non-seed nodes reach more
than 50 peers is due to [\#9548].

![peers](/cometbft/next/docs/qa/img37/200nodes_cmt037/peers.png)
...
![rounds](/cometbft/next/docs/qa/img38/200nodes/rounds.png)

The following specific run of the baseline required some nodes to reach round 1.

![rounds](/cometbft/next/docs/qa/img37/200nodes_cmt037/rounds.png)
...
![heights](/cometbft/next/docs/qa/img38/200nodes/block_rate.png)
...
![heights-baseline](/cometbft/next/docs/qa/img37/200nodes_cmt037/block_rate.png)
...
![total-txs](/cometbft/next/docs/qa/img38/200nodes/total_txs_rate.png)

The following is the transaction processing rate of the baseline, which is
similar to the above.

![total-txs-baseline](/cometbft/next/docs/qa/img37/200nodes_cmt037/total_txs_rate.png)
...
![rss](/cometbft/next/docs/qa/img38/200nodes/memory.png)

Similar behavior was shown in the baseline, with even slightly higher memory
usage.

![rss](/cometbft/next/docs/qa/img37/200nodes_cmt037/memory.png)
...
![load1](/cometbft/next/docs/qa/img38/200nodes/cpu.png)

The baseline had similar behavior.

![load1-baseline](/cometbft/next/docs/qa/img37/200nodes_cmt037/cpu.png)
...
which is **different** from the one used in the [previous section](/cometbft/next/docs/qa/Method#200-node-testnet).
...
![rotating-all-latencies](/cometbft/next/docs/qa/img38/rotating/rotating_latencies.png)

This is similar to the baseline.

![rotating-all-latencies](/cometbft/next/docs/qa/img37/200nodes_tm037/v037_rotating_latencies.png)
...
![rotating-heights](/cometbft/next/docs/qa/img38/rotating/rotating_block_rate.png)

This is similar to the baseline, shown below.

![rotating-heights-bl](/cometbft/next/docs/qa/img37/rotating/rotating_block_rate.png)
...
![rotating-heights-ephe](/cometbft/next/docs/qa/img38/rotating/rotating_eph_heights.png)

![rotating-heights-ephe-bl](/cometbft/next/docs/qa/img37/rotating/rotating_eph_heights.png)
...
![rotating-total-txs](/cometbft/next/docs/qa/img38/rotating/rotating_txs_rate.png)

For comparison, this is the baseline plot.

![rotating-total-txs-bl](/cometbft/next/docs/qa/img37/rotating/rotating_txs_rate.png)
...
![rotating-peers](/cometbft/next/docs/qa/img38/rotating/rotating_peers.png)

This is the baseline plot, for comparison.

![rotating-peers-bl](/cometbft/next/docs/qa/img37/rotating/rotating_peers.png)

The plotted values and their evolution are comparable in both plots.

For further details on these plots, see [this section](/cometbft/next/docs/qa/TMCore-QA-34#peers-2).
...
![rotating-rss-avg](/cometbft/next/docs/qa/img38/rotating/rotating_avg_memory.png)

![rotating-rss-avg-bl](/cometbft/next/docs/qa/img37/rotating/rotating_avg_memory.png)

#### CPU Utilization

The plots show metric `load1` for all nodes for `v0.38.0-alpha.2` and for the baseline.

![rotating-load1](/cometbft/next/docs/qa/img38/rotating/rotating_cpu.png)

![rotating-load1-bl](/cometbft/next/docs/qa/img37/rotating/rotating_cpu.png)
...
![](/cometbft/next/docs/qa/img38/voteExtensions/all_experiments_baseline.png)

**2k**

![](/cometbft/next/docs/qa/img38/voteExtensions/all_experiments_2k.png)

**4k**

![](/cometbft/next/docs/qa/img38/voteExtensions/all_experiments_4k.png)

**8k**

![](/cometbft/next/docs/qa/img38/voteExtensions/all_experiments_8k.png)

**16k**

![](/cometbft/next/docs/qa/img38/voteExtensions/all_experiments_16k.png)

**32k**

![](/cometbft/next/docs/qa/img38/voteExtensions/all_experiments_32k.png)
...
|                                                            |                                                  |
| ---------------------------------------------------------- | ------------------------------------------------ |
| baseline ![](/cometbft/next/docs/qa/img38/voteExtensions/all_c1r400_baseline.png) | 2k ![](/cometbft/next/docs/qa/img38/voteExtensions/all_c1r400_2k.png)   |
| 4k ![](/cometbft/next/docs/qa/img38/voteExtensions/all_c1r400_4k.png)             | 8k ![](/cometbft/next/docs/qa/img38/voteExtensions/all_c1r400_8k.png)   |
| 16k ![](/cometbft/next/docs/qa/img38/voteExtensions/all_c1r400_16k.png)           | 32k ![](/cometbft/next/docs/qa/img38/voteExtensions/all_c1r400_32k.png) |
...
| ------------ | ----------------------------------------------------------- | ------------------------------------------------------------- |
| **baseline** | ![block rate](/cometbft/next/docs/qa/img38/voteExtensions/baseline_block_rate.png) | ![txs rate](/cometbft/next/docs/qa/img38/voteExtensions/baseline_total_txs_rate.png) |
| **2k**       | ![block rate](/cometbft/next/docs/qa/img38/voteExtensions/02k_block_rate.png)      | ![txs rate](/cometbft/next/docs/qa/img38/voteExtensions/02k_total_txs_rate.png)      |
| **4k**       | ![block rate](/cometbft/next/docs/qa/img38/voteExtensions/04k_block_rate.png)      | ![txs rate](/cometbft/next/docs/qa/img38/voteExtensions/04k_total_txs_rate.png)      |
| **8k**       | ![block rate](/cometbft/next/docs/qa/img38/voteExtensions/8k_block_rate.png)       | ![txs rate](/cometbft/next/docs/qa/img38/voteExtensions/08k_total_txs_rate.png)      |
| **16k**      | ![block rate](/cometbft/next/docs/qa/img38/voteExtensions/16k_block_rate.png)      | ![txs rate](/cometbft/next/docs/qa/img38/voteExtensions/16k_total_txs_rate.png)      |
| **32k**      | ![block rate](/cometbft/next/docs/qa/img38/voteExtensions/32k_block_rate.png)      | ![txs rate](/cometbft/next/docs/qa/img38/voteExtensions/32k_total_txs_rate.png)      |

#### First Run

| Experiment   | Block creation rate                                           | Transaction rate                                                |
| ------------ | ------------------------------------------------------------- | --------------------------------------------------------------- |
| **baseline** | ![block rate](/cometbft/next/docs/qa/img38/voteExtensions/baseline_1_block_rate.png) | ![txs rate](/cometbft/next/docs/qa/img38/voteExtensions/baseline_1_total_txs_rate.png) |
| **2k**       | ![block rate](/cometbft/next/docs/qa/img38/voteExtensions/02k_1_block_rate.png)      | ![txs rate](/cometbft/next/docs/qa/img38/voteExtensions/02k_1_total_txs_rate.png)      |
| **4k**       | ![block rate](/cometbft/next/docs/qa/img38/voteExtensions/04k_1_block_rate.png)      | ![txs rate](/cometbft/next/docs/qa/img38/voteExtensions/04k_1_total_txs_rate.png)      |
| **8k**       | ![block rate](/cometbft/next/docs/qa/img38/voteExtensions/08k_1_block_rate.png)      | ![txs rate](/cometbft/next/docs/qa/img38/voteExtensions/08k_1_total_txs_rate.png)      |
| **16k**      | ![block rate](/cometbft/next/docs/qa/img38/voteExtensions/16k_1_block_rate.png)      | ![txs rate](/cometbft/next/docs/qa/img38/voteExtensions/16k_1_total_txs_rate.png)      |
| **32k**      | ![block rate](/cometbft/next/docs/qa/img38/voteExtensions/32k_1_block_rate.png)      | ![txs rate](/cometbft/next/docs/qa/img38/voteExtensions/32k_1_total_txs_rate.png)      |
...
| ------------ | ------------------------------------------------------------- |
| **baseline** | ![number of rounds](/cometbft/next/docs/qa/img38/voteExtensions/baseline_rounds.png) |
| **2k**       | ![number of rounds](/cometbft/next/docs/qa/img38/voteExtensions/02k_rounds.png)      |
| **4k**       | ![number of rounds](/cometbft/next/docs/qa/img38/voteExtensions/04k_rounds.png)      |
| **8k**       | ![number of rounds](/cometbft/next/docs/qa/img38/voteExtensions/08k_rounds.png)      |
| **16k**      | ![number of rounds](/cometbft/next/docs/qa/img38/voteExtensions/16k_rounds.png)      |
| **32k**      | ![number of rounds](/cometbft/next/docs/qa/img38/voteExtensions/32k_rounds.png)      |
...
| Experiment   | CPU                                                   |
| ------------ | ----------------------------------------------------- |
| **baseline** | ![cpu-avg](/cometbft/next/docs/qa/img38/voteExtensions/baseline_avg_cpu.png) |
| **2k**       | ![cpu-avg](/cometbft/next/docs/qa/img38/voteExtensions/02k_avg_cpu.png)      |
| **4k**       | ![cpu-avg](/cometbft/next/docs/qa/img38/voteExtensions/04k_avg_cpu.png)      |
| **8k**       | ![cpu-avg](/cometbft/next/docs/qa/img38/voteExtensions/08k_avg_cpu.png)      |
| **16k**      | ![cpu-avg](/cometbft/next/docs/qa/img38/voteExtensions/16k_avg_cpu.png)      |
| **32k**      | ![cpu-avg](/cometbft/next/docs/qa/img38/voteExtensions/32k_avg_cpu.png)      |
...
| ------------ | -------------------------------------------------------- |
| **baseline** | ![rss-avg](/cometbft/next/docs/qa/img38/voteExtensions/baseline_avg_memory.png) |
| **2k**       | ![rss-avg](/cometbft/next/docs/qa/img38/voteExtensions/02k_avg_memory.png)      |
| **4k**       | ![rss-avg](/cometbft/next/docs/qa/img38/voteExtensions/04k_avg_memory.png)      |
| **8k**       | ![rss-avg](/cometbft/next/docs/qa/img38/voteExtensions/08k_avg_memory.png)      |
| **16k**      | ![rss-avg](/cometbft/next/docs/qa/img38/voteExtensions/16k_avg_memory.png)      |
| **32k**      | ![rss-avg](/cometbft/next/docs/qa/img38/voteExtensions/32k_avg_memory.png)      |
...
| ------------ | ------------------------------------------------------------------ |
| **baseline** | ![mempool-avg](/cometbft/next/docs/qa/img38/voteExtensions/baseline_avg_mempool_size.png) |
| **2k**       | ![mempool-avg](/cometbft/next/docs/qa/img38/voteExtensions/02k_avg_mempool_size.png)      |
| **4k**       | ![mempool-avg](/cometbft/next/docs/qa/img38/voteExtensions/04k_avg_mempool_size.png)      |
| **8k**       | ![mempool-avg](/cometbft/next/docs/qa/img38/voteExtensions/08k_avg_mempool_size.png)      |
| **16k**      | ![mempool-avg](/cometbft/next/docs/qa/img38/voteExtensions/16k_avg_mempool_size.png)      |
| **32k**      | ![mempool-avg](/cometbft/next/docs/qa/img38/voteExtensions/32k_avg_mempool_size.png)      |
