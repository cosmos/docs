...
For more background, see [What is CometBFT?](/cometbft/next/docs/introduction/intro#what-is-cometbft).

To get started quickly with an example application, see the [quick start guide](/cometbft/next/docs/guides/Quick-Start).

To learn about application development on CometBFT, see the [Application Blockchain Interface](/cometbft/next/spec/abci/Overview).

For more details on using CometBFT, see the respective documentation for
[CometBFT internals](/cometbft/next/docs/core/), [benchmarking and monitoring](/cometbft/next/docs/tools/), and [network deployments](/cometbft/next/docs/networks/).
