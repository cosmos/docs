...
with an ABCI++ application, available [here](/cometbft/v0.39/spec/abci/CometBFTs-expected-behavior).
...
documented in the companion [API for Reactors](/cometbft/v0.39/spec/p2p/reactor-api/API-for-Reactors#switch-api) document.
...
The companion [API for Reactors](/cometbft/v0.39/spec/p2p/reactor-api/API-for-Reactors#peer-api) documents the methods
