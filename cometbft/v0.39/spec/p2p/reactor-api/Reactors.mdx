...
- [Reactor API](/cometbft/v0.39/spec/p2p/reactor-api/Reactor-Api): documents the [`p2p.Reactor`][reactor-interface]
...
- [P2P API](/cometbft/v0.39/spec/p2p/reactor-api/API-for-Reactors): documents the interface provided by the p2p
