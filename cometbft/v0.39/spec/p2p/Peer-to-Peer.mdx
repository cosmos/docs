...
- [`implementation`](/cometbft/v0.39/spec/p2p/Implementation-of-the-p2p-layer): documents the current state
...
- [`reactor-api`](/cometbft/v0.39/spec/p2p/reactor-api/Reactor-Api): specifies the API offered by the
...
- [`legacy-docs`](/cometbft/v0.39/spec/p2p/legacy-docs/Overview): We keep older documentation in 
