---
noindex: true
canonical: 'https://docs.cosmos.network/cometbft/latest/spec/core/encoding'
title: Encoding
order: 2
---
...
For more details, see the [signing spec](/cometbft/v0.39/spec/consensus/Validator-Signing).
