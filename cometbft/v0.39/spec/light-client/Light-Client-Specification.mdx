...
![Experimental results](/cometbft/v0.39/spec/light-client/experiments.png)
...
computer-aided analysis of  [Tendermint Consensus in TLA+](/cometbft/v0.39/spec/light-client/Accountability) shows that equivocation and amnesia capture all non-lunatic attacks.
...
[tendermint-accountability](/cometbft/v0.39/spec/light-client/Accountability)
