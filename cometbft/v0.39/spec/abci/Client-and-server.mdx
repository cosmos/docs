---
noindex: true
canonical: 'https://docs.cosmos.network/cometbft/latest/spec/abci/Client-and-server'
order: 5
...
[Basic Concepts](/cometbft/v0.39/spec/abci/Outline),
[Methods](/cometbft/v0.39/spec/abci/Methods),
[Application Requirements](/cometbft/v0.39/spec/abci/Requirements-for-the-Application), and
[Expected Behavior](/cometbft/v0.39/spec/abci/CometBFTs-expected-behavior).
...
[Connections](/cometbft/v0.39/spec/abci/abci++_app_requirements)), when CometBFT issues a request to the
