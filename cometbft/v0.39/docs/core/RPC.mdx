...
<Card title="RPC API Reference" icon="book" href="/cometbft/v0.39/api-reference/rpc/index">
...
See the [Configuration](/cometbft/v0.39/docs/core/configuration) page for more details on RPC configuration options.
