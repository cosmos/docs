...
this way.
If that is the way you wish to proceed, use the [Creating a built-in application in Go](/cometbft/v0.39/docs/guides/Creating-a-built-in-application-in-Go) guide instead of this one.
