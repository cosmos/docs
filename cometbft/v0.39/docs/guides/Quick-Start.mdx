...
See the [install guide](/cometbft/v0.39/docs/guides/Install-CometBFT).
...
Then, `ssh` into each machine and install CometBFT following the [instructions](/cometbft/v0.39/docs/guides/Install-CometBFT).
...
Persistent peers can also be specified in the `config.toml`. See [here](/cometbft/v0.39/docs/core/configuration) for more information about configuration options.
