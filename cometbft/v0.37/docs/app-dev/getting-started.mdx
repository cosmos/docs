---
noindex: true
canonical: 'https://docs.cosmos.network/cometbft/latest/docs/app-dev/getting-started'
...
ABCI](/cometbft/v0.37/docs/introduction/what-is-cometbft#abci-overview) that CometBFT
...
[here](/cometbft/v0.37/docs/guides/install). If you have never run CometBFT
before, use:
...
details, see [the guide on using CometBFT](/cometbft/v0.37/docs/core/using-cometbft).
