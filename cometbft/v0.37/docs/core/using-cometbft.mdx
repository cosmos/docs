...
config specification](/cometbft/v0.37/docs/core/configuration).
...
write-ahead-log](/cometbft/v0.37/docs/core/running-in-production#mempool-wal)
...
developers guide](/cometbft/v0.37/docs/app-dev/abci-cli) for more details.
