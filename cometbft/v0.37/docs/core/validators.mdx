...
1. They can be pre-established in the [genesis state](/cometbft/v0.37/docs/core/using-cometbft#genesis)
...
![ALT Network Layout](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/imgs/sentry_layout.png)
...
![ALT Local Configuration](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/imgs/sentry_local_config.png)
