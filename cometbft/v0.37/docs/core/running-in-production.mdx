...
instructions](/cometbft/v0.37/docs/guides/install) for details.
...
result events. See [indexing transactions](/cometbft/v0.37/docs/app-dev/indexing-transactions) for
details.
...
Applications can use [state sync](/cometbft/v0.37/docs/core/state-sync) to help nodes bootstrap quickly.
...
modules can be found [here](/cometbft/v0.37/docs/core/how-to-read-logs#list-of-modules). If
...
Validators are supposed to setup [Sentry Node Architecture](/cometbft/v0.37/docs/core/validators)
...
**Under no condition should any of the [unsafe RPC endpoints](https://docs.cometbft.com/v0.37/rpc/#/Unsafe)
...
check out the logs. See [How to read logs](/cometbft/v0.37/docs/core/how-to-read-logs), where we
...
[Debugging](/cometbft/v0.37/docs/tools/debugging) for the exact format.
...
information into an archive. See [Debugging](/cometbft/v0.37/docs/tools/debugging) for more
information.
