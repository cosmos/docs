...
elements (100 max). See the [RPC Documentation](https://docs.cometbft.com/v0.37/rpc/)
...
(Source: [PostgreSQL Wiki - Corruption](https://wiki.postgresql.org/wiki/Corruption))
