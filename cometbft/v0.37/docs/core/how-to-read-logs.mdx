...
- `abci-client` As mentioned in [Application Development Guide](/cometbft/v0.37/docs/app-dev/abci-cli), CometBFT acts as an ABCI
...
- `events` Simple event notification system. The list of events can be
  ...
  to [RPC docs](/cometbft/v0.37/docs/core/rpc) for additional information.
- `mempool` Mempool module handles all incoming transactions, whenever
  they are coming from peers or the application.
- `p2p` Provides an abstraction around peer-to-peer communication. For
  more details, please check out the
  [README](https://github.com/cometbft/cometbft/blob/v0.37.x/p2p/README.md).
- `rpc` [CometBFT's RPC](/cometbft/v0.37/docs/core/rpc).
