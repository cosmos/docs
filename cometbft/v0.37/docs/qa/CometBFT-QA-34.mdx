---
noindex: true
canonical: 'https://docs.cosmos.network/cometbft/latest/docs/qa/CometBFT-QA-34'
order: 1
parent:
...
the [saturation point](/cometbft/v0.37/docs/qa/TMCore-QA-34#finding-the-saturation-point).

Therefore, we will simply use a load of (`r=200,c=2`)
(see the explanation [here](/cometbft/v0.37/docs/qa/TMCore-QA-34#finding-the-saturation-point)) on all experiments.
...
![latencies](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img34/homogeneous/all_experiments.png)

### 1/2 Tendermint Core - 1/2 CometBFT

![latencies](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img34/cmt1tm1/all_experiments.png)

### 1/3 Tendermint Core - 2/3 CometBFT

![latencies](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img34/cmt2tm1/all_experiments.png)

### 2/3 Tendermint Core - 1/3 CometBFT

![latencies_all_tm2_3_cmt1_3](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img34/v034_200node_tm2cmt1/all_experiments.png)
...
* Baseline results: `v0.34.x`, obtained in October 2022 and reported [here](/cometbft/v0.37/docs/qa/TMCore-QA-34).
...
![mempool-cumulative](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img34/baseline/mempool_size.png)

![mempool-avg](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img34/baseline/avg_mempool_size.png)

#### CometBFT Homogeneous network

The results for the homogeneous network and the baseline are similar in terms of outstanding transactions.

![mempool-cumulative-homogeneous](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img34/homogeneous/mempool_size.png)

![mempool-avg-homogeneous](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img34/homogeneous/avg_mempool_size.png)

#### 1/2 Tendermint Core - 1/2 CometBFT

![mempool size](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img34/cmt1tm1/mempool_size.png)

![average mempool size](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img34/cmt1tm1/avg_mempool_size.png)

#### 1/3 Tendermint Core - 2/3 CometBFT

![mempool size](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img34/cmt2tm1/mempool_size.png)

![average mempool size](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img34/cmt2tm1/avg_mempool_size.png)

#### 2/3 Tendermint Core - 1/3 CometBFT

![mempool_tm2_3_cmt_1_3](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img34/v034_200node_tm2cmt1/mempool_size.png)

![mempool-avg_tm2_3_cmt_1_3](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img34/v034_200node_tm2cmt1/avg_mempool_size.png)
...
![rounds](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img34/baseline/rounds.png)
...
![rounds-homogeneous](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img34/homogeneous/rounds.png)

#### 1/2 Tendermint Core - 1/2 CometBFT

![peers](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img34/cmt1tm1/rounds.png)

#### 1/3 Tendermint Core - 2/3 CometBFT

![peers](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img34/cmt2tm1/rounds.png)

#### 2/3 Tendermint Core - 1/3 CometBFT

![rounds-tm2_3_cmt1_3](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img34/v034_200node_tm2cmt1/rounds.png)
...
![peers](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img34/baseline/peers.png)
...
![peers-homogeneous](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img34/homogeneous/peers.png)

#### 1/2 Tendermint Core - 1/2 CometBFT

![peers](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img34/cmt1tm1/peers.png)

#### 1/3 Tendermint Core - 2/3 CometBFT

![peers](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img34/cmt2tm1/peers.png)
...
![peers-tm2_3_cmt1_3](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img34/v034_200node_tm2cmt1/peers.png)
...
![heights](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img34/baseline/block_rate_regular.png)

The number of transactions/minute tops around 30k.

![total-txs](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img34/baseline/total_txs_rate_regular.png)
...
![heights-homogeneous-rate](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img34/homogeneous/block_rate_regular.png)

The plot showing the transaction rate shows the rate stays around 20000 transactions per minute,
also topping around 30k.

![txs-homogeneous-rate](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img34/homogeneous/total_txs_rate_regular.png)

#### 1/2 Tendermint Core - 1/2 CometBFT

![height rate](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img34/cmt1tm1/block_rate_regular.png)

![transaction rate](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img34/cmt1tm1/total_txs_rate_regular.png)

#### 1/3 Tendermint Core - 2/3 CometBFT

![height rate](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img34/cmt2tm1/block_rate_regular.png)

![transaction rate](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img34/cmt2tm1/total_txs_rate_regular.png)

#### 2/3 Tendermint Core - 1/3 CometBFT

![height rate](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img34/v034_200node_tm2cmt1/block_rate_regular.png)

![transaction rate](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img34/v034_200node_tm2cmt1/total_txs_rate_regular.png)
...
![rss](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img34/baseline/memory.png)

![rss-avg](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img34/baseline/avg_memory.png)
...
![rss-homogeneous](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img34/homogeneous/memory.png)

And this is the average plot. It oscillates around 560 MiB, which is noticeably lower than the baseline.

![rss-avg-homogeneous](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img34/homogeneous/avg_memory.png)

#### 1/2 Tendermint Core - 1/2 CometBFT

![rss](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img34/cmt1tm1/memory.png)

![rss average](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img34/cmt1tm1/avg_memory.png)

#### 1/3 Tendermint Core - 2/3 CometBFT

![rss](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img34/cmt2tm1/memory.png)

![rss average](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img34/cmt2tm1/avg_memory.png)

#### 2/3 Tendermint Core - 1/3 CometBFT

![rss](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img34/v034_200node_tm2cmt1/memory.png)

![rss average](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img34/v034_200node_tm2cmt1/avg_memory.png)
...
![load1](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img34/baseline/cpu.png)

![load1-avg](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img34/baseline/avg_cpu.png)

#### CometBFT Homogeneous network

The load in the homogenous network is, similarly to the baseline case, below 5 and, therefore, normal.

![load1-homogeneous](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img34/homogeneous/cpu.png)

As expected, the average plot also looks similar.

![load1-homogeneous-avg](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img34/homogeneous/avg_cpu.png)

#### 1/2 Tendermint Core - 1/2 CometBFT

![load1](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img34/cmt1tm1/cpu.png)

![average load1](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img34/cmt1tm1/avg_cpu.png)

#### 1/3 Tendermint Core - 2/3 CometBFT

![load1](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img34/cmt2tm1/cpu.png)

![average load1](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img34/cmt2tm1/avg_cpu.png)

#### 2/3 Tendermint Core - 1/3 CometBFT

![load1](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img34/v034_200node_tm2cmt1/cpu.png)

![average load1](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img34/v034_200node_tm2cmt1/avg_cpu.png)
