...
[`latency_throughput.py`]: https://github.com/cometbft/cometbft/blob/v0.37.x/scripts/qa/reporting/README.md#Latency-vs-Throughput-Plotting
...
[`latency_plotter.py`]: https://github.com/cometbft/cometbft/blob/v0.37.x/scripts/qa/reporting/README.md#Latency-vs-Throughput-Plotting-version-2
...
[`prometheus_plotter.py`]: https://github.com/cometbft/cometbft/blob/v0.37.x/scripts/qa/reporting/README.md#prometheus-metrics
...
7. On a different shell,
    ...
    * `X` and `Y` should reflect a load below the saturation point (see, e.g.,
      [this paragraph](/cometbft/v0.37/docs/qa/CometBFT-QA-34#saturation-point) for further info)
