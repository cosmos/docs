---
noindex: true
canonical: 'https://docs.cosmos.network/cometbft/latest/docs/qa/TMCore-QA-34'
order: 1
parent:
...
(extracted from file [`v034_report_tabbed.txt`](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img34/v034_report_tabbed.txt)).
...
![load-load-runner](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img34/v034_r200c2_load-runner.png)
...
![all-latencies](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img34/v034_200node_latencies.png)
...
![all-latencies-zoomed](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img34/v034_200node_latencies_zoomed.png)
...
![latency-vs-throughput](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img34/v034_latency_throughput.png)
...
![mempool-cumulative](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img34/v034_r200c2_mempool_size.png)

The plot below shows evolution of the average over all full nodes, which oscillates between 1500 and 2000
outstanding transactions.

![mempool-avg](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img34/v034_r200c2_mempool_size_avg.png)
...
![peers](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img34/v034_r200c2_peers.png)

#### Consensus Rounds per Height

Most nodes used only round 0 for most heights, but some nodes needed to advance to round 1 for some heights.

![rounds](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img34/v034_r200c2_rounds.png)

#### Blocks Produced per Minute, Transactions Processed per Minute

The blocks produced per minute are the slope of this plot.

![heights](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img34/v034_r200c2_heights.png)
...
![rss](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img34/v034_r200c2_rss.png)

The average over all processes oscillates around 1.2 GiB and does not demonstrate unconstrained growth.

![rss-avg](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img34/v034_r200c2_rss_avg.png)
...
![rotating-all-latencies](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img34/v034_rotating_latencies.png)
...
![rotating-all-latencies-uniq](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img34/v034_rotating_latencies_uniq.png)
...
![rotating-heights](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img34/v034_rotating_heights.png)
...
![rotating-heights-ephe](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img34/v034_rotating_heights_ephe.png)

The transactions processed per minute are the gradient of this plot.

![rotating-total-txs](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img34/v034_rotating_total-txs.png)
...
![rotating-peers](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img34/v034_rotating_peers.png)
...
![rotating-rss-avg](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img34/v034_rotating_rss_avg.png)
...
![rotating-load1](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img34/v034_rotating_load1.png)
