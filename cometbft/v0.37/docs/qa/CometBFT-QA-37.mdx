...
The method to identify the saturation point is explained [here](/cometbft/v0.37/docs/qa/CometBFT-QA-34#finding-the-saturation-point) and its application to the baseline is described [here](/cometbft/v0.37/docs/qa/TMCore-QA-37#finding-the-saturation-point).
