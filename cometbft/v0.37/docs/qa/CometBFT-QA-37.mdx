---
noindex: true
canonical: 'https://docs.cosmos.network/cometbft/latest/docs/qa/CometBFT-QA-37'
order: 1
parent:
...
The method to identify the saturation point is explained [here](/cometbft/v0.37/docs/qa/CometBFT-QA-34#saturation-point) and its application to the baseline is described [here](/cometbft/v0.37/docs/qa/TMCore-QA-37#finding-the-saturation-point).
...
![latencies](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img37/200nodes_cmt037/all_experiments.png)
...
![latencies](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img37/200nodes_cmt037/e_75cb89a8-f876-4698-82f3-8aaab0b361af.png).
...
![mempoool-cumulative](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img37/200nodes_cmt037/mempool_size.png)
...
![mempool-avg](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img37/200nodes_cmt037/avg_mempool_size.png)
...
![mempool-cumulative-baseline](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img37/200nodes_tm037/mempool_size.png)

![mempool-avg-baseline](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img37/200nodes_tm037/avg_mempool_size.png)
...
![peers](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img37/200nodes_cmt037/peers.png)

Just as in the baseline, shown next, the fact that non-seed nodes reach more than 50 peers is due to [\#9548].

![peers](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img37/200nodes_tm037/peers.png)
...
![rounds](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img37/200nodes_cmt037/rounds.png)
...
![rounds](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img37/200nodes_tm037/rounds.png)
...
![heights](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img37/200nodes_cmt037/block_rate.png)
...
![total-txs](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img37/200nodes_cmt037/total_txs_rate.png)

The baseline experienced a similar behavior, shown in the following two graphs.
The first depicts the block rate.

![heights-baseline](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img37/200nodes_tm037/block_rate_regular.png)

The second plots the transaction rate.

![total-txs-baseline](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img37/200nodes_tm037/total_txs_rate_regular.png)

### Memory Resident Set Size

The Resident Set Size of all monitored processes is plotted below, with maximum memory usage of 2GB.

![rss](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img37/200nodes_cmt037/memory.png)

A similar behavior was shown in the baseline, presented next.

![rss](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img37/200nodes_tm037/memory.png)
...
![load1](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img37/200nodes_cmt037/cpu.png)

A similar behavior was seen in the baseline.

![load1-baseline](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img37/200nodes_tm037/cpu.png)
