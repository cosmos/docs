...
File [method](/cometbft/v0.37/docs/qa/method) keeps track of the process followed to obtain the results
...
* [TM v0.34.x](/cometbft/v0.37/docs/qa/TMCore-QA-34) - Tested prior to releasing Tendermint Core v0.34.22.
* [v0.34.x](/cometbft/v0.37/docs/qa/CometBFT-QA-34) - Tested prior to releasing v0.34.27, using TM v0.34.x results as baseline.
* [TM v0.37.x](/cometbft/v0.37/docs/qa/TMCore-QA-37) - Tested prior to releasing TM v0.37.x, using TM v0.34.x results as baseline.
* [v0.37.x](/cometbft/v0.37/docs/qa/CometBFT-QA-37) - Tested on CometBFT v0.37.0-alpha3, using TM v0.37.x results as baseline.
