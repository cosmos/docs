...
For further details, see [this paragraph](/cometbft/v0.37/docs/qa/CometBFT-QA-34#finding-the-saturation-point)
...
[this paragraph](/cometbft/v0.37/docs/qa/CometBFT-QA-34#finding-the-saturation-point) in the baseline version.
...
See this paragraph in the [baseline report](/cometbft/v0.37/docs/qa/CometBFT-QA-34#rotating-node-testnet) for further details.
