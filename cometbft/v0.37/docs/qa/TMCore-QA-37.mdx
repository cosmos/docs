...
For further details, see [this paragraph](CometBFT-QA-34#finding-the-saturation-point)
...
[this paragraph](CometBFT-QA-34#finding-the-saturation-point) in the baseline version.
...
see [this paragraph](CometBFT-QA-34#examining-latencies) in the baseline version.
...
See this paragraph in the [baseline report](CometBFT-QA-34#rotating-node-testnet) for further details.
