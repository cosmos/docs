---
noindex: true
canonical: 'https://docs.cosmos.network/cometbft/latest/docs/qa/TMCore-QA-37'
order: 1
parent:
...
For further details, see [this paragraph](/cometbft/v0.37/docs/qa/CometBFT-QA-34#saturation-point)
in the baseline version.

The following table summarizes the results for v0.37.x, for the different experiments
(extracted from file [`v037_report_tabbed.txt`](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img37/200nodes_tm037/v037_report_tabbed.txt)).
...
[this paragraph](/cometbft/v0.37/docs/qa/CometBFT-QA-34#saturation-point) in the baseline version.
...
The method described [here](/cometbft/v0.37/docs/qa/method) allows us to plot the latencies of transactions
for all experiments.

![all-latencies](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img37/200nodes_tm037/v037_200node_latencies.png)

The data seen in the plot is similar to that of the baseline.

![all-latencies-bl](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img34/v034_200node_latencies.png)

Therefore, for further details on these plots,
see [this paragraph](/cometbft/v0.37/docs/qa/CometBFT-QA-34#examining-latencies) in the baseline version.
...
![latency-vs-throughput](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img37/200nodes_tm037/v037_latency_throughput.png)

This is similar to that of the baseline plot:

![latency-vs-throughput-bl](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img34/v034_latency_throughput.png)
...
![mempool-cumulative](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img37/200nodes_tm037/v037_r200c2_mempool_size.png)
...
![mempool-avg](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img37/200nodes_tm037/v037_r200c2_mempool_size_avg.png)
...
![mempool-cumulative-bl](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img34/v034_r200c2_mempool_size.png)

![mempool-avg-bl](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img34/v034_r200c2_mempool_size_avg.png)
...
![peers](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img37/200nodes_tm037/v037_r200c2_peers.png)
...
![peers-bl](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img34/v034_r200c2_peers.png)

#### Consensus Rounds per Height

Most heights took just one round, but some nodes needed to advance to round 1 at some point.

![rounds](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img37/200nodes_tm037/v037_r200c2_rounds.png)

**This plot yields slightly better results than the baseline**:

![rounds-bl](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img34/v034_r200c2_rounds.png)

#### Blocks Produced per Minute, Transactions Processed per Minute

The blocks produced per minute are the gradient of this plot.

![heights](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img37/200nodes_tm037/v037_r200c2_heights.png)
...
![total-txs](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img37/200nodes_tm037/v037_r200c2_total-txs.png)
...
![heights-bl](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img34/v034_r200c2_heights.png)

![total-txs](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img34/v034_r200c2_total-txs.png)

#### Memory Resident Set Size

Resident Set Size of all monitored processes is plotted below.

![rss](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img37/200nodes_tm037/v037_r200c2_rss.png)

The average over all processes oscillates around 380 MiB and does not demonstrate unconstrained growth.

![rss-avg](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img37/200nodes_tm037/v037_r200c2_rss_avg.png)

**These plots yield similar results to the baseline**:

![rss-bl](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img34/v034_r200c2_rss.png)

![rss-avg-bl](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img34/v034_r200c2_rss_avg.png)
...
![load1](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img37/200nodes_tm037/v037_r200c2_load1.png)

It is contained below 5 on most nodes.

**This plot yields similar results to the baseline**:

![load1](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img34/v034_r200c2_load1.png)
...
See this paragraph in the [baseline report](/cometbft/v0.37/docs/qa/TMCore-QA-34#rotating-node-testnet) for further details.
...
![rotating-all-latencies](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img37/200nodes_tm037/v037_rotating_latencies.png)

Which is similar to the baseline.

![rotating-all-latencies-bl](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img34/v034_rotating_latencies_uniq.png)
...
![rotating-heights](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img37/200nodes_tm037/v037_rotating_heights.png)
...
![rotating-heights-bl](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img34/v034_rotating_heights.png)
...
![rotating-heights-ephe](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img37/200nodes_tm037/v037_rotating_heights_ephe.png)

![rotating-heights-ephe-bl](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img34/v034_rotating_heights_ephe.png)
...
![rotating-total-txs](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img37/200nodes_tm037/v037_rotating_total-txs.png)
...
![rotating-total-txs-bl](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img34/v034_rotating_total-txs.png)

#### Peers

The plot below shows the evolution of the number of peers throughout the experiment.

![rotating-peers](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img37/200nodes_tm037/v037_rotating_peers.png)

This is the baseline plot, for comparison.

![rotating-peers-bl](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img34/v034_rotating_peers.png)
...
![rotating-rss-avg](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img37/200nodes_tm037/v037_rotating_rss_avg.png)

![rotating-rss-avg-bl](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img34/v034_rotating_rss_avg.png)
...
![rotating-load1](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img37/200nodes_tm037/v037_rotating_load1.png)

![rotating-load1-bl](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/qa/img34/v034_rotating_load1.png)
