...
1. [Install CometBFT](/cometbft/v0.37/docs/guides/install)
...
To change the number of validators / non-validators change the `localnet-start` Makefile target [here](https://github.com/cometbft/cometbft/blob/v0.37.x/Makefile):
