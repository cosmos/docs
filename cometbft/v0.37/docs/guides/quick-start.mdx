...
See the [install guide](/cometbft/v0.37/docs/guides/install).
...
Then, `ssh` into each machine and install CometBFT following the [instructions](/cometbft/v0.37/docs/guides/install).
...
Persistent peers can also be specified in the `config.toml`. See [here](/cometbft/v0.37/docs/core/configuration) for more information about configuration options.
