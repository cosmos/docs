...
`H[i] =` ![formula1](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/architecture/img/formula1.png "Weighted Sum Formula")
...
`R[j] =` ![formula2](https://raw.githubusercontent.com/cometbft/cometbft/v0.37.x/docs/architecture/img/formula2.png "Fading Memories Formula")
