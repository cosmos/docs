...
[`ResponseDeliverTx`](./abci%2B%2B_methods#delivertx).

This section discusses the fields inside `ResponseDeliverTx` along with the fields in
[`ResponseCheckTx`](./abci%2B%2B_methods#checktx),
...
[`InitChain`](./abci%2B%2B_methods#initchain), and may update it during
[`EndBlock`](./abci%2B%2B_methods#endblock). In both cases, a structure of type
[`ValidatorUpdate`](./abci%2B%2B_methods#validatorupdate) is returned.
...
at block `H+2` (see Section [Methods](./abci%2B%2B_methods)).
...
[`InitChain`](./abci%2B%2B_methods#initchain), and updated in
[`EndBlock`](./abci%2B%2B_methods#endblock).
...
[`InitChain`](./abci%2B%2B_methods#initchain),
...
[methods](abci%2B%2B_methods) section.
