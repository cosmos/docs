...
[`ResponseDeliverTx`](/cometbft/v0.37/spec/abci/abci++_methods#delivertx).

This section discusses the fields inside `ResponseDeliverTx` along with the fields in
[`ResponseCheckTx`](/cometbft/v0.37/spec/abci/abci++_methods#checktx),
...
[`InitChain`](/cometbft/v0.37/spec/abci/abci++_methods#initchain), and may update it during
[`EndBlock`](/cometbft/v0.37/spec/abci/abci++_methods#endblock). In both cases, a structure of type
[`ValidatorUpdate`](/cometbft/v0.37/spec/abci/abci++_methods#validatorupdate) is returned.
...
at block `H+2` (see Section [Methods](/cometbft/v0.37/spec/abci/abci++_methods)).
...
[`InitChain`](/cometbft/v0.37/spec/abci/abci++_methods#initchain), and updated in
[`EndBlock`](/cometbft/v0.37/spec/abci/abci++_methods#endblock).
...
[timeout parameters](/cometbft/v0.37/docs/core/configuration#consensus-timeouts-explained)
...
[`InitChain`](/cometbft/v0.37/spec/abci/abci++_methods#initchain),
...
[methods](/cometbft/v0.37/spec/abci/abci++_methods) section.
