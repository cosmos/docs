...
* **Request**:
    ...
    | header               | [Header](/cometbft/v0.37/spec/core/data_structures#header) | The block header.                                                                                                 | 2            |
    ...
    | byzantine_validators | repeated [Evidence](/cometbft/v0.37/spec/abci/abci++_basic_concepts#evidence)              | List of evidence of validators that acted maliciously.                                                            | 4            |

* **Response**:

    | Name   | Type                      | Description                         | Field Number |
    |--------|---------------------------|-------------------------------------|--------------|
    | events | repeated [Event](/cometbft/v0.37/spec/abci/abci++_basic_concepts#events) | type & Key-Value events for indexing | 1           |
...
* **Response**:
    ...
    | events     | repeated [Event](/cometbft/v0.37/spec/abci/abci++_basic_concepts#events) | Type & Key-Value events for indexing transactions (eg. by account).   | 7            |
    | codespace  | string                    | Namespace for the `code`.                                             | 8            |
...
* **Response**:
    ...
    | events                  | repeated [Event](/cometbft/v0.37/spec/abci/abci++_basic_concepts#events)                    | Type & Key-Value events for indexing                            | 3            |
...
* **Usage**:
    ...
    * `consensus_param_updates` returned for block `H` apply to the consensus
      ...
      see the [application spec entry on consensus parameters](/cometbft/v0.37/spec/abci/abci++_app_requirements#consensus-parameters).
...
* **Usage**:
    ...
    * For more information, see the `Snapshot` data type or the [state sync section](https://github.com/cometbft/cometbft/blob/v0.37.x/spec/p2p/legacy-docs/messages/state-sync.md).
...
* **Request**:
    ...
    | proposer_address     | bytes                                           | [Address](/cometbft/v0.37/spec/core/data_structures#address) of the validator that is creating the proposal. | 8            |
...
* **Request**:
    ...
    | next_validators_hash | bytes                                           | Merkle root of the next validator set.                                                    | 7            |
    | proposer_address     | bytes                                           | [Address](/cometbft/v0.37/spec/core/data_structures#address) of the validator that created the proposal. | 8            |
...
* **Usage**:
    ...
    * The implementation of `ProcessProposal` MUST be deterministic. Moreover, the value of
      ...
      (see [Requirements](/cometbft/v0.37/spec/abci/abci++_app_requirements) section).
...
Most of the data structures used in ABCI are shared [common data structures](/cometbft/v0.37/spec/core/data_structures). In certain cases, ABCI uses different data structures which are documented here:
...
* **Fields**:
    ...
    | Name    | Type  | Description                                                         | Field Number |
    |---------|-------|---------------------------------------------------------------------|--------------|
    | address | bytes | [Address](/cometbft/v0.37/spec/core/data_structures#address) of validator          | 1            |
...
* **Fields**:
    ...
    | Name    | Type                                             | Description                   | Field Number |
    |---------|--------------------------------------------------|-------------------------------|--------------|
    | pub_key | [Public Key](/cometbft/v0.37/spec/core/data_structures#validator) | Public key of the validator   | 1            |
...
* **Fields**:
    ...
    | Name      | Type                                                          | Description                                                                  | Field Number |
    |-----------|---------------------------------------------------------------|------------------------------------------------------------------------------|--------------|
    | block     | [BlockParams](/cometbft/v0.37/spec/core/data_structures#blockparams)         | Parameters limiting the size of a block and time between consecutive blocks. | 1            |
    | evidence  | [EvidenceParams](/cometbft/v0.37/spec/core/data_structures#evidenceparams)   | Parameters limiting the validity of evidence of byzantine behaviour.         | 2            |
    | validator | [ValidatorParams](/cometbft/v0.37/spec/core/data_structures#validatorparams) | Parameters limiting the types of public keys validators can use.             | 3            |
    | version   | [VersionsParams](/cometbft/v0.37/spec/core/data_structures#versionparams)    | The ABCI application version.                                                | 4            |
...
* **Usage**:
    * Used for state sync snapshots, see the [state sync section](https://github.com/cometbft/cometbft/blob/v0.37.x/spec/p2p/legacy-docs/messages/state-sync.md) for details.
