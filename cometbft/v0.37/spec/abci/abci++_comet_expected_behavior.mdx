...
As mentioned in the [Basic Concepts](/cometbft/v0.37/spec/abci/abci++_basic_concepts) section, CometBFT
...
* `PrepareProposal` must create a list of [transactions](/cometbft/v0.37/spec/abci/abci++_methods#prepareproposal)
