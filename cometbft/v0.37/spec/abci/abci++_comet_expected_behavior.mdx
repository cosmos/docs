...
As mentioned in the [Basic Concepts](./abci%2B%2B_basic_concepts) section, CometBFT
...
* `PrepareProposal` must create a list of [transactions](./abci++_methods#prepareproposal)
