...
[Basic Concepts](/cometbft/v0.37/spec/abci/abci++_basic_concepts),
[Methods](/cometbft/v0.37/spec/abci/abci++_methods),
[Application Requirements](/cometbft/v0.37/spec/abci/abci++_app_requirements), and
[Expected Behavior](/cometbft/v0.37/spec/abci/abci++_comet_expected_behavior).
