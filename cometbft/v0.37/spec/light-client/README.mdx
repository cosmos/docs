...
The [English specification](verification/verification_001_published) describes the light client
...
The [English specification](detection/detection_003_reviewed)
...
and generates
[evidence](detection/detection_003_reviewed#cmbc-lc-evidence-data1)
...
The [English specification](attacks/isolate-attackers_002_reviewed)
defines the protocol that is executed on a full node upon receiving attack [evidence](detection/detection_003_reviewed#cmbc-lc-evidence-data1) from a lightclient. In particular, the protocol handles three types of attacks

- lunatic
- equivocation
- amnesia

We discussed in the [last part](attacks/isolate-attackers_002_reviewed#Part-III---Completeness) of the English specification
that the non-lunatic cases are defined by having the same validator set in the conflicting blocks. For these cases,
computer-aided analysis of  [Tendermint Consensus in TLA+](./accountability/README) shows that equivocation and amnesia capture all non-lunatic attacks.
...
[tendermint-accountability](./accountability/README)
