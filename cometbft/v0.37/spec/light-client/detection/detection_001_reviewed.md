...
[CMBC-FM-2THIRDS], as otherwise, if
[CMBC-FM-2THIRDS] would hold,
[verification](https://github.com/cometbft/cometbft/tree/v0.37.x/spec/light-client/verification) would satisfy
[LCV-SEQ-SAFE.1].

An attack detector (or detector for short) is a mechanism that is used
by the light client [supervisor](https://github.com/cometbft/cometbft/tree/v0.37.x/spec/light-client/supervisor) after
[verification](https://github.com/cometbft/cometbft/tree/v0.37.x/spec/light-client/verification) of a new light block
...
The light client [verification](https://github.com/cometbft/cometbft/tree/v0.37.x/spec/light-client/verification) specification is
designed for the Cosmos failure model (1/3 assumption)
[CMBC-FM-2THIRDS].  It is safe under this
...
correct full node. If [CMBC-FM-2THIRDS] assumption is violated, the light client
...
[verification](https://github.com/cometbft/cometbft/tree/v0.37.x/spec/light-client/verification) with the primary, and then cross-checks
...
> That is, if the Cosmos failure model
> holds, then *c* has been signed by at least one correct full node, cf.
> [[CMBC-VAL-CONTAINS-CORR.1]](https://github.com/cometbft/cometbft/blob/v0.37.x/spec/light-client/verification/verification_002_draft.md#cmbc-val-contains-corr1).
...
- [CMBC-FM-2THIRDS] may be violated
...
The detector is called in the [supervisor](https://github.com/cometbft/cometbft/tree/v0.37.x/spec/light-client/supervisor) as follows
...
via the function [FetchLightBlock](https://github.com/cometbft/cometbft/blob/v0.37.x/spec/light-client/verification/verification_002_draft.md#lcv-func-fetch1).
...
- Error condition
    ...
    period) [[LCV-INV-TP.1]](https://github.com/cometbft/cometbft/blob/v0.37.x/spec/light-client/verification/verification_002_draft.md#lcv-inv-tp1)
...
At the latest when [[LCV-INV-TP.1]](https://github.com/cometbft/cometbft/blob/v0.37.x/spec/light-client/verification/verification_002_draft.md#lcv-inv-tp1) is violated,
