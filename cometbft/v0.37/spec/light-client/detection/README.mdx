...
### [detection.md](/cometbft/v0.37/spec/light-client/detection/detection_003_reviewed)
...
### [discussions.md](/cometbft/v0.37/spec/light-client/detection/discussions)
...
### [req-ibc-detection.md](/cometbft/v0.37/spec/light-client/detection/req-ibc-detection)
...
### [draft-functions.md](/cometbft/v0.37/spec/light-client/detection/draft-functions)
