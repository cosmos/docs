---
noindex: true
canonical: 'https://docs.cosmos.network/cometbft/latest/spec/core/state'
title: State
order: 4
---
...
Further information on [`Validator`'s](/cometbft/v0.37/spec/core/data_structures#validator),
[`ValidatorSet`'s](/cometbft/v0.37/spec/core/data_structures#validatorset) and
[`ConsensusParams`'s](/cometbft/v0.37/spec/core/data_structures#consensusparams) can
be found in [data structures](/cometbft/v0.37/spec/core/data_structures)
...
[`Consensus`](/cometbft/v0.37/spec/core/data_structures#version) contains the protocol version for the blockchain and the
application.
