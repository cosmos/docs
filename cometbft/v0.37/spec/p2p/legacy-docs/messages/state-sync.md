...
| Name          | Type                                                    | Description                          | Field Number |
|---------------|---------------------------------------------------------|--------------------------------------|--------------|
| light_block   | [LightBlock](/cometbft/v0.37/spec/core/data_structures#lightblock)  | Light block at the height requested  | 1            |

State sync will use [light client verification](/cometbft/v0.37/spec/light-client/verification/README) to verify
the light blocks.
