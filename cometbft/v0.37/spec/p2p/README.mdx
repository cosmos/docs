...
- [`implementation`](https://github.com/cometbft/cometbft/tree/v0.37.x/spec/p2p/implementation): documents the current state
...
- [`reactor-api`](https://github.com/cometbft/cometbft/tree/v0.37.x/spec/p2p/reactor-api): specifies the API offered by the
...
- [`legacy-docs`](https://github.com/cometbft/cometbft/tree/v0.37.x/spec/p2p/legacy-docs): We keep older documentation in 
