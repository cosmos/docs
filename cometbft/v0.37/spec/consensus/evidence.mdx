---
noindex: true
canonical: 'https://docs.cosmos.network/cometbft/latest/spec/consensus/evidence'
title: Evidence
order: 4
---
...
[here](https://github.com/cometbft/cometbft/blob/v0.37.x/spec/light-client/detection/detection_003_reviewed.md), involves comparison
...
[validation criteria](https://github.com/cometbft/cometbft/blob/v0.37.x/spec/light-client/verification/verification_001_published.md)
