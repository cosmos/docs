...
- [Fee Distribution](#fee-distribution) → See [distribution.md](/enterprise/components/poa/distribution)
- [Governance](#governance) → See [governance.md](/enterprise/components/poa/governance)
...
- Fees are routed to the PoA module account via a custom ante handler (see [Fee Routing Setup](/enterprise/components/poa/distribution.mdx#fee-routing-setup) for complete details).
...
**Key Features**:
- Fees accumulate in [the PoA module account](/enterprise/components/poa/distribution#fee-routing-setup)
