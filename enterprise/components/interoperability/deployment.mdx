...
description: "End-to-end IBC v2 deployment for mint/burn transfers between Cosmos and EVM chains."
---

<Tip>
To see this architecture in a working example, follow the [Cosmos ↔ EVM Interoperability Tutorial](/ibc/next/cosmos-evm/tutorial/introduction).
</Tip>

This document explains how an IBC v2 deployment works end-to-end to support mint/burn transfers between Cosmos and EVM chains using the IBC v2 protocol, the [enterprise-ready relayer](/enterprise/components/interoperability/relayer), and the [attestor service](/enterprise/components/interoperability/attestor).
...
- **Interchain Fungible Token (IFT)** — A set of rules and interfaces for creating and managing fungible tokens that can be transferred across different blockchain networks using ICS-27 GMP.
  - Implementation: [cosmos/solidity-ibc-eureka IFTBase.sol](https://github.com/cosmos/solidity-ibc-eureka/blob/815ddaf194c81f2098c88afb9d73108687bb48eb/contracts/utils/IFTBaseUpgradeable.sol)
