...
![Attestor Component Structure](/assets/enterprise/interoperability/attestor-diagram.png)
...
For detailed deployment instructions, see the [Attestor Deployment Guide](/enterprise/components/interoperability/deployment-attestor).
