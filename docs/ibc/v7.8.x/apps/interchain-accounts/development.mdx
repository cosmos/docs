...
The underlying application may continue to be used as a short term solution for ADR 008 and the [legacy API](/docs/ibc/v7.8.x/10-legacy/auth-modules) should continue to be utilized in such situations.
