...
In the first case, the smart contract should use the [`MsgServer`](messages).

In the second case, the underlying application should use the [legacy API](10-legacy/keeper-api).
