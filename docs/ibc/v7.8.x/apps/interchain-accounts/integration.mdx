...
Alternatively, submodules can be enabled and disabled dynamically using [on-chain parameters](/docs/ibc/v7.8.x/apps/interchain-accounts/parameters.mdx).
