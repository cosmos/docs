...
You can find the version matrix in [here](/docs/ibc/v7.8.x////docs/03-light-clients/04-wasm/integration#importing-the-08-wasm-module).
...
Or alternatively the parameter can be updated via a governance proposal (see at the bottom of section [`Creating clients`](/docs/ibc/v7.8.x/03-light-clients/01-developer-guide/setup#creating-clients) for an example of how to do this).
