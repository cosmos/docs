...
Or alternatively the parameter can be updated via a governance proposal (see at the bottom of section [`Creating clients`](/docs/ibc/v7.8.x/01-developer-guide/09-setup#creating-clients) for an example of how to do this).
