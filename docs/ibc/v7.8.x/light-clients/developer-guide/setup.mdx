...
Please refer to the [core IBC documentation](/docs/ibc/v7.8.x/ibc/integration.mdx#integrating-light-clients) for how to configure additional light client modules alongside `07-tendermint` in `app.go`.
