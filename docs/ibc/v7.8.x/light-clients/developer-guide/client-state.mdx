...
For more information about client upgrades see the [Handling upgrades](/docs/ibc/v7.8.x/light-clients/developer-guide/upgrades.mdx) section.
...
see the [Existence and non-existence proofs section](/docs/ibc/v7.8.x/light-clients/developer-guide/proofs.mdx).
