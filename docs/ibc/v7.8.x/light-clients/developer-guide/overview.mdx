...
* [IBC Overview](/docs/ibc/v7.8.x//01-ibc/01-overview)
...
The methods which make up this interface are detailed at a more granular level in the [ClientState section of this guide](02-client-state).
...
The methods which make up this interface are detailed at a more granular level in the [`ConsensusState` section of this guide](03-consensus-state).
...
Learn more in the [Handling update and misbehaviour](04-updates-and-misbehaviour) section.
