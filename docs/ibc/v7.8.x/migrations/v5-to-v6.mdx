...
For more information please refer to [ADR 009](/docs/ibc/v6.3.x/architecture/adr-009-v6-ics27-msgserver).
...
![auth-module-decision-tree.png](/docs/ibc/images/05-migrations/images/auth-module-decision-tree.png)
