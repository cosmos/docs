...
Please read the Fee Middleware [integration documentation](/docs/ibc/v7.8.x/04-middleware/01-ics29-fee/integration) for an in depth guide on how to configure the module correctly in order to incentivize IBC packets.
