...
* [IBC middleware development](/docs/ibc/v7.8.x//ibc/middleware/develop)
* [IBC middleware integration](/docs/ibc/v7.8.x//01-ibc/04-middleware/integration)
...
You can find the version matrix in [here](/docs/ibc/v7.8.x////docs/04-middleware/01-callbacks/integration#importing-the-callbacks-middleware).

## Configuring an application stack with the callbacks middleware

As mentioned in [IBC middleware development](/docs/ibc/v7.8.x//ibc/middleware/develop) an application stack may be composed of many or no middlewares that nest a base application.
