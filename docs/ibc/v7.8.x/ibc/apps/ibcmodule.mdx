...
* [IBC Overview](/docs/ibc/v7.8.x/overview))
* [IBC default integration](/docs/ibc/v7.8.x/integration)

</Note>

## Channel handshake callbacks

This section will describe the callbacks that are called during channel handshake execution. Among other things, it will claim channel capabilities passed on from core IBC. For a refresher on capabilities, check [the Overview section](/docs/ibc/v7.8.x/overview#capabilities).
