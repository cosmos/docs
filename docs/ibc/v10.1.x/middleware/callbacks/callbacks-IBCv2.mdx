...
* The callbacks middleware for IBC v2 requires the [`Underlying Application`](/docs/ibc/v10.1.x/01-callbacks/overview) to implement the new [`CallbacksCompatibleModuleV2`](https://github.com/cosmos/ibc-go/blob/main/modules/apps/callbacks/types/callbacks.go#L53-L58) interface.
