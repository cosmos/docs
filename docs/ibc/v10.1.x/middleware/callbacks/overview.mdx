...
![callbacks-middleware](../../../images/04-middleware/01-callbacks/images/callbackflow.svg)

And the following diagram shows how a typical `SendPacket` and `WriteAcknowledgement` execution flow would look like:
![callbacks-middleware](../../../images/04-middleware/01-callbacks/images/ics4-callbackflow.svg)
