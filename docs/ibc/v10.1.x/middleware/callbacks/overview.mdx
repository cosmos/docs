...
![callbacks-middleware](/docs/ibc/images/middleware/callbacks/callbackflow.svg)

And the following diagram shows how a typical `SendPacket` and `WriteAcknowledgement` execution flow would look like:
![callbacks-middleware](/docs/ibc/images/middleware/callbacks/ics4-callbackflow.svg)
