...
* [documentation on developing custom middleware](develop)
* [documentation on integrating middleware into a stack on a chain](integration)
...
* **The order of the middleware matters** (more on how to correctly define your stack in the code will follow in the [integration section](integration)).
