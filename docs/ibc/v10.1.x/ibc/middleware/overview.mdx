...
* [documentation on ./developing custom middleware](/docs/ibc/v10.1.x/ibc/middleware/develop)
* [documentation on integrating middleware into a stack on a chain](/docs/ibc/v10.1.x/ibc/middleware/integration)
...
* [IBC Integration](/docs/ibc/v10.1.x/ibc/./integration)
* [IBC Application Developer Guide](/docs/ibc/v10.1.x/ibc/apps/apps)
...
* **The order of the middleware matters** (more on how to correctly define your stack in the code will follow in the [./integration section](/docs/ibc/v10.1.x/ibc/middleware/integration)).
