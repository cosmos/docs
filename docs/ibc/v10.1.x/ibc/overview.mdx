...
* the [IBC module callback `OnChanCloseInit`](/docs/ibc/v10.1.x/apps/ibcmodule.mdx#channel-closing-callbacks) returns `nil`.
...
* the [IBC module callback `OnChanCloseConfirm`](/docs/ibc/v10.1.x/apps/ibcmodule.mdx#channel-closing-callbacks) returns `nil`.
