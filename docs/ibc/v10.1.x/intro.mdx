...
<Note>
  **Notice** Since ibc-go v10, there are two versions of the protocol in the
  same release: IBC classic and IBC v2. The protocols are seperate - a
  connection uses either IBC classic or IBC v2
</Note>
...
![Light Mode IBC Overview](./../images/./images/ibcoverview-light.svg#gh-light-mode-only)![Dark Mode IBC Overview](./../images/./images/ibcoverview-dark.svg#gh-dark-mode-only)
