...
* [IBC Overview](/docs/ibc/v10.1.x//01-ibc/01-overview)
...
The methods which make up this interface are detailed at a more granular level in the [`LightClientModule` section of this guide](02-light-client-module).
...
The methods which make up this interface are detailed at a more granular level in the [`ClientState` section of this guide](03-client-state).
...
The methods which make up this interface are detailed at a more granular level in the [`ConsensusState` section of this guide](04-consensus-state).
...
Learn more in the [Handling update and misbehaviour](05-updates-and-misbehaviour) section.
