...
Contract developers should familiarise themselves with the migration path offered by 08-wasm [here](/docs/ibc/v10.1.x/05-governance#migrating-an-existing-wasm-light-client-contract).
