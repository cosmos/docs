...
To supplement this, a [sentinel `ConnectionEnd` is stored in core IBC](/docs/ibc/v10.1.x/light-clients/localhost/connection) state with the connection
...
[State verification](/docs/ibc/v10.1.x/light-clients/localhost/state-verification) for channel state in handshakes or processing packets is reduced in
