...
![ica-pre-v6.png](/docs/ibc/images/02-apps/02-interchain-accounts/apps/interchain-accounts/legacy/images/ica-pre-v6.png)
...
Alternatively, submodules can be enabled and disabled dynamically using [on-chain parameters](/docs/ibc/v10.1.x/apps/interchain-accounts/parameters).
