...
Alternatively, submodules can be enabled and disabled dynamically using [on-chain parameters](/docs/ibc/v10.1.x/apps/interchain-accounts/parameters.mdx).
