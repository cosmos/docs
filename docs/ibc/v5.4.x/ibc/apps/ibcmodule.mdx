...
* [IBC Overview](/docs/ibc/v5.4.x/ibc/overview)
...
This section will describe the callbacks that are called during channel handshake execution. Among other things, it will claim channel capabilities passed on from core IBC. For a refresher on capabilities, check [the Overview section](/docs/ibc/v5.4.x/ibc/overview#capabilities).
...
![IBC packet flow diagram](/docs/ibc/images/01-ibc/03-apps/images/packet_flow.png)
