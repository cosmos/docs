...
* [IBC middleware development](/docs/ibc/v5.4.x/ibc/middleware/develop)
* [IBC middleware integration](/docs/ibc/v5.4.x/ibc/middleware/integration)
...
As mentioned in [IBC middleware development](/docs/ibc/v5.4.x/ibc/middleware/develop) an application stack may be composed of many or no middlewares that nest a base application.
