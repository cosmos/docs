...
* [IBC middleware development](/docs/ibc/v4.6.x//01-ibc/04-middleware/01-develop)
* [IBC middleware integration](/docs/ibc/v4.6.x//01-ibc/04-middleware/02-integration)
...
As mentioned in [IBC middleware development](/docs/ibc/v4.6.x//01-ibc/04-middleware/01-develop) an application stack may be composed of many or no middlewares that nest a base application.
