...
Please read the Fee Middleware [integration documentation](/docs/ibc/v4.6.x/03-middleware/01-ics29-fee/02-integration) for an in depth guide on how to configure the module correctly in order to incentivize IBC packets.
