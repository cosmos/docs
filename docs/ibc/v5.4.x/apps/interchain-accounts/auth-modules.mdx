...
To integrate the authentication module into your chain, please follow the steps outlined above in [app.go integration](/docs/ibc/v5.4.x/apps/interchain-accounts/integration.mdx#example-integration).
