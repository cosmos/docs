...
Please refer to the [core IBC documentation](/docs/ibc/v8.5.x//01-ibc/02-integration#integrating-light-clients) for how to configure additional light client modules alongside `07-tendermint` in `app.go`.
