...
For more information about client upgrades see the [Handling upgrades](/docs/ibc/v8.5.x/light-clients/developer-guide/upgrades) section.
...
see the [Existence and non-existence proofs section](/docs/ibc/v8.5.x/light-clients/developer-guide/proofs).
