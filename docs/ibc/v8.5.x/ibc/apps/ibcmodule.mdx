...
* [IBC Overview](/docs/ibc/v8.5.x/01-overview)
* [IBC default integration](/docs/ibc/v8.5.x/02-integration)

</Note>

## Channel handshake callbacks

This section will describe the callbacks that are called during channel handshake execution. Among other things, it will claim channel capabilities passed on from core IBC. For a refresher on capabilities, check [the Overview section](/docs/ibc/v8.5.x/01-overview#capabilities).
