...
* [documentation on ./developing custom middleware](/docs/ibc/v8.5.x/ibc/middleware/develop.mdx)
* [documentation on integrating middleware into a stack on a chain](/docs/ibc/v8.5.x/ibc/middleware/integration.mdx)
...
* [IBC Integration](/docs/ibc/v10.1.x/./integration)
* [IBC Application Developer Guide](/docs/ibc/v10.1.x/03-apps/apps)
...
* **The order of the middleware matters** (more on how to correctly define your stack in the code will follow in the [./integration section](/docs/ibc/v8.5.x/ibc/middleware/integration.mdx)).
