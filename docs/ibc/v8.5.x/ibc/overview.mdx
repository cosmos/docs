...
capability store](/docs/common/pages/adr-comprehensive#adr-003-dynamic-capability-store). Upon binding to a port or
...
- the [IBC module callback `OnChanCloseInit`](/docs/ibc/v8.5.x/ibc/apps/ibcmodule#channel-closing-callbacks) returns `nil`.
...
- the [IBC module callback `OnChanCloseConfirm`](/docs/ibc/v8.5.x/ibc/apps/ibcmodule#channel-closing-callbacks) returns `nil`.
