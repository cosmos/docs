...
* the [IBC module callback `OnChanCloseInit`](/docs/ibc/v8.5.x/apps/ibcmodule#channel-closing-callbacks) returns `nil`.
...
* the [IBC module callback `OnChanCloseConfirm`](/docs/ibc/v8.5.x/apps/ibcmodule#channel-closing-callbacks) returns `nil`.
