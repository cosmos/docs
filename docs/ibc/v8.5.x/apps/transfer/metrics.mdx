...
The IBC transfer application module exposes the following set of [metrics](/docs/ibc/v8.5.x/apps/transfer/hhttps:/docs.cosmos.network/main/learn/advanced/telemetry).
