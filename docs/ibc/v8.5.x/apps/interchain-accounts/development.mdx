...
In the first case, the smart contract should use the [`MsgServer`](/docs/ibc/v8.5.x/apps/interchain-accounts/messages).

In the second case, the underlying application should use the [legacy API](/docs/ibc/v8.5.x/apps/interchain-accounts/apps/interchain-accounts/legacy/keeper-api).
