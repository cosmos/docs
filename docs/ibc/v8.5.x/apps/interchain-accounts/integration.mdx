...
Alternatively, submodules can be enabled and disabled dynamically using [on-chain parameters](/docs/ibc/v8.5.x/apps/interchain-accounts/parameters.mdx).
