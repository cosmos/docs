...
![callbacks-middleware](/docs/ibc/images/04-middleware/02-callbacks/images/callbackflow.svg)

And the following diagram shows how a typical `SendPacket` and `WriteAcknowledgement` execution flow would look like:
![callbacks-middleware](/docs/ibc/images/04-middleware/02-callbacks/images/ics4-callbackflow.svg)
