...
* [IBC middleware development](/docs/ibc/v8.5.x//01-ibc/04-middleware/02-develop)
* [IBC middleware integration](/docs/ibc/v8.5.x//01-ibc/04-middleware/03-integration)
...
You can find the version matrix in [here](/docs/ibc/v8.5.x////docs/04-middleware/01-callbacks/02-integration#importing-the-callbacks-middleware).

## Configuring an application stack with the callbacks middleware

As mentioned in [IBC middleware development](/docs/ibc/v8.5.x//01-ibc/04-middleware/02-develop) an application stack may be composed of many or no middlewares that nest a base application.
