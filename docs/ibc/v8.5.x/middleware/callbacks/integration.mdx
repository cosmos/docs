...
* [IBC middleware development](/docs/ibc/v8.5.x/ibc/middleware/develop.mdx)
* [IBC middleware integration](/docs/ibc/v8.5.x/ibc/middleware/integration.mdx)
...
As mentioned in [IBC middleware development](/docs/ibc/v8.5.x/ibc/middleware/develop.mdx) an application stack may be composed of many or no middlewares that nest a base application.
