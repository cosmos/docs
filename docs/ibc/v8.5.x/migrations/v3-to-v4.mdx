...
Please read the Fee Middleware [integration documentation](/docs/ibc/v8.5.x/light-clients/wasm/integration) for an in depth guide on how to configure the module correctly in order to incentivize IBC packets.
