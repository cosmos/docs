...
To integrate the authentication module into your chain, please follow the steps outlined above in [app.go integration](/docs/ibc/v4.6.x/apps/interchain-accounts/integration#example-integration).
