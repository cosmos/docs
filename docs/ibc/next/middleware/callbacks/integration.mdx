...
<Tip>
An example integration for an IBC v2 transfer stack using the callbacks middleware can be found in the [ibc-go module integration](/docs/ibc/next/ibc/integration.mdx) section
</Tip>
...
* [IBC middleware development](/docs/ibc/next/ibc/middleware/develop.mdx)
* [IBC middleware integration](/docs/ibc/next/ibc/middleware/integration.mdx)
...
As mentioned in [IBC middleware development](/docs/ibc/next/ibc/middleware/develop.mdx) an application stack may be composed of many or no middlewares that nest a base application.
