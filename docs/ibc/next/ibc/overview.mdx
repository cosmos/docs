...
* the [IBC module callback `OnChanCloseInit`](/docs/ibc/next/ibc/apps/ibcmodule.mdx#channel-closing-callbacks) returns `nil`.
...
* the [IBC module callback `OnChanCloseConfirm`](/docs/ibc/next/ibc/apps/ibcmodule.mdx#channel-closing-callbacks) returns `nil`.
