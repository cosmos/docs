...
* the [IBC module callback `OnChanCloseInit`](./apps/ibcmodule#channel-closing-callbacks) returns `nil`.
...
* the [IBC module callback `OnChanCloseConfirm`](./apps/ibcmodule#channel-closing-callbacks) returns `nil`.
