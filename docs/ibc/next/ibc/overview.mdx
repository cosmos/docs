...
* the [IBC module callback `OnChanCloseInit`](/docs/ibc/v10.1.x/03-apps/02-ibcmodule#channel-closing-callbacks) returns `nil`.
...
* the [IBC module callback `OnChanCloseConfirm`](/docs/ibc/v10.1.x/03-apps/02-ibcmodule#channel-closing-callbacks) returns `nil`.
