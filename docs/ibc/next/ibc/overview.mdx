...
- the [IBC module callback `OnChanCloseInit`](/docs/ibc/next/ibc/apps/ibcmodule#channel-closing-callbacks) returns `nil`.
...
- the [IBC module callback `OnChanCloseConfirm`](/docs/ibc/next/ibc/apps/ibcmodule#channel-closing-callbacks) returns `nil`.
