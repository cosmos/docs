...
* [documentation on developing custom middleware](02-develop)
* [documentation on integrating middleware into a stack on a chain](03-integration)

<Note>

## Pre-requisite readings

* [IBC Overview](/docs/ibc/v10.1.x/01-overview)
* [IBC Integration](/docs/ibc/v10.1.x/02-integration)
* [IBC Application Developer Guide](/docs/ibc/v10.1.x/03-apps/01-apps)
...
* **The order of the middleware matters** (more on how to correctly define your stack in the code will follow in the [integration section](03-integration)).
