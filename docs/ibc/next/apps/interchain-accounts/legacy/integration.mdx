...
![ica-pre-v6.png](../../../../images/02-apps/02-interchain-accounts/apps/interchain-accounts/legacy/images/ica-pre-v6.png)
...
Alternatively, submodules can be enabled and disabled dynamically using [on-chain parameters](/docs/ibc/next/apps/interchain-accounts/parameters.mdx).
