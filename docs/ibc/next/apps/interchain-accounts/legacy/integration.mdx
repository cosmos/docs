...
![ica-pre-v6.png](../../../../images/02-apps/02-interchain-accounts/10-legacy/images/ica-pre-v6.png)
...
Alternatively, submodules can be enabled and disabled dynamically using [on-chain parameters](/docs/ibc/v10.1.x/06-parameters).
