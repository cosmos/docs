...
To integrate the authentication module into your chain, please follow the steps outlined in [`app.go` integration](/docs/ibc/next/apps/interchain-accounts/integration#example-integration).
