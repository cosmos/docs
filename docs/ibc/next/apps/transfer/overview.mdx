...
It is strongly recommended to read the full details of [ADR 001: Coin Source Tracing](/docs/ibc/v10.1.x/architecture/adr-001-coin-source-tracing) to understand the implications and context of the IBC token representations.
