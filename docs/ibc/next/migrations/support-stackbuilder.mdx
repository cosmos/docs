...
Refer to the [integration guide](/docs/ibc/next/ibc/middleware/integration) to understand how to use this new middleware to improve middleware wiring in the chain application setup.
