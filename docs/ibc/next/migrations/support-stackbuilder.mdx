...
Refer to the [integration guide](/docs/ibc/next/01-ibc/04-middleware/03-integration) to understand how to use this new middleware to improve middleware wiring in the chain application setup.
