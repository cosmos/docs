...
**Pages**: 74
**Scope**: Complete IBC v2 protocol implementation

The most comprehensive audit covering the next major version of IBC, including all protocol improvements, new features, and architectural enhancements planned for IBC v2.

<Card
  title="IBC v2 Audit Report"
  icon="file-pdf"
  href="https://github.com/cosmos/ibc-go/blob/main/docs/audits/IBC-v2/IBC-v2-April-2025-Collaborative-Audit-Report.pdf"
>
  Complete security assessment of IBC v2 protocol (74 pages)
</Card>
