...
The methods which make up this interface are detailed at a more granular level in the [`LightClientModule` section of this guide](light-client-module).
...
The methods which make up this interface are detailed at a more granular level in the [`ClientState` section of this guide](client-state).
...
The methods which make up this interface are detailed at a more granular level in the [`ConsensusState` section of this guide](consensus-state).
...
Learn more in the [Handling update and misbehaviour](updates-and-misbehaviour) section.
