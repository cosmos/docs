...
To supplement this, a [sentinel `ConnectionEnd` is stored in core IBC](04-connection) state with the connection
...
[State verification](05-state-verification) for channel state in handshakes or processing packets is reduced in
