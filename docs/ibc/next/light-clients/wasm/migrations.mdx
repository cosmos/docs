...
Contract developers should familiarise themselves with the migration path offered by 08-wasm [here](./governance#migrating-an-existing-wasm-light-client-contract).
