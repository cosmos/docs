...
Contract developers should familiarise themselves with the migration path offered by 08-wasm [here](/docs/ibc/next/light-clients/wasm/governance#migrating-an-existing-wasm-light-client-contract).
