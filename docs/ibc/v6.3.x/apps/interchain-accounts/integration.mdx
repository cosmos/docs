...
Alternatively, submodules can be enabled and disabled dynamically using [on-chain parameters](/docs/ibc/v6.3.x/apps/interchain-accounts/parameters.mdx).
