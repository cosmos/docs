...
![ica-pre-v6.png](../../../../images/02-apps/02-interchain-accounts/09-legacy/images/ica-pre-v6.png)
...
Alternatively, submodules can be enabled and disabled dynamically using [on-chain parameters](/docs/ibc/v6.3.x/06-parameters).
