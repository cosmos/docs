...
See [ADR-03](/docs/ibc/v6.3.x/architecture/adr-003-ics27-acknowledgement#next-major-version-format) for more information or the [corresponding documentation about authentication modules](/docs/ibc/v6.3.x/02-apps/02-interchain-accounts/03-auth-modules#onacknowledgementpacket).
