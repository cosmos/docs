...
* [IBC Overview](/docs/ibc/v6.3.x/ibc/overview.mdx)
* [IBC default integration](/docs/ibc/v6.3.x/ibc/integration.mdx)

</Note>

## Channel handshake callbacks

This section will describe the callbacks that are called during channel handshake execution. Among other things, it will claim channel capabilities passed on from core IBC. For a refresher on capabilities, check [the Overview section](/docs/ibc/v6.3.x/ibc/overview.mdx#capabilities).
