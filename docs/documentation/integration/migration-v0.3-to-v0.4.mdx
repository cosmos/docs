...
- **Migrate ERC20 precompiles if you have existing token pairs** (see [Section 5](#5-erc20-precompiles-migration))
...
## 4. Precompiles: optionals + codec injection
...
## 7. Rollout checklist (operational)
