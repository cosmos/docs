...
description: "Integrating the EVM module into your Cosmos-SDK project"
---
...
<Check>
Ensure the following components are working correctly:
- JSON-RPC server starts on configured port (default: 8545)
- MetaMask can connect to your local node
- Precompiles are accessible at expected addresses
- IBC tokens automatically register as ERC20s
</Check>
...
<Info>
This section covers common issues encountered during EVM module integration and their solutions.
</Info>
...
<Tip>
Always check [github.com/cosmos/evm](https://github.com/cosmos/evm) for the latest updates, examples, and additional troubleshooting resources.
</Tip>