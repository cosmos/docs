...
* Perform upgrades in place, which significantly decrease the upgrade time for chains with a larger state. Use the [Module Upgrade Guide](/docs/sdk/v0.47//build/building-modules/13-upgrade) to set up your application modules to take advantage of in-place upgrades.
...
To learn more about configuring migration scripts for your modules, see the [Module Upgrade Guide](/docs/sdk/v0.47//build/building-modules/13-upgrade).
...
To learn more about Cosmovisor, see the [Cosmovisor Quick Start](/docs/sdk/v0.47//build/tooling/01-cosmovisor).
