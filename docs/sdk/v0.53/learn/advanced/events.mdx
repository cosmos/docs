...
* [`BeginBlock`](/docs/sdk/v0.53/learn/advanced/baseapp#beginblock)
* [`EndBlock`](/docs/sdk/v0.53/learn/advanced/baseapp#endblock)
* [`CheckTx`](/docs/sdk/v0.53/learn/advanced/baseapp#checktx)
* [`Transaction Execution`](/docs/sdk/v0.53/learn/advanced/baseapp#transactionexecution)
...
the [`Context`](/docs/sdk/v0.53/learn/advanced/context), where Event should be already registered, and emitted like this:
...
Where the `EventManager` is accessed via the [`Context`](/docs/sdk/v0.53/learn/advanced/context).
...
where `ownerAddress` is an address following the [`AccAddress`](/docs/sdk/v0.53/learn/beginner/accounts#addresses) format.
