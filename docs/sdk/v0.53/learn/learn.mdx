...
title: Learn
---
* [Introduction](/docs/sdk/v0.53/intro/00-overview) -  Dive into the fundamentals of Cosmos SDK with an insightful introduction,
...
* [Beginner](/docs/sdk/v0.53/beginner/00-app-anatomy) - Start your journey with beginner-friendly resources in the Cosmos SDK's "Learn"
...
* [Advanced](/docs/sdk/v0.53/advanced/00-baseapp) - Level up your Cosmos SDK expertise with advanced topics, tailored for experienced
