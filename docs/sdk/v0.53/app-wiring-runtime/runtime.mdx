...
Learn more about wiring `runtime` in the [next section](/docs/sdk/v0.53/01-app-go-di.md).
...
More information on building applications can be found in the [next section](/docs/sdk/v0.53/02-app-building.md).
