...
also potentially doing a backup. The SDK tool for doing such, is called [Cosmovisor](/docs/sdk/v0.53/tooling/cosmovisor).
...
Read more about [Cosmovisor](/docs/sdk/v0.53/tooling/cosmovisor), the tool for automating upgrades.
