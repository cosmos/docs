...
* [Mitigating Front-running with Vote Extensions](/docs/sdk/next/tutorials/vote-extensions/auction-frontrunning/mitigating-front-running-with-vote-extesions)
