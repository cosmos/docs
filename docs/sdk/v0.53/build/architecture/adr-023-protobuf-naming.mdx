...
In [ADR 021](./docs/sdk/v0.53/build/architecture/adr-021-protobuf-query-encoding.mdx), gRPC was adopted for Protobuf
...
[ADR 021](./docs/sdk/v0.53/build/architecture/adr-021-protobuf-query-encoding.mdx) specifies that modules should
