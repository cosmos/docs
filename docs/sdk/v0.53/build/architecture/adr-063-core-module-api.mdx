...
* [ADR 033: Protobuf-based Inter-Module Communication](/docs/sdk/v0.53/build/architecture/adr-033-protobuf-inter-module-comm) clients.
...
implementations of these services to modules via both [dependency injection](/docs/sdk/v0.53/build/architecture/adr-057-app-wiring) and
...
The [ORM](/docs/sdk/v0.53/build/architecture/adr-055-orm) and [collections](/docs/sdk/v0.53/build/architecture/adr-062-collections-state-layer) both support
...
as possible during initialization and in [ADR 057: App Wiring](/docs/sdk/v0.53/build/architecture/adr-057-app-wiring-1), protobuf type registration\
...
[autocli](/docs/sdk/v0.53/build/architecture/adr-058-auto-generated-cli) framework.

#### Example Usage

Here is an example of setting up a hypothetical `foo` v2 module which uses the [ORM](/docs/sdk/v0.53/build/architecture/adr-055-orm) for its state
...
semantically versioned Cosmos SDK module as described in [ADR 057: App Wiring](/docs/sdk/v0.53/build/architecture/adr-057-app-wiring).
...
* [ADR 033: Protobuf-based Inter-Module Communication](/docs/sdk/v0.53/build/architecture/adr-033-protobuf-inter-module-comm)
* [ADR 057: App Wiring](/docs/sdk/v0.53/build/architecture/adr-057-app-wiring-1)
