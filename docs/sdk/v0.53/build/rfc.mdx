...
The [rfc-template.md](/docs/sdk/v0.53/build/rfc/rfc-template) file includes placeholders for these sections.

## Table of Contents[​](#table-of-contents "Direct link to Table of Contents")

* [RFC-001: Tx Validation](/docs/sdk/v0.53/build/rfc/rfc-001-tx-validation)
