...
* [BaseApp](/docs/sdk/v0.53/learn/advanced/baseapp)
* [ABCI](/docs/sdk/v0.53/build/abci/introduction)
...
By default, the SDK uses the [No-op Mempool](#no-op-mempool), but it can be replaced by the application developer in [`app.go`](/docs/sdk/v0.53/build/building-apps/app-go-di):
