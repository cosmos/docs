...
Runtime has built-in support for [`depinject`-enabled modules](/docs/sdk/v0.53/build/building-modules/depinject).
...
More information on building applications can be found in the [next section](/docs/sdk/v0.53/build/building-apps/app-go).
