...
The Cosmos SDK allows much easier wiring of an `app.go` thanks to [runtime](/docs/sdk/v0.53/build/building-apps/runtime) and app wiring.
...
1. Create the `AppConfig` variable:
   ...
   Where the `appConfig` combines the [runtime](/docs/sdk/v0.53/build/building-apps/runtime) configuration and the (extra) modules configuration.
