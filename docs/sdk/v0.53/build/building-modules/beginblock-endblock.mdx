...
* [Module Manager](/docs/sdk/v0.53/build/building-modules/docs/sdk/v0.53/build/building-modules/module-manager)
...
It is possible for developers to define the order of execution between the `BeginBlocker`/`EndBlocker` functions of each of their application's modules via the module's manager `SetOrderBeginBlocker`/`SetOrderEndBlocker` methods. For more on the module manager, click [here](/docs/sdk/v0.53/build/building-modules/docs/sdk/v0.53/build/building-modules/module-manager).
