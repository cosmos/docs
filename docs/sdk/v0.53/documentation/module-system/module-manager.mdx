...
- [Introduction to Cosmos SDK Modules](/docs/sdk/v0.53/documentation/module-system/intro)
...
- `DefaultGenesis(codec.JSONCodec)`: Returns a default [`GenesisState`](/docs/sdk/v0.53/documentation/module-system/genesis#genesisstate) for the module, marshalled to `json.RawMessage`. The default `GenesisState` need to be defined by the module developer and is primarily used for testing.
...
- `RegisterInvariants(ir sdk.InvariantRegistry)`: Registers the [invariants](/docs/sdk/v0.53/documentation/module-system/invariants) of module implementing the `HasInvariants` interface.
