...
<Note>
**Synopsis**
`PreBlocker` is optional method module developers can implement in their module. They will be triggered before [`BeginBlock`](/docs/sdk/v0.50/documentation/application-framework/baseapp#beginblock).
</Note>
