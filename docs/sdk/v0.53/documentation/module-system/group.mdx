...
Location: off-chain as json object stored on IPFS (mirrors [gov proposal](/docs/sdk/v0.53/documentation/module-system/gov#metadata))
...
Location: on-chain as json within 255 character limit (mirrors [gov vote](/docs/sdk/v0.53/documentation/module-system/gov#metadata))
