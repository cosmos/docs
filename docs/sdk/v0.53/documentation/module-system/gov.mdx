...
Location: off-chain as json object stored on IPFS (mirrors [group proposal](/docs/sdk/v0.53/group/README#metadata))
...
Location: on-chain as json within 255 character limit (mirrors [group vote](/docs/sdk/v0.53/group/README#metadata))
