...
[ADR-037](docs/sdk/next/documentation/legacy/adr-comprehensive) introduces the weighted vote feature which allows a staker to split their votes into several voting options. For example, it could use 70% of its voting power to vote Yes and 30% of its voting power to vote No.
...
results[v1.OptionNoWithVeto] = math.LegacyZeroDec()
    rng := collections.NewPrefixedPairRange[uint64, sdk.AccAddress](/docs/sdk/v0.53/documentation/module-system/proposal.Id)
...
Location: off-chain as json object stored on IPFS (mirrors [group proposal](/docs/sdk/v0.53/documentation/module-system/group#metadata))
...
Location: on-chain as json within 255 character limit (mirrors [group vote](/docs/sdk/v0.53/documentation/module-system/group#metadata))
