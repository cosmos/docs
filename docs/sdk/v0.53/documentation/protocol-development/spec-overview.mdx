...
* [Store](/docs/sdk/v0.53/documentation/state-storage/store) - The core Merkle store that holds the state.
* [Bech32](/docs/sdk/v0.53/documentation/protocol-development/bech32) - Address format for Cosmos SDK applications.
