...
**CRITICAL**: If your chain uses IBC, you MUST upgrade to IBC-Go v10.x when upgrading to SDK v0.53. IBC-Go v8.x is **NOT** compatible with SDK v0.53. See the [IBC-Go Compatibility section](#ibc-go-compatibility-critical) below for details.

</Warning>

## Table of Contents

* [IBC-Go Compatibility (CRITICAL)](#ibc-go-compatibility-critical)
