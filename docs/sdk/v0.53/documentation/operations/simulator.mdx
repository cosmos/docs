...
* [Cosmos Blockchain Simulator](/docs/sdk/v0.53/documentation/operations/simulation)
...
func Run[T SimulationApp](/docs/sdk/v0.53/documentation/operations/
	t *testing.T,
	appFactory func(
		logger log.Logger,
		db dbm.DB,
...
func RunWithSeeds[T SimulationApp](/docs/sdk/v0.53/documentation/operations/
	t *testing.T,
	appFactory func(
		logger log.Logger,
		db dbm.DB,
...
func RunWithSeedsAndRandAcc[T SimulationApp](/docs/sdk/v0.53/documentation/operations/
	t *testing.T,
	appFactory func(
		logger log.Logger,
		db dbm.DB,
...
/ The execution is deterministic and can be used for fuzz tests as well.
func RunWithSeed[T SimulationApp](/docs/sdk/v0.53/documentation/operations/
	tb testing.TB,
	cfg simtypes.Config,
...
func RunWithSeedAndRandAcc[T SimulationApp](/docs/sdk/v0.53/documentation/operations/
	tb testing.TB,
	cfg simtypes.Config,
	appFactory func(logger log.Logger, db dbm.DB, traceStore io.Writer, loadLatest bool, appOpts servertypes.AppOptions, baseAppOptions ...func(*baseapp.BaseApp))
...
func NewSimulationAppInstance[T SimulationApp](/docs/sdk/v0.53/documentation/operations/
	tb testing.TB,
...
Operations on the simulation are simulated using the full [transaction cycle](/docs/sdk/v0.53/documentation/protocol-development/transactions) of a
