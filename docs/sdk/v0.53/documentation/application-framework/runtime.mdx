...
Learn more about wiring `runtime` in the [next section](/docs/sdk/v0.53/documentation/application-framework/app-go-di).
...
Runtime has built-in support for [`depinject`-enabled modules](/docs/sdk/v0.53/documentation/module-system/depinject).
