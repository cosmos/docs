...
3. Perform non-module related _stateful_ checks on the [account](/docs/sdk/v0.53/documentation/protocol-development/accounts). This step is mainly about checking
