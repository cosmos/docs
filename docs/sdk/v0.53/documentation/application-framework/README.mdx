...
* [Collections](/docs/sdk/v0.53/documentation/state-storage/collections) - State management library

## Automation

* [Depinject](/docs/sdk/v0.53/documentation/module-system/depinject) - Dependency injection framework
