...
- [BaseApp](/docs/sdk/v0.53/documentation/application-framework/baseapp)
- [ABCI](/docs/sdk/v0.53/documentation/core-concepts/abci)
...
By default, the SDK uses the [No-op Mempool](#no-op-mempool), but it can be replaced by the application developer in [`app.go`](/docs/sdk/v0.53/documentation/application-framework/app-go-di):
