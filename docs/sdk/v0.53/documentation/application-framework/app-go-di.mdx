...
Learn more about the rationale of App Wiring in [ADR-057](docs/sdk/next/documentation/legacy/adr-comprehensive).
...
- [ADR 057: App Wiring](docs/sdk/next/documentation/legacy/adr-comprehensive)
