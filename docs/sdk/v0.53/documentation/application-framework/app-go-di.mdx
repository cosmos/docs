...
The Cosmos SDK allows much easier wiring of an `app.go` thanks to [runtime](/docs/sdk/v0.53/runtime) and app wiring.
Learn more about the rationale of App Wiring in [ADR-057](/docs/sdk/v0.53/architecture/adr-057-app-wiring).
...
* [What is `runtime`?](/docs/sdk/v0.53/runtime)
* [Depinject documentation](/docs/sdk/v0.53/packages/depinject)
* [Modules depinject-ready](/docs/sdk/v0.53/building-modules/depinject)
* [ADR 057: App Wiring](/docs/sdk/v0.53/architecture/adr-057-app-wiring)
...
In short `depinject` and the [`runtime` package](/docs/sdk/v0.53/runtime) abstract the wiring of the app, and the `AppBuilder` is the place where the app is constructed. [`runtime`](/docs/sdk/v0.53/runtime) takes care of registering the codecs, KV store, subspaces and instantiating `baseapp`.
