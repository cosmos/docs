...
* [BaseApp](/docs/sdk/vnext/learn/advanced/baseapp)
* [ABCI](/docs/sdk/vnext/build/abci/introduction)
...
By default, the SDK uses the [No-op Mempool](#no-op-mempool), but it can be replaced by the application developer in [`app.go`](/docs/sdk/vnext/build/building-apps/app-go-di):
