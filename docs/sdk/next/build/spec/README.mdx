...
* [Store](/docs/sdk/vnext/build/spec/store) - The core Merkle store that holds the state.
* [Bech32](/docs/sdk/vnext/build/spec/addresses/bech32) - Address format for Cosmos SDK applications.
