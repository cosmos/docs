...
SDK outlined in [ADR 060: ABCI 1.0 (Phase I)](/docs/sdk/vnext/build/architecture/adr-060-abci-1.0).
...
```go
type ExtendVoteHandler func(sdk.Context, abci.ExtendVoteRequest)

abci.ExtendVoteResponse
type VerifyVoteExtensionHandler func(sdk.Context, abci.VerifyVoteExtensionRequest)
...
ExtendVoteHandler(ctx sdk.Context, req abci.ExtendVoteRequest)
...
VerifyVoteExtensionHandler(ctx sdk.Context, req abci.VerifyVoteExtensionRequest)
...
PreBlocker(ctx sdk.Context, req *abci.FinalizeBlockRequest)
...
FinalizeBlock(req abci.FinalizeBlockRequest) (*abci.FinalizeBlockResponse, error) {
    ctx := ...
