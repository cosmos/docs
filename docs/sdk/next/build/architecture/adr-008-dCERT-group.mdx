...
as defined in [ADR 007](./docs/sdk/next/build/architecture/adr-007-specialization-groups.mdx). This will include the
implementation of:
...
[Specialization Groups ADR](./docs/sdk/next/build/architecture/adr-007-specialization-groups.mdx)
