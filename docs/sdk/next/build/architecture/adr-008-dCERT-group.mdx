...
as defined in [ADR 007](/docs/sdk/vnext/build/architecture/adr-007-specialization-groups). This will include the
implementation of:
...
[Specialization Groups ADR](/docs/sdk/vnext/build/architecture/adr-007-specialization-groups)
