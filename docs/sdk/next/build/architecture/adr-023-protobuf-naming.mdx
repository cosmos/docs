...
In [ADR 021](./docs/sdk/next/build/architecture/adr-021-protobuf-query-encoding.mdx), gRPC was adopted for Protobuf
...
[ADR 021](./docs/sdk/next/build/architecture/adr-021-protobuf-query-encoding.mdx) specifies that modules should
