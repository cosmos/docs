...
It's meant to be used with other access control modules such as [`x/feegrant`](adr-029-fee-grant-module.mdx) ans [`x/authz`](adr-030-authz-module.mdx) to simplify key management for individuals and organizations.
