...
* [Collections](/docs/sdk/vnext/build/packages/collections) - State management library

## Automation

* [Depinject](/docs/sdk/vnext/build/packages/depinject) - Dependency injection framework
