...
[Architecture Decision Records (ADR)](/docs/sdk/vnext/build/architecture).
...
The [rfc-template.md](/docs/sdk/vnext/build/rfc/rfc-template) file includes placeholders for these
sections.

## Table of Contents

* [RFC-001: Tx Validation](/docs/sdk/vnext/build/rfc/rfc-001-tx-validation)
