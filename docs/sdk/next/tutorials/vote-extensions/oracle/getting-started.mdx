...
* Read and understood [What is an Oracle?](/docs/sdk/next/tutorials/vote-extensions/oracle/what-is-an-oracle.mdx). This provides necessary background information for understanding the Oracle module.
