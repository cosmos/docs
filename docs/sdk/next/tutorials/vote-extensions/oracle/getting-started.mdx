...
* [What is an Oracle?](/docs/sdk/next/tutorials/vote-extensions/oracle/what-is-an-oracle)
* [Implementing Vote Extensions](/docs/sdk/next/tutorials/vote-extensions/oracle/implementing-vote-extensions)
* [Testing the Oracle Module](/docs/sdk/next/tutorials/vote-extensions/oracle/testing-oracle)
...
* Read and understood [What is an Oracle?](/docs/sdk/next/tutorials/vote-extensions/oracle/what-is-an-oracle). This provides necessary background information for understanding the Oracle module.
