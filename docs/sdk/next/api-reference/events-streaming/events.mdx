...
* [`BeginBlock`](/docs/sdk/next/baseapp#beginblock)
* [`EndBlock`](/docs/sdk/next/baseapp#endblock)
* [`CheckTx`](/docs/sdk/next/baseapp#checktx)
* [`Transaction Execution`](/docs/sdk/next/baseapp#transactionexecution)
...
the [`Context`](/docs/sdk/next/context), where Event should be already registered, and emitted like this:
...
Where the `EventManager` is accessed via the [`Context`](/docs/sdk/next/context).
...
where `ownerAddress` is an address following the [`AccAddress`](/docs/sdk/next/beginner/accounts#addresses) format.
