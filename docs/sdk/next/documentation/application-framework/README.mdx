...
description: >-
  ...
  documentation on various packages that can be used when developing a Cosmos
  SDK chain. It lists all standalone Go modules that are part of the Cosmos SDK.
---
...
* [Collections](/docs/sdk/next/documentation/state-storage/collections) - State management library

## Automation

* [Depinject](/docs/sdk/next/documentation/module-system/depinject) - Dependency injection framework
