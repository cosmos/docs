...
Learn more about wiring `runtime` in the [next section](/docs/sdk/next/documentation/application-framework/app-go-di).
...
Runtime has built-in support for [`depinject`-enabled modules](/docs/sdk/next/documentation/module-system/depinject).
...
More information on building applications can be found in the [next section](/docs/sdk/next/documentation/application-framework/app-go-di).
