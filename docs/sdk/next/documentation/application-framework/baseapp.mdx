...
![Types](/docs/sdk/images/learn/advanced/baseapp_state.png)
...
![InitChain](/docs/sdk/images/learn/advanced/baseapp_state-initchain.png)
...
![CheckTx](/docs/sdk/images/learn/advanced/baseapp_state-checktx.png)
...
![ProcessProposal](/docs/sdk/images/learn/advanced/baseapp_state-prepareproposal.png)
...
![ProcessProposal](/docs/sdk/images/learn/advanced/baseapp_state-processproposal.png)
...
![Commit](/docs/sdk/images/learn/advanced/baseapp_state-commit.png)
...
* Run the application's [`preBlocker()`](/docs/sdk/next/beginner/app-anatomy#preblocker), which mainly runs the [`PreBlocker()`](/docs/sdk/next/documentation/module-system/preblock#preblock) method of each of the modules.
...
* Run the application's [`beginBlocker()`](/docs/sdk/next/beginner/app-anatomy#beginblocker-and-endblocker), which mainly runs the [`BeginBlocker()`](/docs/sdk/next/documentation/module-system/beginblock-endblock#beginblock) method of each of the modules.
