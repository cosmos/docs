...
More context can found in the corresponding [ADR-022](/docs/common/pages/adr-comprehensive#adr-022-custom-baseapp-panic-handling) and the implementation in [recovery.go](https://github.com/cosmos/cosmos-sdk/blob/v0.53.0-rc.2/baseapp/recovery.go).
