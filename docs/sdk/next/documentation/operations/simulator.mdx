...
* [Cosmos Blockchain Simulator](/docs/sdk/next/documentation/operations/simulation)
...
Operations on the simulation are simulated using the full [transaction cycle](/docs/sdk/next/documentation/protocol-development/transactions) of a
