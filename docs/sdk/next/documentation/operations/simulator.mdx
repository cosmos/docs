...
* [Cosmos Blockchain Simulator](/docs/sdk/next/learn/advanced/simulation)
...
Operations on the simulation are simulated using the full [transaction cycle](/docs/sdk/next/learn/advanced/transactions) of a
