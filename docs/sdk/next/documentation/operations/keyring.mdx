...
This document describes how to configure and use the keyring and its various backends for an [**application**](/docs/sdk/next/documentation/application-framework/app-anatomy).
