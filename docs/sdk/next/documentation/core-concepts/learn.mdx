...
* [Introduction](/docs/sdk/next/intro/overview) - Dive into the fundamentals of Cosmos SDK with an insightful introduction,
...
* [Beginner](/docs/sdk/next/documentation/application-framework/app-anatomy) - Start your journey with beginner-friendly resources in the Cosmos SDK's "Learn"
...
* [Advanced](/docs/sdk/next/documentation/application-framework/baseapp) - Level up your Cosmos SDK expertise with advanced topics, tailored for experienced
