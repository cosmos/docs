...
What's more, the Cosmos SDK is a capabilities-based system that allows developers to better reason about the security of interactions between modules. For a deeper look at capabilities, jump to [Object-Capability Model](/docs/sdk/next/advanced/ocap).
...
Learn more about [application-specific blockchains](/docs/sdk/next/why-app-specific).
...
* Learn more about the [architecture of a Cosmos SDK application](/docs/sdk/next/sdk-app-architecture)
