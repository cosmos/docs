...
The gas meter is generally held in [`ctx`](/docs/sdk/next/documentation/application-framework/context), and consuming gas is done with the following pattern:
