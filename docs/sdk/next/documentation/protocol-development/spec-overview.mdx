...
- [Store](/docs/sdk/next/documentation/state-storage/store) - The core Merkle store that holds the state.
- [Bech32](/docs/sdk/next/documentation/protocol-development/bech32) - Address format for Cosmos SDK applications.
