...
The actual implementation of `BeginBlocker` and `EndBlocker` in `abci.go` is very similar to that of a [`Msg` service](/docs/sdk/next/documentation/module-system/msg-services):

- They generally use the [`keeper`](/docs/sdk/next/documentation/module-system/keeper) and [`ctx`](/docs/sdk/next/documentation/application-framework/context) to retrieve information about the latest state.
