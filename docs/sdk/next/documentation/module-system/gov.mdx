...
results[v1.OptionNoWithVeto] = math.LegacyZeroDec()
    rng := collections.NewPrefixedPairRange[uint64, sdk.AccAddress](/docs/sdk/next/documentation/module-system/proposal.Id)
...
Location: off-chain as json object stored on IPFS (mirrors [group proposal](/docs/sdk/next/documentation/module-system/group#metadata))
...
Location: on-chain as json within 255 character limit (mirrors [group vote](/docs/sdk/next/documentation/module-system/group#metadata))
