...
<Note>
**Synopsis**
`PreBlocker` is an optional method module developers can implement in their module. They will be triggered before [`BeginBlock`](/docs/sdk/next//learn/advanced/baseapp#beginblock).
</Note>
