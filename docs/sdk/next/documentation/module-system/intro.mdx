...
* [Anatomy of a Cosmos SDK application](/docs/sdk/next//learn/beginner/app-anatomy)
* [Lifecycle of a Cosmos SDK transaction](/docs/sdk/next//learn/beginner/tx-lifecycle)

</Note>

## Role of Modules in a Cosmos SDK Application

The Cosmos SDK can be thought of as the Ruby-on-Rails of blockchain development. It comes with a core that provides the basic functionalities every blockchain application needs, like a [boilerplate implementation of the ABCI](/docs/sdk/next//learn/advanced/baseapp) to communicate with the underlying consensus engine, a [`multistore`](/docs/sdk/next//learn/advanced/store#multistore) to persist state, a [server](/docs/sdk/next//learn/advanced/node) to form a full-node and [interfaces](/docs/sdk/next/module-interfaces) to handle queries.
...
* A [`Msg` service](/docs/sdk/next/messages-and-queries#messages), used to process messages when they are routed to the module by [`BaseApp`](/docs/sdk/next//learn/advanced/baseapp#message-routing) and trigger state-transitions.
* A [query service](/docs/sdk/next/query-services), used to process user queries when they are routed to the module by [`BaseApp`](/docs/sdk/next//learn/advanced/baseapp#query-routing).
