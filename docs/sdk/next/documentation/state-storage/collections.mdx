...
Under the hood the `collections.Map` will convert the key and value to bytes using the [key and value codec](/docs/sdk/next/documentation/state-storage/README.mdx#key-and-value-codecs).
It will prepend to our bytes key the [prefix](/docs/sdk/next/documentation/state-storage/README.mdx#prefix) and store it in the KVStore of the module.
