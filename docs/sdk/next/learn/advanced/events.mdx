...
*Typed Events* are Protobuf-defined [messages](/docs/sdk/vnext/../architecture/adr-032-typed-events) used by the Cosmos SDK
...
They are triggered from the module's Protobuf [`Msg` service](/docs/sdk/vnext/build/building-modules/msg-services)
...
* [`BeginBlock`](/docs/sdk/vnext/learn/advanced/baseapp#beginblock)
* [`EndBlock`](/docs/sdk/vnext/learn/advanced/baseapp#endblock)
* [`CheckTx`](/docs/sdk/vnext/learn/advanced/baseapp#checktx)
* [`Transaction Execution`](/docs/sdk/vnext/learn/advanced/baseapp#transactionexecution)
...
| `message.action='/cosmos.bank.v1beta1.Msg/Send'` | Query all transactions containing a x/bank `Send` [Service `Msg`](/docs/sdk/vnext/build/building-modules/msg-services). Note the `'`s around the value. |
| `message.module='bank'`                          | Query all transactions containing messages from the x/bank module. Note the `'`s around the value.                                                      |
| `create_validator.validator='cosmosval1...'`     | x/staking-specific Event, see [x/staking SPEC](/docs/sdk/vnext/../../x/staking/README).                                                                 |
...
the [`Context`](/docs/sdk/vnext/learn/advanced/context), where Event should be already registered, and emitted like this:
...
Where the `EventManager` is accessed via the [`Context`](/docs/sdk/vnext/learn/advanced/context).

See the [`Msg` services](/docs/sdk/vnext/build/building-modules/msg-services) concept doc for a more detailed
...
where `ownerAddress` is an address following the [`AccAddress`](/docs/sdk/vnext/learn/beginner/accounts#addresses) format.
