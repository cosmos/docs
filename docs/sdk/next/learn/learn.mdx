...
title: Learn
---
* [Introduction](/docs/sdk/next/intro/00-overview) - Dive into the fundamentals of Cosmos SDK with an insightful introduction,
...
* [Beginner](/docs/sdk/next/beginner/00-app-anatomy) - Start your journey with beginner-friendly resources in the Cosmos SDK's "Learn"
...
* [Advanced](/docs/sdk/next/advanced/00-baseapp) - Level up your Cosmos SDK expertise with advanced topics, tailored for experienced
