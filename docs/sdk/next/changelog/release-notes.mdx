...
<Update label="2024-06-04" description="v0.50.7" tags={["SDK", "Release"]}>
  ...
  context when available in `SetCmdClientContext`. ### Bug Fixes * (simulation)
  ...
  test. * (baseapp) [#20346](https://github.com/cosmos/cosmos-sdk/pull/20346)
  Correctly assign `execModeSimulate` to context for `simulateTx`. * (baseapp)
