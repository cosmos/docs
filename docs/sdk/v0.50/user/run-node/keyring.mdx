...
<Note>
**Synopsis**
This document describes how to configure and use the keyring and its various backends for an [**application**](/docs/sdk/v0.50/documentation/application-framework/app-anatomy).
</Note>
