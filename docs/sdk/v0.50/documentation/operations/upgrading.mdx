...
Read more about other use cases [here](/docs/sdk/v0.50/build/architecture/adr-068-preblock).
...
[ADR-38](/docs/sdk/v0.50/build/architecture/adr-038-state-listening) has been implemented in the SDK.
...
To learn more see the [docs](/docs/sdk/v0.50/learn/advanced/transactions#sign_mode_textual) and the [ADR-050](/docs/sdk/v0.50/build/architecture/adr-050-sign-mode-textual).

### Modules

#### `**all**`

* [RFC 001](/docs/sdk/v0.50/build/rfc/rfc-001-tx-validation) has defined a simplification of the message validation process for modules.
