...
When migrating from a previous version, refer to the [`UPGRADING.md`](/docs/sdk/v0.50/documentation/operations/upgrading) and the `CHANGELOG.md` of the version you are migrating to.
