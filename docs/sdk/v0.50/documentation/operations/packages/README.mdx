...
* [Core](https://pkg.go.dev/cosmossdk.io/core) - Core library defining SDK interfaces ([ADR-063](/docs/common/pages/adr-comprehensive#adr-063-core-module-api))
...
* [Collections](/docs/sdk/v0.50/documentation/operations/packages/collections) - State management library
* [ORM](/docs/sdk/v0.47/build/packages/orm) - State management library

## Automation

* [Depinject](/docs/sdk/v0.50/documentation/module-system/depinject) - Dependency injection framework
