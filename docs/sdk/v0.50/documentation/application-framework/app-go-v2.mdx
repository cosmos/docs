...
The Cosmos SDK allows much easier wiring of an `app.go` thanks to App Wiring and [`depinject`](/docs/sdk/v0.50/documentation/module-system/depinject).
...
* [Depinject Documentation](/docs/sdk/v0.50/documentation/module-system/depinject)
* [Modules depinject-ready](/docs/sdk/v0.50/documentation/module-system/depinject)
