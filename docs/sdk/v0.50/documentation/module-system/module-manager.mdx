...
It is recommended to implement interfaces from the [Core API](docs/sdk/next/documentation/legacy/adr-comprehensive) `appmodule` package. This makes modules less dependent on the SDK.
