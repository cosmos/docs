...
It is recommended to implement interfaces from the [Core API](/docs/sdk/v0.50/build/architecture/adr-063-core-module-api) `appmodule` package. This makes modules less dependent on the SDK.
