...
For more, see an example of `keeper`'s [methods implementation from the `staking` module](/docs/sdk/v0.50/documentation/module-system/https://github.com/cosmos/cosmos-sdk/blob/v0.50.0-alpha.0/x/staking/keeper/keeper.go).
