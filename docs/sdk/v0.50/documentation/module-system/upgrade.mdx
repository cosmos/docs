...
<Note>
**Synopsis**
[In-Place Store Migrations](/docs/sdk/next/documentation/operations/upgrade-advanced) allow your modules to upgrade to new versions that include breaking changes. This document outlines how to build modules to take advantage of this functionality.
</Note>

<Note>
**Pre-requisite Readings**

* [In-Place Store Migration](/docs/sdk/next/documentation/operations/upgrade-advanced)
...
To see example code of changes that were implemented in a migration of balance keys, check out [migrateBalanceKeys](/docs/sdk/v0.50/documentation/module-systemhttps://github.com/cosmos/cosmos-sdk/blob/v0.50.0-alpha.0/x/bank/migrations/v2/store.go#L55-L76). For context, this code introduced migrations of the bank store that updated addresses to be prefixed by their length in bytes as outlined in [ADR-028](docs/sdk/next/documentation/legacy/adr-comprehensive).
