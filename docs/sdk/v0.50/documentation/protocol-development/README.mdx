...
* [Store](/docs/sdk/v0.50/learn/advanced/store) - The core Merkle store that holds the state.
* [Bech32](/docs/sdk/v0.50/documentation/protocol-development/addresses/bech32) - Address format for Cosmos SDK applications.
