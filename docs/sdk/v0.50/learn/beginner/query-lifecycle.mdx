...
This query command was defined by the [`staking`](docs/sdk/v0.50/documentation/module-system/modules/staking/README) module developer and added to the list of subcommands by the application developer when creating the CLI.
...
- **Account Decoder**: The account decoder from the [`auth`](/docs/sdk/v0.50/documentation/module-system/modules/auth) module, which translates `[]byte`s into accounts.
