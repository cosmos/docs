...
- Perform upgrades in place, which significantly decrease the upgrade time for chains with a larger state. Use the [Module Upgrade Guide](/docs/sdk/v0.50/documentation/application-framework/app-upgrade) to set up your application modules to take advantage of in-place upgrades.
...
To learn more about configuring migration scripts for your modules, see the [Module Upgrade Guide](/docs/sdk/v0.50/documentation/application-framework/app-upgrade).
...
To learn more about Cosmovisor, see the [Cosmovisor Quick Start](/docs/sdk/v0.50/documentation/operations/tooling/cosmovisor).
