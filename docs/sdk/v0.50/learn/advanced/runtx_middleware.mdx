...
More context can found in the corresponding [ADR-022](/docs/common/pages/adr-comprehensive#adr-022-custom-baseapp-panic-handling) and the implementation in [recovery.go](https://github.com/cosmos/cosmos-sdk/blob/v0.50.0-alpha.0/baseapp/recovery.go).
