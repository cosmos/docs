...
<Note>
This function is different from the deprecated `sdk.Msg` [`ValidateBasic`](/docs/sdk/v0.50/learn/beginner/tx-lifecycle#ValidateBasic) methods, which was performing basic validity checks on messages only.
</Note>
