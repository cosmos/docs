...
Transactions are comprised of metadata held in [contexts](/docs/sdk/v0.50/context) and [`sdk.Msg`s](/docs/sdk/v0.50/documentation/module-system/messages-and-queries) that trigger state changes within a module through the module's Protobuf [`Msg` service](/docs/sdk/v0.50/documentation/module-system/msg-services).
...
Examples of broadcasting and simulating a transaction are shown [here](/docs/sdk/v0.50/documentation/operations/txs#programmatically-with-go).
...
An example can be seen [here](/docs/sdk/v0.50/documentation/operations/txs#using-rest)
