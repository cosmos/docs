...
* [`BeginBlock`](/docs/sdk/v0.50/baseapp#beginblock)
* [`EndBlock`](/docs/sdk/v0.50/baseapp#endblock)
* [`CheckTx`](/docs/sdk/v0.50/baseapp#checktx)
* [`Transaction Execution`](/docs/sdk/v0.50/baseapp#transactionexecution)
...
the [`Context`](/docs/sdk/v0.50/context), where Event should be already registered, and emitted like this:
...
Where the `EventManager` is accessed via the [`Context`](/docs/sdk/v0.50/context).
...
where `ownerAddress` is an address following the [`AccAddress`](/docs/sdk/v0.50/beginner/accounts#addresses) format.
