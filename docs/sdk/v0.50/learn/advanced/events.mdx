...
They are triggered from the module's Protobuf [`Msg` service](/docs/sdk/v0.50/build/building-modules/msg-services)
...
| `message.action='/cosmos.bank.v1beta1.Msg/Send'` | Query all transactions containing a x/bank `Send` [Service `Msg`](/docs/sdk/v0.50/build/building-modules/msg-services). Note the `'`s around the value. |
| `message.module='bank'`                          | Query all transactions containing messages from the x/bank module. Note the `'`s around the value.                                                      |
| `create_validator.validator='cosmosval1...'`     | x/staking-specific Event, see [x/staking SPEC](/docs/sdk/v0.50/build/building-modules/staking).                                                         |
...
See the [`Msg` services](/docs/sdk/v0.50/build/building-modules/msg-services) concept doc for a more detailed
