...
**Note:** The authz module is different from the [auth (authentication)](/docs/sdk/v0.50/build/modules/auth/authre/) module that is responsible for specifying the base transaction and account types.
