...
favor of a custom implementation in [`app.go`](/docs/sdk/v0.50/build/building-apps/app-go-v2):
...
the application developer in [`app.go`](/docs/sdk/v0.50/build/building-apps/app-go-v2). If you decide to implement
...
The default SDK is a [No-op Mempool](#no-op-mempool), but it can be replaced by the application developer in [`app.go`](/docs/sdk/v0.50/build/building-apps/app-go-v2):
