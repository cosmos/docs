...
[Architecture Decision Records (ADR)](/docs/sdk/v0.50/build/architecture/README).
...
The [rfc-template.md](/docs/sdk/v0.50/build/rfc/rfc-template) file includes placeholders for these
sections.

## Table of Contents

* [RFC-001: Tx Validation](/docs/sdk/v0.50/build/rfc/rfc-001-tx-validation)
