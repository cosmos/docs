...
<Check>
  For more information on SDK modules, see the [SDK Modules](/docs/sdk/v0.50/build/modules/module) section. For more information on SDK tooling, see the [Tooling](/docs/sdk/v0.50/build/tooling) section.
</Check>

## Core[​](#core "Direct link to Core")

* [Core](https://pkg.go.dev/cosmossdk.io/core) - Core library defining SDK interfaces ([ADR-063](/docs/sdk/v0.50/build/architecture/adr-063-core-module-api))
...
* [ORM](docs/sdk/v0.50/build/packages/README#orm) - State management library
