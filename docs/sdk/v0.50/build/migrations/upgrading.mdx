...
and `VerifyVoteExtensionHandler` respectively. Please see [here](/docs/sdk/v0.50/build/building-apps/vote-extensions)
for more info.
...
Read more on those interfaces [here](/docs/sdk/v0.50/build/building-modules/module-manager#application-module-interfaces).
...
To find out more please read the [signer field](/docs/sdk/v0.50/build/building-modules/protobuf-annotations#signer) & [here](https://github.com/cosmos/cosmos-sdk/blob/7352d0bce8e72121e824297df453eb1059c28da8/docs/docs/build/building-modules/02-messages-and-queries.md#L40) documentation.
