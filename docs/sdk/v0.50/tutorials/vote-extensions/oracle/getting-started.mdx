...
* [What is an Oracle?](/docs/sdk/v0.50/01-what-is-an-oracle)
* [Implementing Vote Extensions](/docs/sdk/v0.50/02-implementing-vote-extensions)
* [Testing the Oracle Module](/docs/sdk/v0.50/03-testing-oracle)
...
* Read and understood [What is an Oracle?](01-what-is-an-oracle). This provides necessary background information for understanding the Oracle module.
