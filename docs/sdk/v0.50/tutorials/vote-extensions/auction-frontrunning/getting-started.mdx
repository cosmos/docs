...
* [Mitigating Front-running with Vote Extensions](/docs/sdk/v0.50/tutorials/vote-extensions/auction-frontrunning/mitigating-front-running-with-vote-extesions)
