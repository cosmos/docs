...
* [Understanding Front-Running](/docs/sdk/v0.50/01-understanding-frontrunning)
* [Mitigating Front-running with Vote Extensions](/docs/sdk/v0.50/02-mitigating-front-running-with-vote-extesions)
* [Demo of Mitigating Front-Running](/docs/sdk/v0.50/03-demo-of-mitigating-front-running)
...
* Familiarity with the concepts of front-running and MEV, as detailed in [Understanding Front-Running](/docs/sdk/v0.50/01-understanding-frontrunning)
