...
[Architecture Decision Records (ADR)](/docs/sdk/v0.47/build/architecture/README).
...
The [rfc-template.md](/docs/sdk/v0.47/build/rfc/rfc-template) file includes placeholders for these
sections.
