...
[Architecture Decision Records (ADR)](/docs/sdk/v0.47/architecture/README).
...
The [rfc-template.md](./docs/sdk/v0.47/build/rfc/rfc-template.mdx) file includes placeholders for these
sections.
