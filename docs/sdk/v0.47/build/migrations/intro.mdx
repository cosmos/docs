...
When migrating from a previous version, refer to the [`UPGRADING.md`](./docs/sdk/v0.47/build/migrations/upgrading.mdx) and the `CHANGELOG.md` of the version you are migrating to.
