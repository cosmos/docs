...
3. pernicious minor version incompatibilities introduced through correctly
   ...
   without correct [unknown field filtering](./adr-020-protobuf-transaction-encoding.mdx#unknown-field-filtering)
...
on [ADR 020 unknown field filtering](./adr-020-protobuf-transaction-encoding.mdx#unknown-field-filtering).
...
some sort of
framework-level [unknown field filtering](./adr-020-protobuf-transaction-encoding.mdx#unknown-field-filtering),
it is hard to know whether these pernicious hard to detect bugs are getting into
our app and a client-server layer such as [ADR 033: Inter-Module Communication](./adr-033-protobuf-inter-module-comm.mdx)
...
requisite [unknown field filtering](./adr-020-protobuf-transaction-encoding.mdx#unknown-field-filtering).
Likely some sort of client-server routing layer which does this check such as
[ADR 033: Inter-Module communication](./adr-033-protobuf-inter-module-comm.mdx)
...
in [ADR 033](./adr-033-protobuf-inter-module-comm.mdx).
...
for [unknown field filtering](./adr-020-protobuf-transaction-encoding.mdx#unknown-field-filtering),
...
described above unless [unknown field filtering](./adr-020-protobuf-transaction-encoding.mdx#unknown-field-filtering)
...
1. we are alignment on adopting [ADR 033](./adr-033-protobuf-inter-module-comm.mdx) not just as an addition to the
...
To correctly perform [unknown field filtering](./adr-020-protobuf-transaction-encoding.mdx#unknown-field-filtering),
...
other languages such as plugins described briefly in [ADR 033](./adr-033-protobuf-inter-module-comm.mdx#internal-methods).
...
* [ADR 020](./adr-020-protobuf-transaction-encoding.mdx)
* [ADR 033](./adr-033-protobuf-inter-module-comm.mdx)
