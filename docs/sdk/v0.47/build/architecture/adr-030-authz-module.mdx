...
* "sub-keys" functionality, as originally proposed in [#4480](https://github.com/cosmos/cosmos-sdk/issues/4480) which
  ...
  the `fee_grant` module from [ADR 029](./docs/sdk/v0.47/build/architecture/adr-029-fee-grant-module.mdx) and the [group module](https://github.com/cosmos/cosmos-sdk/tree/main/x/group).
