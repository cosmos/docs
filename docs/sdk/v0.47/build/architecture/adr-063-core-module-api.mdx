...
* [ADR 033: Protobuf-based Inter-Module Communication](./docs/sdk/v0.47/build/architecture/adr-033-protobuf-inter-module-comm.mdx) clients.
...
implementations of these services to modules via both [dependency injection](./docs/sdk/v0.47/build/architecture/adr-057-app-wiring.mdx) and
...
The [ORM](./docs/sdk/v0.47/build/architecture/adr-055-orm.mdx) and [collections](./docs/sdk/v0.47/build/architecture/adr-062-collections-state-layer.mdx) both support
...
as possible during initialization and in [ADR 057: App Wiring](/docs/sdk/v0.47/adr-057-app-wiring), protobuf type registration\
...
[autocli](./docs/sdk/v0.47/build/architecture/adr-058-auto-generated-cli.mdx) framework.

#### Example Usage

Here is an example of setting up a hypothetical `foo` v2 module which uses the [ORM](./docs/sdk/v0.47/build/architecture/adr-055-orm.mdx) for its state
...
* [ADR 033: Protobuf-based Inter-Module Communication](./docs/sdk/v0.47/build/architecture/adr-033-protobuf-inter-module-comm.mdx)
* [ADR 057: App Wiring](/docs/sdk/v0.47/adr-057-app-wiring)
