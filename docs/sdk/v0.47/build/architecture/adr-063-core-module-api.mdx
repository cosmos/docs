...
* [ADR 033: Protobuf-based Inter-Module Communication](./adr-033-protobuf-inter-module-comm.mdx) clients.
...
implementations of these services to modules via both [dependency injection](./adr-057-app-wiring.mdx) and
...
The [ORM](./adr-055-orm.mdx) and [collections](./adr-062-collections-state-layer.mdx) both support
...
[autocli](./adr-058-auto-generated-cli.mdx) framework.

#### Example Usage

Here is an example of setting up a hypothetical `foo` v2 module which uses the [ORM](./adr-055-orm.mdx) for its state
...
* [ADR 033: Protobuf-based Inter-Module Communication](./adr-033-protobuf-inter-module-comm.mdx)
