...
modules for Cosmos SDK modules as described in [ADR 053: Go Module Refactoring](/docs/sdk/v0.47/build/architecture/adr-053-go-module-refactoring).
...
Several attempts were made to improve the current situation including [ADR 033: Internal-Module Communication](/docs/sdk/v0.47/build/architecture/adr-033-protobuf-inter-module-comm)
...
described in [ADR 063: Core Module API](/docs/sdk/v0.47/build/architecture/adr-063-core-module-api).
...
defined here are described in [ADR 061: Core Module API](/docs/sdk/v0.47/build/architecture/adr-063-core-module-api).
...
* [ADR 063](/docs/sdk/v0.47/build/architecture/adr-063-core-module-api)
