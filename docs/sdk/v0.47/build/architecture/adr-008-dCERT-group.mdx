...
as defined in [ADR 007](./docs/sdk/v0.47/build/architecture/adr-007-specialization-groups.mdx). This will include the
implementation of:
...
[Specialization Groups ADR](./docs/sdk/v0.47/build/architecture/adr-007-specialization-groups.mdx)
