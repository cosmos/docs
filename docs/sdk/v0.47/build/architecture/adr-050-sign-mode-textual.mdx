...
See [annex 2](/docs/sdk/v0.47/build/architecture/adr-050-sign-mode-textual-annex2) for guidance.
...
By including this hash in the SIGN\_MODE\_TEXTUAL signing payload, we keep the same level of guarantees as [SIGN\_MODE\_DIRECT](/docs/sdk/v0.47/build/architecture/adr-020-protobuf-transaction-encoding).
...
See [annex 2](/docs/sdk/v0.47/build/architecture/adr-050-sign-mode-textual-annex2).
...
* Some details on value renderers need to be polished, see [Annex 1](/docs/sdk/v0.47/build/architecture/adr-050-sign-mode-textual-annex1).
...
* [Annex 1](/docs/sdk/v0.47/build/architecture/adr-050-sign-mode-textual-annex1)
