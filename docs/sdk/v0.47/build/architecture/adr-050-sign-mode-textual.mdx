...
See [annex 2](./adr-050-sign-mode-textual-annex2.mdx) for guidance.
...
By including this hash in the SIGN\_MODE\_TEXTUAL signing payload, we keep the same level of guarantees as [SIGN\_MODE\_DIRECT](./adr-020-protobuf-transaction-encoding.mdx).
...
See [annex 2](./adr-050-sign-mode-textual-annex2.mdx).
...
* Some details on value renderers need to be polished, see [Annex 1](./adr-050-sign-mode-textual-annex1.mdx).
...
* [Annex 1](./adr-050-sign-mode-textual-annex1.mdx)
