...
service definitions defined in [ADR 021](./adr-021-protobuf-query-encoding.mdx) and
[ADR 031](./adr-031-msg-service.mdx) which provides:
...
Based on [ADR-021](./adr-021-protobuf-query-encoding.mdx) and [ADR-031](./adr-031-msg-service.mdx), we introduce the
...
In [ADR 021](./adr-021-protobuf-query-encoding.mdx), a mechanism for using protobuf service definitions to define queriers
was introduced and in [ADR 31](./adr-031-msg-service.mdx), a mechanism for using protobuf service to define `Msg`s was added.
...
[ADR 021](./adr-021-protobuf-query-encoding.mdx) and [ADR 31](./adr-031-msg-service.mdx) specifies how modules can implement the generated `QueryServer`
...
corresponding "public key". From the [ADR 028](./adr-028-public-key-addresses.mdx), modules can have both a root module account and any number of sub-accounts
...
In [ADR 031](./adr-031-msg-service.mdx), the `AppModule.RegisterService(Configurator)` method was introduced. To support
...
* [ADR 021](./adr-021-protobuf-query-encoding.mdx)
* [ADR 031](./adr-031-msg-service.mdx)
* [ADR 028](./adr-028-public-key-addresses.mdx)
