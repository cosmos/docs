...
service definitions defined in [ADR 021](/docs/sdk/v0.47/build/architecture/adr-021-protobuf-query-encoding) and
[ADR 031](/docs/sdk/v0.47/build/architecture/adr-031-msg-service) which provides:
...
Based on [ADR-021](/docs/sdk/v0.47/build/architecture/adr-021-protobuf-query-encoding) and [ADR-031](/docs/sdk/v0.47/build/architecture/adr-031-msg-service), we introduce the
...
In [ADR 021](/docs/sdk/v0.47/build/architecture/adr-021-protobuf-query-encoding), a mechanism for using protobuf service definitions to define queriers
was introduced and in [ADR 31](/docs/sdk/v0.47/build/architecture/adr-031-msg-service), a mechanism for using protobuf service to define `Msg`s was added.
...
[ADR 021](/docs/sdk/v0.47/build/architecture/adr-021-protobuf-query-encoding) and [ADR 31](/docs/sdk/v0.47/build/architecture/adr-031-msg-service) specifies how modules can implement the generated `QueryServer`
...
corresponding "public key". From the [ADR 028](/docs/sdk/v0.47/build/architecture/adr-028-public-key-addresses), modules can have both a root module account and any number of sub-accounts
...
In [ADR 031](/docs/sdk/v0.47/build/architecture/adr-031-msg-service), the `AppModule.RegisterService(Configurator)` method was introduced. To support
...
* [ADR 021](/docs/sdk/v0.47/build/architecture/adr-021-protobuf-query-encoding)
* [ADR 031](/docs/sdk/v0.47/build/architecture/adr-031-msg-service)
* [ADR 028](/docs/sdk/v0.47/build/architecture/adr-028-public-key-addresses)
