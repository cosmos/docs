...
* [Store](/docs/sdk/v0.50/build/store) - The core Merkle store that holds the state.
* [Bech32](/docs/sdk/v0.50/build/addresses/bech32) - Address format for Cosmos SDK applications.
