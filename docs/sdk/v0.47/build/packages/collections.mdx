...
Under the hood the `collections.Map` will convert the key and value to bytes using the [key and value codec](./docs/sdk/v0.47/build/architecture/README.mdx#key-and-value-codecs).
It will prepend to our bytes key the [prefix](./docs/sdk/v0.47/build/architecture/README.mdx#prefix) and store it in the KVStore of the module.
