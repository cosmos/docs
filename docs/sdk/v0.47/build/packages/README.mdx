...
* [Collections](./docs/sdk/v0.47/build/packages/collections.mdx) - State management library
* [ORM](./docs/sdk/v0.47/build/packages/orm.mdx) - State management library

## Automation

* [Depinject](./docs/sdk/v0.47/build/building-modules/depinject.mdx) - Dependency injection framework
