...
favor of a custom implementation in [`app.go`](/docs/sdk/v0.47/build/building-apps/app-go-v2):
...
Like `PrepareProposal` this implementation is the default and can be modified by the application developer in [`app.go`](/docs/sdk/v0.47/build/building-apps/app-go-v2):
...
The default SDK is a [No-op Mempool](#no-op-mempool), but it can be replaced by the application developer in [`app.go`](/docs/sdk/v0.47/build/building-apps/app-go-v2):
