...
Nodes should not have all ports open to the public, this is a simple way to get DDOS'd. Secondly it is recommended by [CometBFT](/docs/sdk/v0.47/user/run-node/github.com/cometbft/cometbft.mdx) to never expose ports that are not required to operate a node.
