...
<Note>
**Synopsis**
This document describes how to configure and use the keyring and its various backends for an [**application**](/docs/sdk/v0.47//learn/beginner/00-overview-app).
</Note>
