...
See which buf commit for `cosmos/cosmos-sdk` to pin in your `buf.yaml` file [here](docs/sdk/v0.47/documentation/operations/tooling/README).
...
The `params` module will be removed in `v0.48`, as mentioned [in v0.46 release](https://github.com/cosmos/cosmos-sdk/blob/v0.46.1/UPGRADING#xparams). It is strongly encouraged to migrate away from `x/params` before `v0.48`.
...
For the exhaustive list of API renaming, please refer to the [CHANGELOG](https://github.com/cosmos/cosmos-sdk/blob/main/CHANGELOG).
