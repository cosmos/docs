...
description: >-
  This guide provides instructions for upgrading to specific versions of Cosmos
  SDK. Note, always read the SimApp section for more information on application
  wiring updates.
---
...
More information about [confix](/docs/sdk/v0.47/documentation/operations/tooling/confix).
...
The `gogoproto.goproto_stringer = false` annotation has been removed from most proto files. This means that the `String()` method is being generated for types that previously had this annotation. The generated `String()` method uses `proto.CompactTextString` for *stringifying* structs.
[Verify](/docs/sdk/v0.47/documentation/operations/https://github.com/cosmos/cosmos-sdk/pull/13850#issuecomment-1328889651) the usage of the modified `String()` methods and double-check that they are not used in state-machine code.
...
[RFC 001](/https://github.com/cosmos/cosmos-sdk/blob/main/docs/rfc/rfc-001-tx-validation.md) has defined a simplification of the message validation process for modules.
...
Capability was moved to [IBC-GO](/docs/sdk/v0.47/documentation/operations/https://github.com/cosmos/ibc-go). IBC V8 will contain the necessary changes to incorporate the new module location
...
## [v0.47.x](/docs/sdk/v0.47/documentation/operations/https://github.com/cosmos/cosmos-sdk/releases/tag/v0.47.0)
...
The `simapp` package **should not be imported in your own app**. Instead, you should import the `runtime.AppI` interface, that defines an `App`, and use the [`simtestutil` package](/docs/sdk/v0.47/documentation/operations/https://pkg.go.dev/github.com/cosmos/cosmos-sdk/testutil/sims) for application testing.

#### App Wiring

SimApp's `app_v2.go` is using [App Wiring](/docs/sdk/v0.47/documentation/application-framework/app-go-v2), the dependency injection framework of the Cosmos SDK.
This means that modules are injected directly into SimApp thanks to a [configuration file](/docs/sdk/v0.47/documentation/operations/https://github.com/cosmos/cosmos-sdk/blob/v0.47.0-rc1/simapp/app_config.go).
The previous behavior, without the dependency injection framework, is still present in [`app.go`](/docs/sdk/v0.47/documentation/operations/https://github.com/cosmos/cosmos-sdk/blob/v0.47.0-rc1/simapp/app.go) and is not going anywhere.
...
* [issue #14949 on cosmos-sdk](/docs/sdk/v0.47/documentation/operations/https://github.com/cosmos/cosmos-sdk/issues/14949)
* [issue #25413 on go-ethereum](/docs/sdk/v0.47/documentation/operations/https://github.com/ethereum/go-ethereum/pull/25413)

### Protobuf

The SDK has migrated from `gogo/protobuf` (which is currently unmaintained), to our own maintained fork, [`cosmos/gogoproto`](/docs/sdk/v0.47/documentation/operations/https://github.com/cosmos/gogoproto).
...
See which buf commit for `cosmos/cosmos-sdk` to pin in your `buf.yaml` file [here](/docs/sdk/v0.47/tooling).

#### Gogoproto Import Paths

The SDK made a [patch fix](/docs/sdk/v0.47/documentation/operations/https://github.com/cosmos/gogoproto/pull/32) on its gogoproto repository to require that each proto file's package name matches its OS import path (relatively to a protobuf root import path, usually the root `proto/` folder, set by the `protoc -I` flag).
...
This is to allow the proto FileDescriptSets to be correctly registered, and this standardized OS import paths allows [Hubl](/docs/sdk/v0.47/documentation/operations/tooling/hubl) to reflectively talk to any chain.
...
For more information, see the [encoding guide](/docs/sdk/v0.47/learn/advanced/encoding).
...
The `params` module will be removed in `v0.48`, as mentioned [in v0.46 release](/docs/sdk/v0.47/documentation/operations/https://github.com/cosmos/cosmos-sdk/blob/v0.46.1/UPGRADING#xparams). It is strongly encouraged to migrate away from `x/params` before `v0.48`.
...
## [v0.46.x](/docs/sdk/v0.47/documentation/operations/https://github.com/cosmos/cosmos-sdk/releases/tag/v0.46.0)
...
For instance, the REST API, deprecated in v0.45, is now removed. If you have not migrated yet, please follow the [instructions](/docs/sdk/v0.47/documentation/operations/https://docs.cosmos.network/v0.45/migrations/rest.html).
...
For the exhaustive list of API renaming, please refer to the [CHANGELOG](/docs/sdk/v0.47/documentation/operations/https://github.com/cosmos/cosmos-sdk/blob/main/CHANGELOG).
...
More information can be found in the gov module [client documentation](/docs/sdk/v0.47/documentation/operations/https://docs.cosmos.network/v0.46/modules/gov/07_client.html).
...
The `third_party/proto` folder that existed in [previous version](/docs/sdk/v0.47/documentation/operations/https://github.com/cosmos/cosmos-sdk/tree/v0.45.3/third_party/proto) now does not contains directly the [proto files](/docs/sdk/v0.47/documentation/operations/https://github.com/cosmos/cosmos-sdk/tree/release/v0.46.x/third_party/proto).

Instead, the SDK uses [`buf`](/docs/sdk/v0.47/documentation/operations/https://buf.build). Clients should have their own [`buf.yaml`](/docs/sdk/v0.47/documentation/operations/https://docs.buf.build/configuration/v1/buf-yaml) with `buf.build/cosmos/cosmos-sdk` as dependency, in order to avoid having to copy paste these files.
...
When clients interract with a node they are required to set a codec in in the grpc.Dial. More information can be found in this [doc](/docs/sdk/v0.47/documentation/operations/https://docs.cosmos.network/v0.46/run-node/interact-node.html#programmatically-via-go).
