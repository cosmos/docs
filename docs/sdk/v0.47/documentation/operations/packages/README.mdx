...
* [Collections](/docs/sdk/v0.47/documentation/operations/packages/collections) - State management library
* [ORM](/docs/sdk/v0.47/documentation/operations/packages/orm) - State management library

## Automation

* [Depinject](/docs/sdk/v0.47/documentation/module-system/depinject) - Dependency injection framework
