...
`x/evidence` is an implementation of a Cosmos SDK module, per [ADR 009](docs/sdk/next/documentation/legacy/adr-comprehensive),
...
on slashing and jailing in [State Transitions](docs/sdk/v0.47/documentation/module-system/modules/staking/README#state-transitions).
