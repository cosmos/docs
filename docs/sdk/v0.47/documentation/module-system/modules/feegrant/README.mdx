...
This document specifies the fee grant module. For the full ADR, please see [Fee Grant ADR-029](docs/sdk/next/documentation/legacy/adr-comprehensive).
...
Fees are deducted from grants in the `x/auth` ante handler. To learn more about how ante handlers work, read the [Auth Module AnteHandlers Guide](docs/sdk/v0.47/documentation/module-system/modules/auth/README#antehandlers).
