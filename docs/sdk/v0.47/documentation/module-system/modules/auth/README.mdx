...
**Note:** The auth module is different from the [authz module](docs/sdk/v0.47/documentation/module-system/modules/authz/README).
...
The `AnteHandler` can be seen as a set of decorators that check transactions within the current context, per [ADR 010](docs/sdk/next/documentation/legacy/adr-comprehensive).
