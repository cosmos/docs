...
The rationale behind testing can be found in [ADR-59](/docs/common/pages/adr-comprehensive#adr-059-test-scopes).
...
Simulations uses as well a minimal application, built with [`depinject`](/docs/sdk/v0.47/documentation/module-system/depinject):
...
<Note>
**warning**
The SDK is in the process of creating its E2E tests, as defined in [ADR-59](/docs/common/pages/adr-comprehensive#adr-059-test-scopes). This page will eventually be updated with better examples.
</Note>

## Learn More

Learn more about testing scope in [ADR-59](/docs/common/pages/adr-comprehensive#adr-059-test-scopes).
