...
The actual implementation of `BeginBlocker` and `EndBlocker` in `abci.go` are very similar to that of a [`Msg` service](/docs/sdk/v0.47/documentation/module-system/msg-services):

* They generally use the [`keeper`](/docs/sdk/v0.47/documentation/module-system/keeper) and [`ctx`](/docs/sdk/v0.47/learn/advanced/context) to retrieve information about the latest state.
