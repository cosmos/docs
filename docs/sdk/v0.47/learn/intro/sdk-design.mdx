...
---
The Cosmos SDK is a framework that facilitates the development of secure state-machines on top of CometBFT. At its core, the Cosmos SDK is a boilerplate implementation of the [ABCI](sdk-app-architecture#abci) in Golang. It comes with a [`multistore`](/docs/sdk/v0.47/advanced/04-store#multistore) to persist data and a [`router`](/docs/sdk/v0.47/advanced/00-baseapp#routing) to handle transactions.
