...
Learn more about [application-specific blockchains](/docs/sdk/v0.47/learn/intro/why-app-specific).
...
* Learn more about the [architecture of a Cosmos SDK application](/docs/sdk/v0.47/learn/intro/sdk-app-architecture)
