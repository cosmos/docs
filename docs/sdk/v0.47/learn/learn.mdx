...
* [Introduction](/docs/sdk/v0.47/documentation/core-concepts/overview) -  Dive into the fundamentals of Cosmos SDK with an insightful introduction,
...
* [Beginner](/docs/sdk/v0.47/learn/beginner/overview-app) - Start your journey with beginner-friendly resources in the Cosmos SDK's "Learn"
...
* [Advanced](/docs/sdk/v0.47/documentation/application-framework/baseapp) - Level up your Cosmos SDK expertise with advanced topics, tailored for experienced
