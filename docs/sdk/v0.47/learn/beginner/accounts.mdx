...
Address construction algorithm is defined in [ADR-28](https://github.com/cosmos/cosmos-sdk/blob/main/docs/sdk/0.47/architecture/adr-028-public-key-addresses.md).
