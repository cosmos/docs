...
This query command was defined by the [`staking`](/docs/sdk/v0.47/documentation/module-system/staking) module developer and added to the list of subcommands by the application developer when creating the CLI.
...
* **Account Decoder**: The account decoder from the [`auth`](/docs/sdk/v0.47/documentation/module-system/auth) module, which translates `[]byte`s into accounts.
