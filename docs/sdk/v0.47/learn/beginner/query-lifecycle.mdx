...
* **Keyring**: A [Key Manager](./docs/sdk/v0.47/build/modules/accounts/accounts.mdx#keyring) used to sign transactions and handle other operations with keys.
