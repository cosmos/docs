...
* [`CommitMultiStore`](/docs/sdk/v0.47/learn/advanced/store.mdx#commitmultistore): This is the main store of the application,
...
In the Cosmos SDK, after [decoding transactions](/docs/sdk/v0.47/learn/advanced/encoding.mdx), `CheckTx()` is implemented
...
* Be a primary line of defense against spam and second line of defense (the first one being the mempool) against transaction replay with fees deduction and [`sequence`](/docs/sdk/v0.47/learn/advanced/transactions.mdx#transaction-generation) checking.
