...
* [`BeginBlock`](/docs/sdk/v0.47/learn/advanced/baseapp.mdx#beginblock)
* [`EndBlock`](/docs/sdk/v0.47/learn/advanced/baseapp.mdx#endblock)
* [`CheckTx`](/docs/sdk/v0.47/learn/advanced/baseapp.mdx#checktx)
* [`DeliverTx`](/docs/sdk/v0.47/learn/advanced/baseapp.mdx#delivertx)
...
the [`Context`](/docs/sdk/v0.47/learn/advanced/context.mdx), where Event should be already registered, and emitted like this:
