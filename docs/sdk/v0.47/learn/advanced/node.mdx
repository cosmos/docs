...
* First, an [`encodingCodec`](/docs/sdk/v0.47/documentation/protocol-development/encoding) is instantiated for the application.
...
To discover how to concretely run a node and interact with it, please refer to our [Running a Node, API and CLI](/docs/sdk/v0.47/documentation/operations/run-node) guide.
