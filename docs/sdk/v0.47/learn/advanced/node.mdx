...
* [Anatomy of an SDK application](/docs/sdk/v0.47/learn/beginner/app-anatomy)
...
In practice, the [constructor of the application](/docs/sdk/v0.47/learn/beginner/app-anatomy#constructor-function) is passed as the `appCreator`.
