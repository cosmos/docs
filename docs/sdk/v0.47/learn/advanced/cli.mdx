...
* **All [module query commands](/docs/sdk/v0.47/documentation/module-system/module-interfaces#query-commands)** the application is dependent on, retrieved by using the [basic module manager's](/docs/sdk/v0.47/build/building-modules/module-manager#basic-manager) `AddQueryCommands()` function.
