...
[transactions](/docs/sdk/v0.47/documentation/protocol-development/transactions). Transactions are defined by the application or
...
The Protobuf DSL is strongly typed, which can make inserting variable-typed fields difficult. Imagine we want to create a `Profile` protobuf message that serves as a wrapper over [an account](/docs/sdk/v0.47/beginner/accounts):
