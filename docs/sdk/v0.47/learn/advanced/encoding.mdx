...
interface support. See the [Proto3 spec](https://developers.google.com/protocol-buffers/docs/sdk/0.47/proto3)
...
In addition to [following official Protocol Buffer guidelines](https://developers.google.com/protocol-buffers/docs/sdk/0.47/proto3#simple), we recommend using these annotations in .proto files when dealing with interfaces:
...
We encourage developers to follow industry guidelines: [Protocol Buffers style guide](https://developers.google.com/protocol-buffers/docs/sdk/0.47/style)
and [Buf](https://buf.build/docs/sdk/0.47/style-guide), see more details in [ADR 023](/../build/architecture/adr-023-protobuf-naming.md)
