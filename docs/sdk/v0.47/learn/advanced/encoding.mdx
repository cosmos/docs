...
and [Buf](https://buf.build/docs/style-guide), see more details in [ADR 023](/docs/common/pages/adr-comprehensive#adr-023-protocol-buffer-naming-and-versioning-conventions)
