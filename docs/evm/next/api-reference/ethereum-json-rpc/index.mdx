...
<Warning>
  ...
  * All `engine_*` methods - Post-merge Engine API
  ...
  See the [methods page](/docs/evm/next/api-reference/ethereum-json-rpc/methods.mdx) for complete details.
</Warning>
...
<Info>
See the [methods](/docs/evm/next/api-reference/ethereum-json-rpc/methods.mdx) page for an exhaustive list and working examples.
</Info>

| Namespace | Description | Supported | Enabled by Default |
|-----------|-------------|-----------|-------------------|
| [`eth`](/docs/evm/next/api-reference/ethereum-json-rpc/methods.mdx#eth-methods) | Core Ethereum JSON-RPC methods for interacting with the EVM | Y | Y |
| [`web3`](/docs/evm/next/api-reference/ethereum-json-rpc/methods.mdx#web3-methods) | Utility functions for the web3 client | Y | Y |
| [`net`](/docs/evm/next/api-reference/ethereum-json-rpc/methods.mdx#net-methods) | Network information about the node | Y | Y |
| [`txpool`](/docs/evm/next/api-reference/ethereum-json-rpc/methods.mdx#txpool-methods) | Transaction pool inspection | Y | N |
| [`debug`](/docs/evm/next/api-reference/ethereum-json-rpc/methods.mdx#debug-methods) | Debugging and tracing functionality | Y | N |
| [`personal`](/docs/evm/next/api-reference/ethereum-json-rpc/methods.mdx#personal-methods) | Private key management | Y | N |
| [`admin`](/docs/evm/next/api-reference/ethereum-json-rpc/methods.mdx#admin-methods) | Node administration | Y | N |
| [`miner`](/docs/evm/next/api-reference/ethereum-json-rpc/methods.mdx#miner-methods) | Mining operations (stub for PoS) | Y | N |
...
* [`eth_getBalance`](/docs/evm/next/api-reference/ethereum-json-rpc/methods.mdx#eth_getbalance)
* [`eth_getCode`](/docs/evm/next/api-reference/ethereum-json-rpc/methods.mdx#eth_getcode)
* [`eth_getTransactionCount`](/docs/evm/next/api-reference/ethereum-json-rpc/methods.mdx#eth_gettransactioncount)
* [`eth_getStorageAt`](/docs/evm/next/api-reference/ethereum-json-rpc/methods.mdx#eth_getstorageat)
* [`eth_call`](/docs/evm/next/api-reference/ethereum-json-rpc/methods.mdx#eth_call)
