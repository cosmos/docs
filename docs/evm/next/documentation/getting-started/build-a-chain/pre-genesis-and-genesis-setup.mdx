...
- [Runtime Configuration & Launch](/docs/evm/v0.5.0/documentation/getting-started/build-a-chain/runtime-and-launch) - Network launch procedures
- [Configuration Reference](/docs/evm/v0.5.0/documentation/getting-started/build-a-chain/configuration-reference) - Commands, examples, and quick reference
</Info>
...
<Info>
**Network Launch Details**: For complete launch coordination procedures, validator startup instructions, and timing best practices, see [Coordinate Launch Time](/docs/evm/v0.5.0/documentation/getting-started/build-a-chain/runtime-and-launch#coordinate-launch-time) in the Runtime Configuration & Network Launch guide.
</Info>
...
Continue to [Runtime Configuration & Network Launch](/docs/evm/v0.5.0/documentation/getting-started/build-a-chain/runtime-and-launch) for full details.



## Quick Reference

**See**: [Configuration Reference](/docs/evm/v0.5.0/documentation/getting-started/build-a-chain/configuration-reference) for:
- Command cheatsheets
