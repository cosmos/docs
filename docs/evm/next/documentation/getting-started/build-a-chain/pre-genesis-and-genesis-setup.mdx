...
<Expandable title="Binary Name" defaultOpen={false}>
...
<Expandable title="Bech32 Address Prefix" defaultOpen={false}>
...
<Expandable title="BIP44 Coin Type" defaultOpen={false}>
...
<Expandable title="EVM Chain ID" defaultOpen={false}>
...
<Expandable title="Token Decimal Precision" defaultOpen={false}>
...
<Expandable title="Default Denomination in Source" defaultOpen={false}>
...
<Expandable title="Initialize Your Chain" defaultOpen={false}>
...
<Expandable title="Cosmos Chain ID" defaultOpen={false}>
...
<Expandable title="Genesis Time" defaultOpen={false}>
...
<Info>
**Network Launch Details**: For complete launch coordination procedures, validator startup instructions, and timing best practices, see [Coordinate Launch Time](/docs/evm/next/documentation/getting-started/build-a-chain/runtime-and-launch#coordinate-launch-time) in the Runtime Configuration & Network Launch guide.
</Info>
...
<Expandable title="Bank Denomination Metadata" defaultOpen={false}>
...
<Expandable title="VM Parameters" defaultOpen={false}>
...
<Expandable title="Active Precompiles" defaultOpen={false}>
...
<Expandable title="ERC20 Module" defaultOpen={false}>
...
<Expandable title="Fee Market (EIP-1559)" defaultOpen={false}>
...
<Expandable title="EVM Access Control" defaultOpen={false}>
...
<Expandable title="Staking Parameters" defaultOpen={false}>
...
<Expandable title="Slashing Parameters" defaultOpen={false}>
...
<Expandable title="Governance Parameters" defaultOpen={false}>
...
<Expandable title="Mint Parameters" defaultOpen={false}>
...
<Expandable title="Distribution Parameters" defaultOpen={false}>
...
<Expandable title="Initial Accounts and Validators" defaultOpen={false}>
...
Continue to [Runtime Configuration & Network Launch](/docs/evm/next/documentation/getting-started/build-a-chain/runtime-and-launch) for full details.
