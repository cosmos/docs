...
| File | Location | Purpose |
|---|---|---|
| **Bech32 Prefix** | `config/config.go:61-62` | Address prefix |
| **BIP44 Coin Type** | `crypto/hd/hdpath.go:8-9` | HD wallet path |
| **EVM Chain ID** | `config/config.go:78` | EIP-155 chain ID |
| **Default Denoms** | `x/vm/types/params.go:20-25` | EVM module defaults |
| **Constants** | `config/constants.go:4-8` | Example chain values |
...
| Bech32 Prefix | `cosmos` | `config/config.go:61-62` |
| BIP44 Coin Type | `60` (Ethereum) | `crypto/hd/hdpath.go:8-9` |
| EVM Chain ID | `262144` | `config/config.go:78` |
| Base Denom (EVM) | `uatom` | `x/vm/types/params.go:21` |
| Extended Denom | `aatom` | `x/vm/types/params.go:23` |
