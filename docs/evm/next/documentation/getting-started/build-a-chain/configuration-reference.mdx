...
<CardGroup cols={3}>
<Card title="Pre-Genesis Setup" icon="file-code" href="/docs/evm/v0.5.0/documentation/getting-started/build-a-chain/quick-start">
Configuration guide
</Card>

<Card title="Runtime & Launch" icon="rocket" href="/docs/evm/v0.5.0/documentation/getting-started/network-operators/node-configuration">
Launch procedures
</Card>
