...
- [Building Your Chain Guide](/docs/evm/next/documentation/getting-started/build-a-chain/building-your-chain-guide#configuring-predeployed-contracts) - Quick start configuration examples
...
If uaing the reference `evmd` application, your chain automatically includes default preinstalls, however they will not be active by defaut.
...
- [Chain Customization Checklist](/docs/evm/next/documentation/getting-started/build-a-chain/chain-customization-checklist) - Step-by-step setup guide
- [Configuration Parameters](/docs/evm/next/documentation/getting-started/build-a-chain/configuration-parameters) - All genesis parameters explained