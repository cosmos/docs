...
<Info>
For comprehensive ERC20 module configuration, see the [ERC20 Module Documentation](/docs/evm/next/documentation/cosmos-sdk/modules/erc20).
</Info>
...
- See [PreciseBank Module Docs](/docs/evm/next/documentation/cosmos-sdk/modules/precisebank)
