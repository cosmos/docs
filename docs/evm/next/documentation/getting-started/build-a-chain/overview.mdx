...
Besides being much simpler than alternatives, this provides several advantages:
...
- **Peace of mind** - Fully audited (as of v0.4.x) -- read the [audit reports](/docs/evm/next/documentation/overview#audits) here
...
Rather than assembling components from scratch, fork `evmd` and customize it for your specific needs. This approach lets engineers focus on what makes your chain unique rather than debugging basic integration issues.
