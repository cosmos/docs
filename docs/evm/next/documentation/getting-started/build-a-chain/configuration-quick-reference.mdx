    ...
    "denom_metadata": [
      {
        "denom_units": [
          ...
          },
          {
            ...
            "exponent": 6         // Decimals (6 = needs to add precisebank, 18 = standard bank by default)
          }
        ],
        "base": "ustake",
        "display": "stake",
...
- `decimals: 18` → Uses standard bank module (default, no changes needed)
- `decimals: 6` (or any non-18) → Must add precisebank module
...
- [ ] For 18-decimal chains: No module changes needed (standard bank is default)
- [ ] For non-18 decimal chains: Add precisebank module and `extended_denom_options` in VM params
