...
<Accordion title="Configure default token denomination in source code">
...
<Accordion title="Configure slashing parameters (downtime, double-sign penalties)">
...
<Accordion title="Configure client chain-id (required before node startup)">
