...
**Related Configuration**: Requires [PreciseBank Module](/docs/evm/next/documentation/getting-started/build-a-chain/modules/precisebank-module) to be included in app.go

**See Also**: [Token Configuration Guide](/docs/evm/next/documentation/getting-started/build-a-chain/token-configuration-guide) for complete decimal configuration details
...
- [Token Configuration Guide](/docs/evm/next/documentation/getting-started/build-a-chain/token-configuration-guide) - Token decimals and evm_denom setup
- [Fee Market Module](/docs/evm/next/documentation/getting-started/build-a-chain/modules/feemarket-module) - EIP-1559 fee configuration
