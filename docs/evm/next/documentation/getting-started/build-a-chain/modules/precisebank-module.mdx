...
**Source**: [Token Configuration Guide](/docs/evm/next/documentation/getting-started/build-a-chain/token-configuration-guide)
...
- [Token Configuration Guide](/docs/evm/next/documentation/getting-started/build-a-chain/token-configuration-guide) - Decimal configuration
- [VM Module](/docs/evm/next/documentation/getting-started/build-a-chain/modules/vm-module) - extended_denom_options setup
- [ERC20 Module](/docs/evm/next/documentation/getting-started/build-a-chain/modules/erc20-module) - Token pair configuration
