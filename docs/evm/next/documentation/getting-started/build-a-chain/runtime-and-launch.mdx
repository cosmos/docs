...
<Expandable title="Minimum Gas Prices" defaultOpen={false}>
...
<Expandable title="JSON-RPC Configuration" defaultOpen={false}>
...
<Expandable title="EVM Configuration" defaultOpen={false}>
...
<Expandable title="EVM Mempool Configuration" defaultOpen={false}>
...
<Info>
**Advanced Mempool Configuration**: For detailed information on integrating the EVM mempool, see the [EVM Mempool Integration](/docs/evm/next/documentation/getting-started/build-a-chain/additional-configuration/mempool-integration) guide.
</Info>
...
<Expandable title="Persistent Peers" defaultOpen={false}>
...
<Expandable title="Consensus Timeouts" defaultOpen={false}>
...
Faster block times for local developmen or testingt:
...
<Expandable title="Prometheus Metrics" defaultOpen={false}>
...
<Expandable title="Set Client Chain ID" defaultOpen={false}>
...
# Node RPC address - This can be canged to a public endpoint to use the light client without syncinc the full node.
...
<Expandable title="Pre-Launch Checklist" defaultOpen={false}>
...
<Expandable title="Distribute Genesis File" defaultOpen={false}>
...
<Expandable title="Verify Genesis Hash" defaultOpen={false}>
...
<Expandable title="Exchange Peer Information" defaultOpen={false}>
...
<Expandable title="Coordinate Launch Time" defaultOpen={false}>
...
<Expandable title="Start Validator Nodes" defaultOpen={false}>
...
<Expandable title="Verify Network Health" defaultOpen={false}>
