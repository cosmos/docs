...
| **Section** | Root level |
| **Default** | `0aatom` |
| **Can Change After Launch** | Yes (requires node restart) |
...
| **File** | `app.toml` |
| **Section** | `[json-rpc]` |
| **Default** | Enabled on `0.0.0.0:8545` (HTTP), `0.0.0.0:8546` (WebSocket) |
| **Can Change After Launch** | Yes (requires node restart) |
...
| **Can Change After Launch** | Yes, except `evm-chain-id` (read-only, set during init) |
