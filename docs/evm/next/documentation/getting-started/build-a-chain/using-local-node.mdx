...
See the [full mempool documentation](/docs/evm/next/documentation/getting-started/build-a-chain/additional-configuration/mempool-integration) for details.
</Tab>
</Tabs>
...
<Warning>
**Known Issue - Safe Factory**: The Safe Singleton Factory bytecode in `DefaultPreinstalls` is currently incorrect (identical to Create2). Before production deployment, get the correct bytecode from the [official Safe repository](https://github.com/safe-global/safe-singleton-factory). See the [predeployed contracts documentation](/docs/evm/next/documentation/getting-started/build-a-chain/additional-configuration/predeployed-contracts) for details.
</Warning>
