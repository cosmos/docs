...
- [Accounts - Address Formats](/docs/evm/next/documentation/concepts/accounts#address-formats-for-clients)
- [IBC - Address Formats](/docs/evm/next/documentation/concepts/ibc#address-formats-for-ibc-transfers)
...
<Info>
For detailed callback implementation, see [IBC Module](/docs/evm/next/documentation/cosmos-sdk/modules/ibc) and [Callbacks Interface](/docs/evm/next/documentation/smart-contracts/precompiles/callbacks).
</Info>
