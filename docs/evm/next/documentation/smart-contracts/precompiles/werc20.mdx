...
The WERC20 precompile provides a standard ERC20 interface to native Cosmos tokens through Cosmos EVM's **[Single Token Representation](/docs/evm/next/documentation/concepts/single-token-representation)** architecture.
