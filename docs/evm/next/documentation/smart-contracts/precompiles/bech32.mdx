...
contract Bech32Example {
    ...
    {
        bech32Addresses = new string[](/docs/evm/next/documentation/smart-contracts/precompiles/addresses.length);
...
contract Bech32Example {
    ...
    {
        hexAddresses = new address[](/docs/evm/next/documentation/smart-contracts/precompiles/bech32Addresses.length);
