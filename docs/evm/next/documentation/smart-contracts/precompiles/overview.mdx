...
<Note>
For complete genesis configuration including EVM and fee market parameters, see the [Node Configuration](/docs/evm/next/documentation/getting-started/runtime-and-launch#genesis-json) reference.
</Note>
