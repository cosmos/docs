...
| **Safe Singleton Factory** | `0x914d7Fec6aaC8cd542e72Bca78B30650d45643d7` | Deploy Safe multisig wallets at deterministic addresses<br/>⚠️ **Bytecode issue** - see [details](./safe-factory) | [Details](./safe-factory) |
| **EIP-2935** | `0x0b` | Historical block hash storage (system contract) | N/A |

<Note>
Additional pre-deployable contracts can be incorporated into your project in a similar way, given that any dependencies are met. See the [Predeployed Contracts Integration](/docs/evm/next/documentation/migrations/predeployed-contracts-integration) guide for instructions.
</Note>

<Warning>
**Safe Factory Bytecode Issue**: The Safe Singleton Factory in `DefaultPreinstalls` currently has incorrect bytecode (duplicate of Create2). Verify and update the bytecode before production use. See the [Safe Factory documentation](./safe-factory) for details.
</Warning>
