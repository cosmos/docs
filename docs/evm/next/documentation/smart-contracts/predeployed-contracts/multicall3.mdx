...
contract MultiTokenReader {
    ...
    function getTokenBalances(
        ...
        IMulticall3.Call3[] memory calls = new IMulticall3.Call3[](/docs/evm/next/documentation/smart-contracts/predeployed-contracts/tokens.length);
        ...
        balances = new uint256[](/docs/evm/next/documentation/smart-contracts/predeployed-contracts/results.length);
