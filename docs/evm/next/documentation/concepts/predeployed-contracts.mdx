...
- [Building Your Chain Guide](/docs/evm/next/documentation/getting-started/build-a-chain/building-your-chain-guide#configuring-predeployed-contracts) - Quick start configuration
- [Predeployed Contracts Integration](/docs/evm/next/documentation/getting-started/build-a-chain/additional-configuration/predeployed-contracts-integration) - Detailed implementation guide
- [Chain Customization Checklist](/docs/evm/next/documentation/getting-started/build-a-chain/chain-customization-checklist) - Step-by-step setup
</Note>
...
- [Building Your Chain](/docs/evm/next/documentation/getting-started/build-a-chain/building-your-chain-guide) - Complete guide to chain setup

## Implementation Guides

- [Predeployed Contracts Integration](/docs/evm/next/documentation/getting-started/build-a-chain/additional-configuration/predeployed-contracts-integration) - Detailed technical guide for deploying and managing preinstalled contracts
- [Chain Customization Checklist](/docs/evm/next/documentation/getting-started/build-a-chain/chain-customization-checklist) - Step-by-step setup checklist
