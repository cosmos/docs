...
- [VM Module](/docs//docs/evm/next/documentation/cosmos-sdk/modules/vm) - Core EVM module configuration including preinstalls
...
- [Chain Customization Checklist](/docs/evm/next/documentation/getting-started/build-a-chain/configuration-reference) - Step-by-step setup checklist
