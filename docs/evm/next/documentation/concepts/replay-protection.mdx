...
As documented in the [Chain ID](/docs/evm/next/documentation/concepts/chain-id) page, Cosmos EVM uses:
...
- [Chain ID Configuration](/docs/evm/next/documentation/concepts/chain-id)
- [Transaction Types](/docs/evm/next/documentation/concepts/transactions#ethereum-tx-type)
- [EVM Module Parameters](/docs//docs/evm/next/documentation/cosmos-sdk/modules/vm#parameters)