...
- **Related Documentation:** [Mempool Configuration](/docs/evm/next/documentation/concepts/mempool.mdx), [VM Module](/docs/evm/next/documentation/cosmos-sdk/modules/vm.mdx)
