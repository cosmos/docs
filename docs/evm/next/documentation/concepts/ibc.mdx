...
For more information on address representation and conversion, see [Accounts - Address Formats](/docs/evm/next/documentation/concepts/accounts#address-formats-for-clients).
