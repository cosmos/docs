...
**EIP-7702 Support**: Cosmos EVM supports [EIP-7702 code delegation](/docs/evm/next/documentation/evm-compatibility/eip-7702), allowing EOAs to temporarily delegate code execution to smart contracts through the `SetCodeHash` functionality.
...
<Info>
For more information on address format usage in IBC transfers, see [IBC - Address Formats](/docs/evm/next/documentation/concepts/ibc#address-formats-for-ibc-transfers).
</Info>
...
<Note>
For JSON-RPC methods, see [`eth_accounts`](/docs/evm/next/api-reference/ethereum-json-rpc/methods#eth-accounts) and [`personal_listAccounts`](/docs/evm/next/api-reference/ethereum-json-rpc/methods#personal-listAccounts) documentation.
</Note>
