...
**Related Configuration**: Requires [PreciseBank Module](/docs/evm/next/documentation/cosmos-sdk/modules/precisebank) to be included in app.go

**See Also**: [Token Configuration Guide](/docs/evm/next/documentation/getting-started/build-a-chain/pre-genesis-and-genesis-setup) for complete decimal configuration details
...
- [Token Configuration Guide](/docs/evm/next/documentation/getting-started/build-a-chain/pre-genesis-and-genesis-setup) - Token decimals and evm_denom setup
- [Fee Market Module](/docs/evm/next/documentation/cosmos-sdk/modules/feemarket) - EIP-1559 fee configuration
