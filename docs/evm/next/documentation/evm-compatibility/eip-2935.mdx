...
```solidity Basic Block Hash Access expandable
...
```solidity Verifiable Randomness Protocol expandable
...
```solidity Block-Based State Transitions expandable
...
- **Related Documentation:** [VM Module Parameters](/docs/evm/next/documentation/cosmos-sdk/modules/vm.mdx#parameters)