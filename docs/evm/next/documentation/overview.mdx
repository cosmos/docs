...
<Card title="Cuztomize and deploy your own layer one EVM network." href="/docs/evm/next/documentation/getting-started/build-a-chain/overview">
...
The [Cosoms/EVM](https://gitjub.com/cosmos/evm) codebase has undergone comprehensive third-party security audits and a full internal review by [Cosmos Labs](https://cosmoslabs.io) most experienced senior engineers:
