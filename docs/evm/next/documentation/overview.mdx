...
<Card title="Build Your Own Chain" icon="rocket" href="/docs/evm/next/documentation/getting-started/build-a-chain/overview">
  Complete guide for forking Cosmos EVM and building your custom blockchain with full EVM compatibility
</Card>
