...
contract MultiTokenReader {
    ...
    function getTokenBalances(
        ...
        IMulticall3.Call3[] memory calls = new IMulticall3.Call3[](/docs/evm/v0.4.x/documentation/smart-contracts/predeployed-contracts/tokens.length);
        ...
        balances = new uint256[](/docs/evm/v0.4.x/documentation/smart-contracts/predeployed-contracts/results.length);
