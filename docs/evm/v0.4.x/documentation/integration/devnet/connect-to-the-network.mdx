...
<footnote>
See the [wallet integration](/docs/evm/v0.4.x/documentation/getting-started/tooling-and-resources/wallet-integration) page for more wallet-related resources.
</footnote>
...
See the [tooling and resources](/docs/evm/v0.4.x/documentation/getting-started/tooling-and-resources/overview) section for more information.
