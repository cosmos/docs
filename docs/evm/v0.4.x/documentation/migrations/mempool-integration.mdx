...
1. **EVM Module Integration**: Complete the [EVM module integration](/docs/evm/next/documentation/getting-started/build-a-chain/overview) first
...
- [EVM Module Integration](/docs/evm/next/documentation/getting-started/build-a-chain/overview) - Prerequisites for mempool integration
