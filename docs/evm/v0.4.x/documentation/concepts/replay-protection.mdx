...
As documented in the [Chain ID](/docs/evm/v0.4.x/documentation/concepts/chain-id) page, Cosmos EVM uses:
...
- [Chain ID Configuration](/docs/evm/v0.4.x/documentation/concepts/chain-id)
- [Transaction Types](/docs/evm/v0.4.x/documentation/concepts/transactions#ethereum-tx-type)
- [EVM Module Parameters](/docs/evm/v0.4.x/documentation/cosmos-sdk/modules/vm#parameters)