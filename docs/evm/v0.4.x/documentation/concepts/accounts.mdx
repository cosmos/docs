...
For more information on Ethereum accounts head over to the [x/vm module](/docs/evm/v0.4.x/documentation/cosmos-sdk/modules/vm).
...
<Note>
For JSON-RPC methods, see [`eth_accounts`](/docs/evm/v0.4.x/api-reference/ethereum-json-rpc/methods#eth-accounts) and [`personal_listAccounts`](/docs/evm/v0.4.x/api-reference/ethereum-json-rpc/methods#personal-listAccounts) documentation.
</Note>
