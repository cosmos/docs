...
<Note>
  For conceptual understanding of precision handling and mathematical proofs, see [Precision Handling](/docs/evm/v0.4.x/documentation/concepts/precision-handling).
</Note>
...
- [Precision Handling](/docs/evm/v0.4.x/documentation/concepts/precision-handling) - Mathematical foundation
- [VM Module](/docs/evm/v0.4.x/documentation/cosmos-sdk/modules/vm) - EVM integration
