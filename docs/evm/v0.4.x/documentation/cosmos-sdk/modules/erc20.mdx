...
<Note>
  For conceptual understanding of Single Token Representation v2, see [Single Token Representation](/docs/evm/v0.4.x/documentation/concepts/single-token-representation).
</Note>
...
- [Single Token Representation](/docs/evm/v0.4.x/documentation/concepts/single-token-representation) - Conceptual overview
- [VM Module](/docs/evm/v0.4.x/documentation/cosmos-sdk/modules/vm) - EVM execution environment
