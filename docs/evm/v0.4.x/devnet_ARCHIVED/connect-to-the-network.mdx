...
<footnote>
See the [wallet integration](/docs/evm/next/documentation/getting-started/tooling-and-resources/wallet-integration) page for more wallet-related resources.
</footnote>
...
See the [tooling and resources](/docs/evm/next/documentation/getting-started/tooling-and-resources/overview) section for more information.
