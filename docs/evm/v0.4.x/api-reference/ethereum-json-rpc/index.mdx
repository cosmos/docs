...
* [Geth JSON-RPC Server](https://geth.ethereum.org/v0.4.x/interacting-with-geth/rpc)
* [Ethereum's PubSub JSON-RPC API](https://geth.ethereum.org/v0.4.x/interacting-with-geth/rpc/pubsub)
...
<Warning>
  ...
  * All `engine_*` methods - Post-merge Engine API
  ...
  See the [methods page](/docs/evm/v0.4.x/api-reference/ethereum-json-rpc/methods.mdx) for complete details.
</Warning>
...
<Info>
See the [methods](/docs/evm/v0.4.x/api-reference/ethereum-json-rpc/methods.mdx) page for an exhaustive list and working examples.
</Info>

| Namespace | Description | Supported | Enabled by Default |
|-----------|-------------|-----------|-------------------|
| [`eth`](/docs/evm/v0.4.x/api-reference/ethereum-json-rpc/methods.mdx#eth-methods) | Core Ethereum JSON-RPC methods for interacting with the EVM | Y | Y |
| [`web3`](/docs/evm/v0.4.x/api-reference/ethereum-json-rpc/methods.mdx#web3-methods) | Utility functions for the web3 client | Y | Y |
| [`net`](/docs/evm/v0.4.x/api-reference/ethereum-json-rpc/methods.mdx#net-methods) | Network information about the node | Y | Y |
| [`txpool`](/docs/evm/v0.4.x/api-reference/ethereum-json-rpc/methods.mdx#txpool-methods) | Transaction pool inspection | Y | N |
| [`debug`](/docs/evm/v0.4.x/api-reference/ethereum-json-rpc/methods.mdx#debug-methods) | Debugging and tracing functionality | Y | N |
| [`personal`](/docs/evm/v0.4.x/api-reference/ethereum-json-rpc/methods.mdx#personal-methods) | Private key management | Y | N |
| [`admin`](/docs/evm/v0.4.x/api-reference/ethereum-json-rpc/methods.mdx#admin-methods) | Node administration | Y | N |
| [`miner`](/docs/evm/v0.4.x/api-reference/ethereum-json-rpc/methods.mdx#miner-methods) | Mining operations (stub for PoS) | Y | N |
...
Cosmos EVM also supports the Ethereum [JSON-RPC](/docs/evm/v0.4.x/api-reference/ethereum-json-rpc/methods.mdx) filters calls to subscribe to [state logs](https://eth.wiki/json-rpc/API#eth_newfilter), [blocks](https://eth.wiki/json-rpc/API#eth_newblockfilter) or [pending transactions](https://eth.wiki/json-rpc/API#eth_newpendingtransactionfilter) changes.
...
* [`eth_getBalance`](/docs/evm/v0.4.x/api-reference/ethereum-json-rpc/methods.mdx#eth_getbalance)
* [`eth_getCode`](/docs/evm/v0.4.x/api-reference/ethereum-json-rpc/methods.mdx#eth_getcode)
* [`eth_getTransactionCount`](/docs/evm/v0.4.x/api-reference/ethereum-json-rpc/methods.mdx#eth_gettransactioncount)
* [`eth_getStorageAt`](/docs/evm/v0.4.x/api-reference/ethereum-json-rpc/methods.mdx#eth_getstorageat)
* [`eth_call`](/docs/evm/v0.4.x/api-reference/ethereum-json-rpc/methods.mdx#eth_call)
