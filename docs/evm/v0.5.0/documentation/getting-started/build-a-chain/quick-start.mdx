...
<CardGroup cols={2}>
<Card title="Configuration Parameters" icon="gear" href="/docs/evm/v0.5.0/documentation/getting-started/build-a-chain/configuration-parameters">
Detailed guide to all configuration options
</Card>

<Card title="Precompiles" icon="puzzle" href="/docs/evm/v0.5.0/documentation/smart-contracts/precompiles/overview">
...
<Card title="ERC20 Module" icon="coins" href="/docs/evm/v0.5.0/documentation/cosmos-sdk/modules/erc20">
