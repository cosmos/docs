...
**Precompiled Contracts** - [Precompiles](/docs/evm/v0.5.0/documentation/smart-contracts/precompiles) bridge EVM smart contracts with Cosmos SDK modules, enabling Solidity contracts to access staking, governance, IBC, and other native functionality.

**Cosmos SDK Modules** - Explore the [core modules](/docs/evm/v0.5.0/documentation/cosmos-sdk) that provide blockchain functionality:
