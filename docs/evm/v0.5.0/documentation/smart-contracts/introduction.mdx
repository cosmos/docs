...
Cosmos EVM supports the full [Ethereum JSON-RPC](/docs/evm/v0.5.0/api-reference/ethereum-json-rpc) API, enabling you to:
...
* Use [block explorers](/docs/evm/v0.5.0/documentation/getting-started/tooling-and-resources/block-explorers) to debug and monitor your contracts
...
These precompiles open up functionality that would be impossible or prohibitively expensive with regular smart contracts. [View all available precompiles →](/docs/evm/v0.5.0/documentation/smart-contracts/precompiles)
...
* **Documentation:** [Cosmos EVM Precompiles](/docs/evm/v0.5.0/documentation/smart-contracts/precompiles) | [Tooling Guide](/docs/evm/v0.5.0/documentation/getting-started/tooling-and-resources/overview)
