...
<Note>
For complete genesis configuration including EVM and fee market parameters, see the [Node Configuration](/docs/evm/v0.5.0/documentation/getting-started/runtime-and-launch#genesis-json) reference.
</Note>
