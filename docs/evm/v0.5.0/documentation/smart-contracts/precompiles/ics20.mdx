...
The ICS20 precompile supports both Ethereum hex addresses (`0x...`) and Cosmos bech32 addresses (e.g., `cosmos1...`) for sender and receiver parameters. The address codec automatically handles format conversion.

**Examples:**
- Hex: `0x91defC7fE5603DFA8CC9B655cF5772459BF10c6f`
- Bech32: `cosmos1z3t55m0l9h0eupuz3dp5t5cypyv674jj7mz2jw`

Both formats work identically and can be used interchangeably.

<Warning>
When using a hex address as the receiver, both the sending chain and the receiving chain must support hex addresses. Not all IBC-enabled chains have EVM or hex address support.
</Warning>

**Implementation:** See the [address codec implementation](https://github.com/cosmos/evm/blob/main/encoding/address/address_codec.go) for technical details.

For more information, see:
- [Accounts - Address Formats](/docs/evm/v0.5.0/documentation/concepts/accounts#address-formats-for-clients)
- [IBC - Address Formats](/docs/evm/v0.5.0/documentation/concepts/ibc#address-formats-for-ibc-transfers)
...
<Info>
For detailed callback implementation, see [IBC Module](/docs/evm/v0.5.0/documentation/cosmos-sdk/modules/ibc) and [Callbacks Interface](/docs/evm/v0.5.0/documentation/smart-contracts/precompiles/callbacks).
</Info>
