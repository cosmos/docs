...
* [Mempool Architecture](/docs/evm/v0.5.0/documentation/concepts/mempool)
...
See the [JSON-RPC Methods](/docs/evm/v0.5.0/api-reference/ethereum-json-rpc/methods#txpool-methods) documentation for complete details.
...
* [`eth_getBalance`](/docs/evm/v0.5.0/api-reference/ethereum-json-rpc/methods#eth_getbalance) - Get balance considering pending transactions
* [`eth_getTransactionCount`](/docs/evm/v0.5.0/api-reference/ethereum-json-rpc/methods#eth_gettransactioncount) - Get next nonce considering pending transactions
* [`eth_getBlockTransactionCountByNumber`](/docs/evm/v0.5.0/api-reference/ethereum-json-rpc/methods#eth_getblocktransactioncountbynumber) - Count pending transactions
* [`eth_getBlockByNumber`](/docs/evm/v0.5.0/api-reference/ethereum-json-rpc/methods#eth_getblockbynumber) - Get pending block information
* [`eth_getTransactionByHash`](/docs/evm/v0.5.0/api-reference/ethereum-json-rpc/methods#eth_gettransactionbyhash) - Retrieve pending transactions
* [`eth_getTransactionByBlockNumberAndIndex`](/docs/evm/v0.5.0/api-reference/ethereum-json-rpc/methods#eth_gettransactionbyblockhashandindex) - Access specific pending transactions
* [`eth_sendTransaction`](/docs/evm/v0.5.0/api-reference/ethereum-json-rpc/methods#eth_sendtransaction) - Submit new transactions

Additionally, the `txpool_*` namespace provides specialized methods for mempool inspection:
* [`txpool_status`](/docs/evm/v0.5.0/api-reference/ethereum-json-rpc/methods#txpool_status) - Get pool statistics
* [`txpool_content`](/docs/evm/v0.5.0/api-reference/ethereum-json-rpc/methods#txpool_content) - View all pool transactions
* [`txpool_contentFrom`](/docs/evm/v0.5.0/api-reference/ethereum-json-rpc/methods#txpool_contentfrom) - Filter by address
* [`txpool_inspect`](/docs/evm/v0.5.0/api-reference/ethereum-json-rpc/methods#txpool_inspect) - Human-readable summaries
...
- See [Mempool Architecture](/docs/evm/v0.5.0/documentation/concepts/mempool#architecture) for the two-tier system design
- Review [Transaction Flow](/docs/evm/v0.5.0/documentation/concepts/mempool#transaction-flow) for state transitions
- Check [Integration Guide](/docs/evm/v0.5.0/documentation/getting-started/build-a-chain/additional-configuration/mempool-integration.mdx) for implementation details