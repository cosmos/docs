...
## Address Formats for IBC Transfers

IBC transfers support both Ethereum hex addresses (`0x...`) and Cosmos bech32 addresses (e.g., `cosmos1...`) for sender and receiver parameters. The address codec automatically handles format conversion.

**Examples:**
- Hex format: `0x91defC7fE5603DFA8CC9B655cF5772459BF10c6f`
- Bech32 format: `cosmos1z3t55m0l9h0eupuz3dp5t5cypyv674jj7mz2jw`

Both formats represent the same account and can be used interchangeably in IBC transfers.
...
**Implementation:** The address codec handles bidirectional conversion between formats. See the [address codec implementation](https://github.com/cosmos/evm/blob/main/encoding/address/address_codec.go) for technical details.

For more information on address representation and conversion, see [Accounts - Address Formats](/docs/evm/v0.5.0/documentation/concepts/accounts#address-formats-for-clients).
