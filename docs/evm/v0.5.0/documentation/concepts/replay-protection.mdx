...
As documented in the [Chain ID](/docs/evm/v0.5.0/documentation/concepts/chain-id) page, Cosmos EVM uses:
...
- [Chain ID Configuration](/docs/evm/v0.5.0/documentation/concepts/chain-id)
- [Transaction Types](/docs/evm/v0.5.0/documentation/concepts/transactions#ethereum-tx-type)
- [EVM Module Parameters](/docs/evm/v0.5.0/documentation/cosmos-sdk/modules/vm#parameters)