...
<Info>
Smart contracts can initiate IBC transfers using the [ICS20 Precompile](/docs/evm/v0.5.0/documentation/smart-contracts/precompiles/ics20), which provides the `transfer` function with memo field support for callbacks. Both hex and bech32 addresses are accepted.
</Info>
...
See [Accounts - Address Formats](/docs/evm/v0.5.0/documentation/concepts/accounts#address-formats-for-clients) for more information on address representation.
</Info>
