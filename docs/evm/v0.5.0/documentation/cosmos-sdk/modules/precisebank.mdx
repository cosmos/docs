...
**Source**: [Token Configuration Guide](/docs/evm/v0.5.0/documentation/getting-started/build-a-chain/pre-genesis-and-genesis-setup)
...
- [Token Configuration Guide](/docs/evm/v0.5.0/documentation/getting-started/build-a-chain/pre-genesis-and-genesis-setup) - Decimal configuration
- [VM Module](/docs/evm/v0.5.0/documentation/cosmos-sdk/modules/vm) - extended_denom_options setup
- [ERC20 Module](/docs/evm/v0.5.0/documentation/cosmos-sdk/modules/erc20) - Token pair configuration
