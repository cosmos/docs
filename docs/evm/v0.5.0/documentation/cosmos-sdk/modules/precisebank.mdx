...
**Source**: [Token Configuration Guide](/docs/evm/v0.5.0/documentation/getting-started/build-a-chain/quick-start)
...
- [Token Configuration Guide](/docs/evm/v0.5.0/documentation/getting-started/build-a-chain/quick-start) - Decimal configuration
