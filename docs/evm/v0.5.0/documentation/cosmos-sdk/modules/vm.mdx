...
**See Also**: [Token Configuration Guide](/docs/evm/v0.5.0/documentation/getting-started/build-a-chain/quick-start) for complete decimal configuration details
...
- [Chain Customization Checklist](/docs/evm/v0.5.0/documentation/getting-started/build-a-chain/quick-start) - Complete parameter checklist
- [Token Configuration Guide](/docs/evm/v0.5.0/documentation/getting-started/build-a-chain/quick-start) - Token decimals and evm_denom setup
