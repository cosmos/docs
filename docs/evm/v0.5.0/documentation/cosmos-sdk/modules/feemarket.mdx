...
- [VM Module](/docs/evm/v0.5.0/documentation/cosmos-sdk/modules/vm) - EVM configuration
- [Token Configuration Guide](/docs/evm/v0.5.0/documentation/getting-started/build-a-chain/pre-genesis-and-genesis-setup) - Token economics setup
