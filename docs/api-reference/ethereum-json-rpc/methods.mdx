...
<Warning>
**Implementation Status**: While Cosmos EVM responds to all standard Ethereum RPC methods for compatibility, many are stub implementations that return empty or null responses. This page indicates the actual implementation status of each method.
...
<Note>
**Namespace Configuration**: By default, only the `eth`, `net`, and `web3` namespaces are enabled. To enable additional namespaces like `personal`, `txpool`, `debug`, or `miner`, you must configure them in your node's app.toml config file.
</Note>
...
<AccordionGroup>
  <Accordion title="debug - Debugging and Tracing (Not Implemented)">
    The `debug` namespace provides debugging and tracing tools for development. These methods are not implemented in Cosmos EVM. For debugging needs, use standard logging and monitoring tools.
  </Accordion>
...
| `eth_mining`                                                                          | Eth       | N          | Y      | Not implemented    |
| [`eth_coinbase`](#eth_coinbase)                                                       | Eth       | N          | Y      | Not implemented    |
| `eth_hashrate`                                                                        | Eth       | N          | Y      | Not implemented    |
...
| [`eth_getProof`](#eth_getproof)                                                       | Eth       | N          | Y      | Requires valid height |
...
| `eth_createAccessList`                                                                | Eth       | N          | Y      | Not implemented    |
| `eth_blobBaseFee`                                                                     | Eth       | N          | Y      | Not implemented    |
...
| `eth_getPendingTransactions`                                                          | Eth       | N          | Y      | Not implemented    |
...
| `debug_blockProfile`                                                                  | Debug     | N          | N      | Requires Profiling config |
| `debug_cpuProfile`                                                                    | Debug     | N          | N      | Requires Profiling config |
| `debug_dumpBlock`                                                                     | Debug     | N          | N      | Returns undefined  |
| `debug_gcStats`                                                                       | Debug     | N          | N      | Requires Profiling config |
| [`debug_getBlockRlp`](#debug_getblockrlp)                                            | Debug     | N          | N      | Requires uint64 param |
| `debug_goTrace`                                                                       | Debug     | N          | N      | Requires Profiling config |
| `debug_freeOSMemory`                                                                  | Debug     | N          | N      | Requires Profiling config |
| `debug_memStats`                                                                      | Debug     | N          | N      | Requires Profiling config |
| `debug_mutexProfile`                                                                  | Debug     | N          | N      | Requires Profiling config |
| `debug_seedHash`                                                                      | Debug     | N          | N      | Not implemented    |
| `debug_setHead`                                                                       | Debug     | N          | N      | Not implemented    |
| `debug_setBlockProfileRate`                                                           | Debug     | N          | N      | Requires Profiling config |
| `debug_setGCPercent`                                                                  | Debug     | N          | N      | Requires Profiling config |
| `debug_setMutexProfileFraction`                                                       | Debug     | N          | N      | Requires Profiling config |
| `debug_stacks`                                                                        | Debug     | N          | N      | Requires Profiling config |
| `debug_startCPUProfile`                                                               | Debug     | N          | N      | Requires Profiling config |
| `debug_startGoTrace`                                                                  | Debug     | N          | N      | Requires Profiling config |
| `debug_stopCPUProfile`                                                                | Debug     | N          | N      | Requires Profiling config |
| `debug_stopGoTrace`                                                                   | Debug     | N          | N      | Requires Profiling config |
| `debug_traceBlock`                                                                    | Debug     | N          | N      | Returns undefined  |
| [`debug_traceBlockByNumber`](#debug_traceblockbynumber)                               | Debug     | Stub       | N      | Returns empty array |
| [`debug_traceBlockByHash`](#debug_traceblockhash)                                    | Debug     | Stub       | N      | Returns empty array |
...
| [`debug_traceTransaction`](#debug_tracetransaction)                                   | Debug     | N          | N      | Returns undefined  |
| `debug_traceCall`                                                                     | Debug     | N          | N      | Returns undefined  |
...
| `debug_writeBlockProfile`                                                             | Debug     | N          | N      | Requires Profiling config |
| `debug_writeMemProfile`                                                               | Debug     | N          | N      | Requires Profiling config |
| `debug_writeMutexProfile`                                                             | Debug     | N          | N      | Requires Profiling config |
...
| [`debug_printBlock`](#debug_printblock)                                              | Debug     | N          | N      | Requires uint64 param |
| [`debug_getHeaderRlp`](#debug_getheaderrlp)                                          | Debug     | N          | N      | Requires uint64 param |
| `debug_intermediateRoots`                                                             | Debug     | N          | N      | Requires Profiling config |
...
| [`txpool_content`](#txpool_content)                                                   | TxPool    | Y          | Y      | Requires `v0.4.x` mempool    |
| [`txpool_contentFrom`](#txpool_contentfrom)                                           | TxPool    | Y          | Y      | Requires `v0.4.x` mempool    |
| [`txpool_inspect`](#txpool_inspect)                                                   | TxPool    | Y          | Y      | Requires `v0.4.x` mempool    |
| [`txpool_status`](#txpool_status)                                                     | TxPool    | Stub       | Y      | Requires `v0.4.x` mempool    |
...
For more details on how Cosmos EVM differs from standard Ethereum implementations, see [Differences from Standard EVMs](/docs/documentation/evm-compatibility/overview).
</Info>
