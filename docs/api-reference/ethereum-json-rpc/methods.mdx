...
<Note>
**Namespace Configuration**: By default, only the `eth`, `net`, and `web3` namespaces are enabled. To enable additional namespaces like `personal`, `txpool`, `debug`, or `miner`, you must configure them in your node's JSON-RPC API settings. Methods marked as "Requires config" are implemented but need their namespace to be explicitly enabled.
</Note>
...
| [`net_peerCount`](#net_peercount)                                                     | Net       | Y          | Y      |                    |
| [`net_listening`](#net_listening)                                                     | Net       | Y          | Y      |                    |
| [`eth_protocolVersion`](#eth_protocolversion)                                         | Eth       | Y          | Y      |                    |
| [`eth_syncing`](#eth_syncing)                                                         | Eth       | Y          | Y      |                    |
| [`eth_gasPrice`](#eth_gasprice)                                                       | Eth       | Y          | Y      |                    |
...
| [`eth_getBlockTransactionCountByNumber`](#eth_getblocktransactioncountbynumber)       | Eth       | Y          | Y      |                    |
| [`eth_getBlockTransactionCountByHash`](#eth_getblocktransactioncountbyhash)           | Eth       | Y          | Y      |                    |
| [`eth_getCode`](#eth_getcode)                                                         | Eth       | Y          | Y      |                    |
| [`eth_sign`](#eth_sign)                                                               | Eth       | Y          | N      |                    |
| [`eth_sendTransaction`](#eth_sendtransaction)                                         | Eth       | Y          | N      |                    |
| [`eth_sendRawTransaction`](#eth_sendrawtransaction)                                   | Eth       | Y          | Y      |                    |
| [`eth_call`](#eth_call)                                                               | Eth       | Y          | Y      |                    |
| [`eth_estimateGas`](#eth_estimategas)                                                 | Eth       | Y          | Y      |                    |
| [`eth_getBlockByNumber`](#eth_getblockbynumber)                                       | Eth       | Y          | Y      |                    |
| [`eth_getBlockByHash`](#eth_getblockbyhash)                                           | Eth       | Y          | Y      |                    |
| [`eth_getTransactionByHash`](#eth_gettransactionbyhash)                               | Eth       | Y          | Y      |                    |
| [`eth_getTransactionByBlockHashAndIndex`](#eth_gettransactionbyblockhashandindex)     | Eth       | Y          | Y      |                    |
| [`eth_getTransactionReceipt`](#eth_gettransactionreceipt)                             | Eth       | Y          | Y      |                    |
...
| [`eth_uninstallFilter`](#eth_uninstallfilter)                                         | Eth       | Y          | Y      |                    |
| [`eth_getFilterChanges`](#eth_getfilterchanges)                                       | Eth       | Y          | Y      |                    |
| [`eth_getFilterLogs`](#eth_getfilterlogs)                                             | Eth       | Y          | Y      |                    |
| [`eth_getLogs`](#eth_getlogs)                                                         | Eth       | Y          | Y      |                    |
| [`eth_getTransactionByBlockNumberAndIndex`](#eth_gettransactionbyblocknumberandindex) | Eth       | Y          | Y      |                    |
| `eth_getWork`                                                                         | Eth       | Y          | Y      | Returns empty work |
| `eth_submitWork`                                                                      | Eth       | Y          | Y      | Always returns false|
| `eth_submitHashrate`                                                                  | Eth       | Y          | Y      | Stub implementation|
| `eth_getCompilers`                                                                    | Eth       | N          | N      | Deprecated         |
| `eth_compileLLL`                                                                      | Eth       | N          | N      | Deprecated         |
| `eth_compileSolidity`                                                                 | Eth       | N          | N      | Deprecated         |
| `eth_compileSerpent`                                                                  | Eth       | N          | N      | Deprecated         |
| `eth_signTransaction`                                                                 | Eth       | Y          | N      |                    |
| `eth_mining`                                                                          | Eth       | Y          | Y      | Always false       |
| [`eth_coinbase`](#eth_coinbase)                                                       | Eth       | Y          | Y      |                    |
| `eth_hashrate`                                                                        | Eth       | Y          | Y      | Always 0           |
| `eth_getUncleCountByBlockHash`                                                        | Eth       | Y          | Y      | Always 0           |
| `eth_getUncleCountByBlockNumber`                                                      | Eth       | Y          | Y      | Always 0           |
| `eth_getUncleByBlockHashAndIndex`                                                     | Eth       | Y          | Y      | Always null        |
| `eth_getUncleByBlockNumberAndIndex`                                                   | Eth       | Y          | Y      | Always null        |
| [`eth_getProof`](#eth_getproof)                                                       | Eth       | Y          | Y      |                    |
| `eth_feeHistory`                                                                      | Eth       | Y          | Y      | EIP-1559           |
| `eth_maxPriorityFeePerGas`                                                            | Eth       | Y          | Y      | EIP-1559           |
| `eth_chainId`                                                                         | Eth       | Y          | Y      |                    |
| `eth_getBlockReceipts`                                                                | Eth       | Y          | Y      |                    |
| `eth_resend`                                                                          | Eth       | Y          | Y      |                    |
| `eth_pendingTransactions`                                                             | Eth       | Y          | Y      |                    |
| `eth_createAccessList`                                                                | Eth       | Y          | Y      | EIP-2930           |
| [`eth_subscribe`](#eth_subscribe)                                                     | Websocket | W         | Y      | syncing not impl.  |
| [`eth_unsubscribe`](#eth_unsubscribe)                                                 | Websocket | Y          | Y      |                    |
| [`personal_importRawKey`](#personal_importrawkey)                                     | Personal  | Y          | N      |                    |
| [`personal_listAccounts`](#personal_listaccounts)                                     | Personal  | Y          | N      |                    |
| [`personal_lockAccount`](#personal_lockaccount)                                       | Personal  | Y          | N      |                    |
| [`personal_newAccount`](#personal_newaccount)                                         | Personal  | Y          | N      |                    |
| [`personal_unlockAccount`](#personal_unlockaccount)                                   | Personal  | Y          | N      |                    |
| [`personal_sendTransaction`](#personal_sendtransaction)                               | Personal  | Y          | N      | Requires config    |
| [`personal_sign`](#personal_sign)                                                     | Personal  | Y          | N      |                    |
| [`personal_ecRecover`](#personal_ecrecover)                                           | Personal  | Y          | N      | Requires config    |
| [`personal_initializeWallet`](#personal_initializewallet)                             | Personal  | Y          | N      |                    |
| [`personal_unpair`](#personal_unpair)                                                 | Personal  | Y          | N      |                    |
| `personal_listWallets`                                                                | Personal  | Y          | N      |                    |
...
| `admin_addPeer`                                                                       | Admin     | Y          | N      |                    |
| `admin_removePeer`                                                                    | Admin     | Y          | N      |                    |
| `admin_datadir`                                                                       | Admin     | Y          | N      |                    |
| `admin_nodeInfo`                                                                      | Admin     | Y          | N      |                    |
| `admin_peers`                                                                         | Admin     | Y          | N      |                    |
| `admin_startHTTP`                                                                     | Admin     | Y          | N      |                    |
| `admin_startWS`                                                                       | Admin     | Y          | N      |                    |
| `admin_stopHTTP`                                                                      | Admin     | Y          | N      |                    |
| `admin_stopWS`                                                                        | Admin     | Y          | N      |                    |
...
| `debug_goTrace`                                                                       | Debug     |             |        |                    |
| `debug_freeOSMemory`                                                                  | Debug     | Y          | N      | **Cosmos-specific**|
| `debug_memStats`                                                                      | Debug     | Y          | N      |                    |
| `debug_mutexProfile`                                                                  | Debug     | N          | N      | Not implemented    |
| `debug_seedHash`                                                                      | Debug     | N          | N      | Not implemented    |
| `debug_setHead`                                                                       | Debug     | N          | N      | Not implemented    |
| `debug_setBlockProfileRate`                                                           | Debug     | Y          | N      |                    |
| `debug_setGCPercent`                                                                  | Debug     | Y          | N      | **Cosmos-specific**|
| `debug_setMutexProfileFraction`                                                       | Debug     | N          | N      | Not implemented    |
| `debug_stacks`                                                                        | Debug     |             |        |                    |
...
| `debug_writeMutexProfile`                                                             | Debug     | Y          | N      | **Cosmos-specific**|
...
| `debug_printBlock`                                                                    | Debug     | N          | N      | Not implemented    |
| `debug_getBadBlocks`                                                                  | Debug     | Y          | N      |                    |
| `debug_storageRangeAt`                                                                | Debug     | Y          | N      |                    |
| `debug_getModifiedAccountsByNumber`                                                   | Debug     | Y          | N      |                    |
| `debug_getModifiedAccountsByHash`                                                     | Debug     | Y          | N      |                    |
...
| `eth_fillTransaction`                                                                 | Eth       | N          | N      | Not implemented    |
| `eth_getTransactionLogs`                                                              | Eth       | Y          | Y      | **Cosmos-specific**|
| `eth_getPendingTransactions`                                                          | Eth       | Y          | Y      | **Cosmos-specific**|
| `miner_start`                                                                         | Miner     | Y          | N      | Stub returns true  |
| `miner_stop`                                                                          | Miner     | Y          | N      | Stub returns true  |
| `miner_setEtherbase`                                                                  | Miner     | Y          | N      | Stub returns true  |
| `miner_setGasPrice`                                                                   | Miner     | Y          | N      | Stub returns true  |
| `miner_setGasLimit`                                                                   | Miner     | Y          | N      | Stub returns true  |
| `engine_newPayloadV1`                                                                 | Engine    | N          | N      | Post-merge API     |
| `engine_newPayloadV2`                                                                 | Engine    | N          | N      | Post-merge API     |
| `engine_newPayloadV3`                                                                 | Engine    | N          | N      | Post-merge API     |
| `engine_forkchoiceUpdatedV1`                                                          | Engine    | N          | N      | Post-merge API     |
| `engine_forkchoiceUpdatedV2`                                                          | Engine    | N          | N      | Post-merge API     |
| `engine_forkchoiceUpdatedV3`                                                          | Engine    | N          | N      | Post-merge API     |
| `engine_getPayloadV1`                                                                 | Engine    | N          | N      | Post-merge API     |
| `engine_getPayloadV2`                                                                 | Engine    | N          | N      | Post-merge API     |
| `engine_getPayloadV3`                                                                 | Engine    | N          | N      | Post-merge API     |
| `engine_exchangeCapabilities`                                                         | Engine    | N          | N      | Post-merge API     |
| `engine_exchangeTransitionConfigurationV1`                                            | Engine    | N          | N      | Post-merge API     |
| `engine_getPayloadBodiesByHashV1`                                                     | Engine    | N          | N      | Post-merge API     |
| `engine_getPayloadBodiesByHashV2`                                                     | Engine    | N          | N      | Post-merge API     |
| `engine_getPayloadBodiesByRangeV1`                                                    | Engine    | N          | N      | Post-merge API     |
| `engine_getPayloadBodiesByRangeV2`                                                    | Engine    | N          | N      | Post-merge API     |
| `engine_getBlobsV1`                                                                   | Engine    | N          | N      | EIP-4844           |
...
* `eth_resend` / `eth_pendingTransactions` - Transaction pool management
...
* `trace_*` methods - Advanced tracing functionality
...
```shell
// Request
curl -X POST --data '{"jsonrpc":"2.0","method":"eth_getPendingTransactions","params":[],"id":1}' -H "Content-Type: application/json" http://localhost:8545
// Result
{"jsonrpc":"2.0","id":1,"result":[]}
```
...
`ecRecover` returns the address associated with the private key that was used to calculate the signature in [`personal_sign`](https://www.google.com/search?q=%23personal-sign).

#### Parameters

  - Message
  - Signature returned from [`personal_sign`](https://www.google.com/search?q=%23personal-sign)
...
// Result
{"jsonrpc":"2.0","id":1,"result":[{"result":{"failed":false,"gas":21000,"returnValue":"0x","structLogs":[]}}]}
```
...
Returns pending and queued transactions from a specific address. This is useful for checking the status of transactions from a particular account.

#### Parameters (1)

1. **Address** - The address to get transactions from
   - Type: `DATA`, 20 bytes
...
```shell
curl -X POST --data '{"jsonrpc":"2.0","method":"txpool_contentFrom","params":["0x742d35Cc6634C0532925a3b844Bc9e7595f0bEb0"],"id":1}' -H "Content-Type: application/json" http://localhost:8545
```

Websocket

```shell
wscat -c ws://localhost:8546 -x '{"jsonrpc": "2.0", "id": 1, "method": "txpool_contentFrom", "params": ["0x742d35Cc6634C0532925a3b844Bc9e7595f0bEb0"]}'
```

Javascript Console

```javascript
txpool.contentFrom("0x742d35Cc6634C0532925a3b844Bc9e7595f0bEb0");
```
