...
| `@cosmjs/cosmwasm-stargate` | Client extensions for CosmWasm-enabled chains |
...
- **Query chain state** — balances, accounts, staking, governance, and arbitrary module queries via gRPC or RPC
