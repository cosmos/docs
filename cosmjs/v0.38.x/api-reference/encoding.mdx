...
| Function | Parameters | Returns |
|----------|------------|---------|
| `fixUint8Array` | `data: ArrayLike<number>` | `Uint8Array` |

Ensures a value is a proper `Uint8Array` instance, which is necessary in some cross-environment scenarios.
