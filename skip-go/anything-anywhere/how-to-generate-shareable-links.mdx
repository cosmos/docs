...
<Frame>![](/assets/skip-go/images/shareable-links.png)</Frame>
...
* To see supported chains, you can use [https://api.skip.build/v2/info/chains](https://api.skip.build/v2/info/chains) see [docs](/skip-go/api-reference/prod/info/get-v2infochains)
* To see supported assets, you can use [https://api.skip.build/v2/fungible/assets](https://api.skip.build/v2/fungible/assets) see [docs](/skip-go/api-reference/prod/fungible/get-v2fungibleassets)
