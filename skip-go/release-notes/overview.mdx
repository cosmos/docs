...
<CardGroup cols={3}>
  ...
  <Card title="Client Library" icon="code" href="/skip-go/release-notes/client" >
  ...
  <Card title="Widget" icon="bolt-lightning" href="/skip-go/release-notes/widget" >
    Seamless cross-chain bridging, swapping, and transferring functionality in an easy to integrate React or Web component
  </Card>
    <Card title="REST API" icon="sliders" href="/skip-go/release-notes/api">
