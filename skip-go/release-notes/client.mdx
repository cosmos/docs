...
## v0.9.0
- Add `/balance` methods query API endpoint. See the [documentation](../client/balance-gas-and-fee-tooling) and the [API reference](/skip-go/api-reference/prod/info/post-v2infobalances) for more details.