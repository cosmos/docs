...
<Info>
  Read more about [affiliate fees](/skip-go/general/affiliate-fees), [Smart Relay](/skip-go/general/smart-relay) and [EVM Swaps](/skip-go/advanced-swapping/smart-swap-options#feature-evm-swaps).
</Info>
