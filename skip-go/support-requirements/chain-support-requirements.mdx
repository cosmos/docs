...
Chain supported by the Skip API
  - Use the [`/info/chains` endpoint](/skip-go/api-reference/prod/info/get-v2infochains) to verify: `/v2/info/chains`
  - If not listed, follow the [Chain Support Requirements](/skip-go/support-requirements/chain-support-requirements)
