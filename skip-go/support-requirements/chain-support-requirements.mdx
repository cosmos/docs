...
* Once you've met the requirements below, submit an integration request through our [API Chain Integration Request Form](/skip-go/support-requirements/chain-integration-request)
 ...
 **This guide assumes using IBC for Interop**
 ...
 The Skip Go API supports other bridges and interop protocols in addition to IBC, including Hyperlane, CCTP, and Axelar. If you're using one of these, please get in contact with us on [our Discord](https://discord.com/invite/interchain), and we will help guide you through it to the extent we can.
...
Chain supported by the Skip API
  - Use the [`/info/chains` endpoint](../api-reference/prod/info/get-v2infochains) to verify: `/v2/info/chains`
  - If not listed, follow the [Chain Support Requirements](./chain-support-requirements)
