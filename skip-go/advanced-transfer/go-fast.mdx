...
Find integration details for Go Fast [here](/skip-go/client/advanced-features#use-the-go-fast-transfer-system).
</Info>
...
### dYdX Volume Limits
When transferring to dYdX via Go Fast, there is a $100,000 USD maximum transfer size.
...
For instructions on integrating Go Fast using the `@skip-go/client`, see the [Advanced Features guide](/skip-go/client/advanced-features#use-the-go-fast-transfer-system).

If you're using the Widget, refer to the [Widget Configuration](/skip-go/widget/configuration#routeconfig).
