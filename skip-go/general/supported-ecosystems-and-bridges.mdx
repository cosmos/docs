 ...
 **Activate Smart Relay (`smart_relay=true`) for global coverage of all chains, bridges, and routes**
 ...
 As a result, if you want your users to be able to transfer their tokens over all routes, we recommend using [Smart Relay](/skip-go/general/smart-relay).
</Info>
...
* CCTP (Move USDC to/from Cosmos, Ethereum/L2s and Solana)
  - Maximum transfer limit: 1,000,000 USDC per transfer
