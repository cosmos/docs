---
noindex: true
canonical: 'https://docs.cosmos.network/ibc/latest/intro'
...
If you are interested in using the canonical deployment of IBC v2, connecting Cosmos chains and Ethereum, take a look at the [IBC Eureka](/skip-go/eureka/eureka-overview) documentation to get started.
