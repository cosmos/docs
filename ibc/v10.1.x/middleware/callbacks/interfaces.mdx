---
noindex: true
canonical: 'https://docs.cosmos.network/ibc/latest/middleware/callbacks/interfaces'
title: Interfaces
---
...
/ This interfaces standardizes that behavior. Upon realization of the ability for middleware's to define their own packet data types, this interface will be deprecated and removed with time.
