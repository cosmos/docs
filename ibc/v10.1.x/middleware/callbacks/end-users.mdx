---
noindex: true
canonical: 'https://docs.cosmos.network/ibc/latest/middleware/callbacks/end-users'
title: End Users
description: >-
  This section explains how to use the callbacks middleware from the perspective
  of an IBC Actor. Callbacks middleware provides two types of callbacks:
---
