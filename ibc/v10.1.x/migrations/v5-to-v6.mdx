---
noindex: true
canonical: 'https://docs.cosmos.network/ibc/latest/migrations/v5-to-v6'
...
![auth-module-decision-tree.png](/ibc/images/04-migrations/images/auth-module-decision-tree.png)
