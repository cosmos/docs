---
noindex: true
canonical: 'https://docs.cosmos.network/ibc/latest/migrations/v1-to-v2'
...
/ may decide to return an error in the event of the proposed version being incompatible with its own
NegotiateAppVersion(
  ctx sdk.Context,
