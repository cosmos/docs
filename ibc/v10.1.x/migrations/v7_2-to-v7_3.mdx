---
noindex: true
canonical: 'https://docs.cosmos.network/ibc/latest/migrations/v7_2-to-v7_3'
title: IBC-Go v7.2 to v7.3
description: This guide provides instructions for migrating to version v7.3.0 of ibc-go.
---
