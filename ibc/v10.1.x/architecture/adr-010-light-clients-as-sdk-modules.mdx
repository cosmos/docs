---
noindex: true
canonical: 'https://docs.cosmos.network/ibc/latest/architecture/adr-010-light-clients-as-sdk-modules'
...
As described in [ADR 006](/ibc/v10.1.x/architecture/adr-006-02-client-refactor), generalizing light client behaviour is difficult.
