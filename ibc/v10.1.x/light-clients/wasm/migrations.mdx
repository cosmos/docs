...
Contract developers should familiarise themselves with the migration path offered by 08-wasm [here](/ibc/v10.1.x/light-clients/wasm/governance#migrating-an-existing-wasm-light-client-contract).
