---
noindex: true
canonical: 'https://docs.cosmos.network/ibc/latest/light-clients/wasm/concepts'
title: Concepts
description: >-
  Learn about the differences between a proxy light client and a Wasm light
  client.
---
...
- `storeProvider` encapsulates the IBC core store key and provides access to isolated prefix stores for each client so they can read and write in separate namespaces.
...
See section [`LightClientModule` of the light client module developer guide](/ibc/v10.1.x/light-clients/developer-guide/overview#lightclientmodule) for more information about the `LightClientModule` interface.
...
See section [`ClientState` of the light client module developer guide](/ibc/v10.1.x/light-clients/developer-guide/overview#clientstate) for more information about the `ClientState` interface.
...
See section [`ConsensusState` of the light client module developer guide](/ibc/v10.1.x/light-clients/developer-guide/overview#consensusstate) for more information about the `ConsensusState` interface.
...
See section [`ClientMessage` of the light client module developer guide](/ibc/v10.1.x/light-clients/developer-guide/overview#clientmessage) for more information about the `ClientMessage` interface.
