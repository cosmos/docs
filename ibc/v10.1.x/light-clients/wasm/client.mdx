---
noindex: true
canonical: 'https://docs.cosmos.network/ibc/latest/light-clients/wasm/client'
title: Client
description: >-
  A user can query and interact with the 08-wasm module using the CLI. Use the
  --help flag to discover the available commands:
---
...
```shell
simd query ibc-wasm code [checksum]
```
