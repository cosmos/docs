---
noindex: true
canonical: 'https://docs.cosmos.network/ibc/latest/light-clients/solomachine/state_transitions'
title: State Transitions
description: 'Successful state verification by a solo machine light client will result in:'
---
...
* the diversifier being updated to the new diversifier provided by the header.
...
Client upgrades are not supported for the solo machine light client. No state transition occurs.
