---
noindex: true
canonical: 'https://docs.cosmos.network/ibc/latest/light-clients/localhost/state-verification'
title: State Verification
description: >-
  The localhost client handles state verification through the LightClientModule
  interface methods VerifyMembership and VerifyNonMembership by performing
  read-only operations directly on the core IBC store.
---
