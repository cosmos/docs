---
noindex: true
canonical: 'https://docs.cosmos.network/ibc/latest/light-clients/localhost/integration'
title: Integration
description: >-
  The 09-localhost light client module registers codec types within the core IBC
  module. This differs from other light client module implementations which are
  expected to register codec types using the AppModuleBasic interface.
---
