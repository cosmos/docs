---
noindex: true
canonical: 'https://docs.cosmos.network/ibc/latest/spec/app/ics-020-fungible-token-transfer/deprecated/README'
ics: 20
...
![Forwarding success case](/ibc/v10.1.x/spec/app/ics-020-fungible-token-transfer/deprecated/forwarding-3-chains-success.png)

![Forwarding failure case](/ibc/v10.1.x/spec/app/ics-020-fungible-token-transfer/deprecated/forwarding-3-chains-failure.png)
