...
For more details on the Payload structure, see [ICS-04](core/ics-004-packet-semantics/PACKET).
...
For a detailed specification of the packet flow, please refer to [ICS-04](core/ics-004-packet-semantics/PACKET_HANDLER).
