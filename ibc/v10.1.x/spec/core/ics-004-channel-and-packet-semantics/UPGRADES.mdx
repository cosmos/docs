---
noindex: true
canonical: 'https://docs.cosmos.network/ibc/latest/spec/core/ics-004-channel-and-packet-semantics/UPGRADES'
...
![Channel Upgrade Flow](/ibc/v10.1.x/spec/core/ics-004-channel-and-packet-semantics/channel-upgrade-flow.png)
