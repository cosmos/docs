---
noindex: true
canonical: 'https://docs.cosmos.network/ibc/latest/spec/core/ics-004-channel-and-packet-semantics/README'
ics: 4
...
![Dataflow Visualisation](/ibc/v10.1.x/spec/core/ics-004-channel-and-packet-semantics/dataflow.png)
...
![Channel State Machine](/ibc/v10.1.x/spec/core/ics-004-channel-and-packet-semantics/channel-state-machine.png)
...
![Packet State Machine](/ibc/v10.1.x/spec/core/ics-004-channel-and-packet-semantics/packet-state-machine.png)
...
![Packet Transit](/ibc/v10.1.x/spec/core/ics-004-channel-and-packet-semantics/packet-transit.png)
