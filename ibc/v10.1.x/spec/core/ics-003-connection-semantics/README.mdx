---
noindex: true
canonical: 'https://docs.cosmos.network/ibc/latest/spec/core/ics-003-connection-semantics/README'
ics: 3
...
![State Machine Diagram](/ibc/v10.1.x/spec/core/ics-003-connection-semantics/state.png)
