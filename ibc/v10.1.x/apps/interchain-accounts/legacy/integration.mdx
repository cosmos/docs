---
noindex: true
canonical: 'https://docs.cosmos.network/ibc/latest/apps/interchain-accounts/legacy/integration'
title: Integration
...
![ica-pre-v6.png](/ibc/images/02-apps/02-interchain-accounts/10-legacy/images/ica-pre-v6.png)
...
func initParamsKeeper(appCodec codec.BinaryCodec, legacyAmino *codec.LegacyAmino, key, tkey sdk.StoreKey)
...
Alternatively, submodules can be enabled and disabled dynamically using [on-chain parameters](/ibc/v10.1.x/apps/interchain-accounts/parameters).
