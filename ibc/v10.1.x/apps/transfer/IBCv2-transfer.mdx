---
noindex: true
canonical: 'https://docs.cosmos.network/ibc/latest/apps/transfer/IBCv2-transfer'
title: IBC v2 Transfer
description: >-
  Much of the core business logic of sending and recieving tokens between chains
  is unchanged between IBC Classic and IBC v2. Some of the key differences to
  pay attention to are detailed below.
---
...
Instead of implementing token transfer for `port.IBCModule`, IBC v2 uses the new application interface `api.IBCModule`. More information on the interface differences can be found in the [application section](/ibc/v10.1.x/ibc/apps/ibcv2apps).
