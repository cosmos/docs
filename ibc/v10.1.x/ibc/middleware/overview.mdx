...
- [documentation on ./developing custom middleware](/ibc/v10.1.x/ibc/middleware/develop)
- [documentation on integrating middleware into a stack on a chain](/ibc/v10.1.x/ibc/middleware/integration)
...
- [IBC Integration](/ibc/v10.1.x/ibc/./integration)
- [IBC Application Developer Guide](/ibc/v10.1.x/ibc/apps/apps)
...
- **The order of the middleware matters** (more on how to correctly define your stack in the code will follow in the [./integration section](/ibc/v10.1.x/ibc/middleware/integration)).
