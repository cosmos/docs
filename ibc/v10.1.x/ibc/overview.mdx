---
noindex: true
canonical: 'https://docs.cosmos.network/ibc/latest/ibc/overview'
title: Overview
---
...
- the [IBC module callback `OnChanCloseInit`](/ibc/v10.1.x/ibc/apps/ibcmodule#channel-closing-callbacks) returns `nil`.
...
- the [IBC module callback `OnChanCloseConfirm`](/ibc/v10.1.x/ibc/apps/ibcmodule#channel-closing-callbacks) returns `nil`.
