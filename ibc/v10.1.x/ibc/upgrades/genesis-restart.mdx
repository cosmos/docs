---
noindex: true
canonical: 'https://docs.cosmos.network/ibc/latest/ibc/upgrades/genesis-restart'
...
These steps are identical to the regular [IBC client breaking upgrade process](/ibc/v10.1.x/ibc/upgrades/quick-guide#step-by-step-upgrade-process-for-relayers-upgrading-counterparty-clients).
