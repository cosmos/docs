---
noindex: true
canonical: 'https://docs.cosmos.network/ibc/latest/architecture/adr-027-ibc-wasm'
...
a [governance v1 proposal](/sdk/latest/modules/gov/README#proposals) that contains the `sdk.Msg` for storing 
