...
With both light clients created and their IDs written to state, the next step configures and starts the relayer and Proof API. Because both client IDs are known at this point, the relayer config is rendered complete in a single pass.
