---
noindex: true
canonical: 'https://docs.cosmos.network/ibc/latest/apps/transfer/metrics'
title: Metrics
description: The IBC transfer application module exposes the following set of metrics.
---

The IBC transfer application module exposes the following set of [metrics](/sdk/latest/guides/testing/telemetry).
