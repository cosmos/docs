---
noindex: true
canonical: 'https://docs.cosmos.network/ibc/latest/apps/interchain-accounts/messages'
title: Messages
description: >-
  An Interchain Accounts channel handshake can be initiated using
...
bz, err := icatypes.SerializeCosmosTx(cdc, []proto.Message{
    queryMsg
