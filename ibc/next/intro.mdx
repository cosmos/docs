...
For a detailed understanding of the protocol design, refer to the [IBC v2 specification.](https://github.com/cosmos/ibc/tree/main/spec/IBC_V2) For a high-level introduction, see the [IBC v2 announcement blog post.](https://ibcprotocol.dev/blog/ibc-v2-announcement) If you are interested in using IBC v2 to connect Cosmos chains and Ethereum, take a look at the [IBC Eureka](/skip-go/eureka/eureka-overview) documentation.
