---
title: "RelayerOverview"
description: "Configure and run the IBC v2 relayer"
---

The IBC v2 Relayer is a relaying service for the IBC v2 Protocol. The relayer supports interoperating between a Cosmos-based chain and major EVM networks.

## Relaying Sequence

![Relaying Sequence](/ibc/images/diagrams/relaying-sequence.png)
...
![Design](/ibc/images/diagrams/relayer-design.png)
...
The IBC v2 Relayer is released under a [Source Available Evaluation License](https://github.com/cosmos/ibc-relayer/blob/main/LICENSE). If you would like to use the relayer in a production environment, please contact [Cosmos Labs](mailto:sales@cosmoslabs.io).
