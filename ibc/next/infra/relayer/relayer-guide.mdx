...
This page covers the configuration and operation of the IBC v2 Relayer. For more information on the IBC v2 Relayer, see the [IBC v2 Relayer overview](/ibc/next/infra/relayer/overview) or the [IBC v2 Relayer repository](https://github.com/cosmos/ibc-relayer). 
