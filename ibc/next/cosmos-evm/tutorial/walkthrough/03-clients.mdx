---
title: "Step 3: Create Attestation Light Clients"
description: "Create attestation light clients on each chain and register their counterparties"
---
...
Both light clients are initialized with the attestor's Ethereum address. The script first ensures the keystore exists — generating a new one if not — then reads the address from it:
