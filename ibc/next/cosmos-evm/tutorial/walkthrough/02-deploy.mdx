...
{/* dennis serdar todo: Please fill in this section with considerations on deploying solditiy contracts on a cosmos EVM chain. What is different? what should be considered? does it make the other steps after this different? What do devs need to know about a connection between 2 chains using only ibc solidity contracts? */}
