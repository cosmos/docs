...
- [IBC Overview](/ibc/next/ibc/overview)
...
The methods which make up this interface are detailed at a more granular level in the [`LightClientModule` section of this guide](/ibc/next/light-clients/developer-guide/light-client-module).
...
The methods which make up this interface are detailed at a more granular level in the [`ClientState` section of this guide](/ibc/next/light-clients/developer-guide/client-state).
...
The methods which make up this interface are detailed at a more granular level in the [`ConsensusState` section of this guide](/ibc/next/light-clients/developer-guide/consensus-state).
...
Learn more in the [Handling update and misbehaviour](/ibc/next/light-clients/developer-guide/updates-and-misbehaviour) section.
