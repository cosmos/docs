...
For a working end-to-end example of how the light client is deployed and configured, see the [Create Attestation Light Clients](/ibc/next/cosmos-evm/tutorial/walkthrough/03-clients) page in the walkthrough of the IBC demo tutorial.
