---
noindex: true
canonical: 'https://docs.cosmos.network/ibc/latest/light-clients/wasm/messages'
title: Messages
description: >-
  Uploading the Wasm light client contract to the Wasm VM storage is achieved by
  means of MsgStoreCode:
---
