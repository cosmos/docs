---
noindex: true
canonical: 'https://docs.cosmos.network/ibc/latest/migrations/v7-to-v7_1'
title: IBC-Go v7 to v7.1
description: This guide provides instructions for migrating to version v7.1.0 of ibc-go.
---
