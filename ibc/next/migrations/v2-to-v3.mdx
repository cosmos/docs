...
For ICS27 it is also necessary to [manually add store upgrades](/sdk/latest/guides/upgrades/upgrade#add-storeupgrades-for-new-modules) for the new ICS27 module and then configure the store loader to apply those upgrades in `app.go`:
