---
noindex: true
canonical: 'https://docs.cosmos.network/ibc/latest/migrations/support-stackbuilder'
title: >-
  Support the new StackBuilder primitive for Wiring Middlewares in the chain
  application
---
...
Refer to the [integration guide](/ibc/next/ibc/middleware/integration) to understand how to use this new middleware to improve middleware wiring in the chain application setup.
