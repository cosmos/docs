...
![Forwarding success case](/ibc/next/spec/app/ics-020-fungible-token-transfer/deprecated/forwarding-3-chains-success.png)

![Forwarding failure case](/ibc/next/spec/app/ics-020-fungible-token-transfer/deprecated/forwarding-3-chains-failure.png)
