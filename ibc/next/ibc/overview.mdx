...
- the [IBC module callback `OnChanCloseInit`](/ibc/next/ibc/apps/ibcmodule#channel-closing-callbacks) returns `nil`.
...
- the [IBC module callback `OnChanCloseConfirm`](/ibc/next/ibc/apps/ibcmodule#channel-closing-callbacks) returns `nil`.
