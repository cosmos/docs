...
More information on implementing the IBCModule Keepers can be found in the [keepers section](/ibc/next/ibc/apps/keeper)
...
More information on implementing the IBC Router can be found in the [routing section](/ibc/next/ibc/apps/routing).
