...
- [documentation on developing custom middleware](/ibc/next/ibc/middleware/develop)
- [documentation on integrating middleware into a stack on a chain](/ibc/next/ibc/middleware/integration)
...
- [IBC Integration](/ibc/next/ibc/integration)
- [IBC Application Developer Guide](/ibc/next/ibc/apps/apps)
...
- **The order of the middleware matters** (more on how to correctly define your stack in the code will follow in the [integration section](/ibc/next/ibc/middleware/integration)).
