...
These steps are identical to the regular [IBC client breaking upgrade process](/ibc/next/ibc/upgrades/quick-guide#step-by-step-upgrade-process-for-relayers-upgrading-counterparty-clients).
