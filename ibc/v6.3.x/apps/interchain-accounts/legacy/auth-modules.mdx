---
noindex: true
canonical: 'https://docs.cosmos.network/ibc/latest/apps/interchain-accounts/legacy/auth-modules'
title: Authentication Modules
description: This document is deprecated and will be removed in future releases.
---
...
To integrate the authentication module into your chain, please follow the steps outlined in [`app.go` integration](/ibc/v6.3.x/apps/interchain-accounts/legacy/integration#example-integration).
