...
- [IBC Overview](/ibc/v4.6.x/ibc/overview)
- [IBC default integration](/ibc/v4.6.x/ibc/integration)

</Note>

## Channel handshake callbacks

This section will describe the callbacks that are called during channel handshake execution. Among other things, it will claim channel capabilities passed on from core IBC. For a refresher on capabilities, check [the Overview section](/ibc/v4.6.x/ibc/overview#capabilities).
