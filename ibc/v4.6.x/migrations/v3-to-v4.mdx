---
noindex: true
canonical: 'https://docs.cosmos.network/ibc/latest/migrations/v3-to-v4'
...
Please read the Fee Middleware [integration documentation](/ibc/v4.6.x/middleware/ics29-fee/integration) for an in depth guide on how to configure the module correctly in order to incentivize IBC packets.
