...
- [IBC middleware development](/ibc/v4.6.x/ibc/middleware/develop)
- [IBC middleware integration](/ibc/v4.6.x/ibc/middleware/integration)
...
As mentioned in [IBC middleware development](/ibc/v4.6.x/ibc/middleware/develop) an application stack may be composed of many or no middlewares that nest a base application.
