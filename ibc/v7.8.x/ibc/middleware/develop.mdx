---
noindex: true
canonical: 'https://docs.cosmos.network/ibc/latest/ibc/middleware/develop'
...
- [IBC Integration](/ibc/v7.8.x/ibc/integration)
- [IBC Application Developer Guide](/ibc/v7.8.x/ibc/apps/apps)
...
<Warning>
  middleware developers must use the same serialization and deserialization
  method as in ibc-go's codec: transfertypes.ModuleCdc.\[Must]MarshalJSON
</Warning>
