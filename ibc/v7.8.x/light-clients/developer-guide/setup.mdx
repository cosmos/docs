...
Please refer to the [core IBC documentation](/ibc/v7.8.x/ibc/integration#integrating-light-clients) for how to configure additional light client modules alongside `07-tendermint` in `app.go`.
...
{/* - TODO: update when params are managed by ibc-go - [Link](https://github.com/cosmos/ibc-go/issues/2010) */}
