---
noindex: true
canonical: 'https://docs.cosmos.network/ibc/latest/light-clients/developer-guide/client-state'
title: Client State interface
description: >-
  Learn how to implement the ClientState interface. This list of methods
  described here does not include all methods of the interface. Some methods are
  explained in detail in the relevant sections of the guide.
---
...
For more information about client upgrades see the [Handling upgrades](/ibc/v7.8.x/light-clients/developer-guide/upgrades) section.
...
see the [Existence and non-existence proofs section](/ibc/v7.8.x/light-clients/developer-guide/proofs).
