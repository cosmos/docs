---
noindex: true
canonical: 'https://docs.cosmos.network/ibc/latest/migrations/v4-to-v5'
...
See [ADR-03](https://github.com/cosmos/ibc-go/blob/main/docs/architecture/adr-003-ics27-acknowledgement.md#next-major-version-format) for more information or the [corresponding documentation about authentication modules](/ibc/v7.8.x/apps/interchain-accounts/auth-modules#onacknowledgementpacket).
