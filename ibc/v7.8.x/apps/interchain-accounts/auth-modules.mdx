...
To integrate the authentication module into your chain, please follow the steps outlined in [`app.go` integration](/ibc/v7.8.x/apps/interchain-accounts/integration#example-integration).
