---
noindex: true
canonical: 'https://docs.cosmos.network/ibc/latest/ibc/apps/ibcmodule'
...
- [IBC Overview](/ibc/v5.4.x/ibc/overview)
- [IBC default integration](/ibc/v5.4.x/middleware/ics29-fee/integration)

</Note>

## Channel handshake callbacks

This section will describe the callbacks that are called during channel handshake execution. Among other things, it will claim channel capabilities passed on from core IBC. For a refresher on capabilities, check [the Overview section](/ibc/v5.4.x/ibc/overview#capabilities).
...
![IBC packet flow diagram](/ibc/images/01-ibc/03-apps/images/packet_flow.png)
