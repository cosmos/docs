...
These steps are identical to the regular [IBC client breaking upgrade process](/ibc/v5.4.x/ibc/upgrades/quick-guide#step-by-step-upgrade-process-for-relayers-upgrading-counterparty-clients).
