...
Please refer to the [core IBC documentation](/ibc/latest/ibc/integration#integrating-light-clients) for how to configure additional light client modules alongside `07-tendermint` in `app.go`.
