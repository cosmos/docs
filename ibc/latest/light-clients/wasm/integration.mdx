...
Or alternatively the parameter can be updated via a governance proposal (see at the bottom of section [`Creating clients`](/ibc/latest/light-clients/developer-guide/setup#creating-clients) for an example of how to do this).
