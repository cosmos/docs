...
Contract developers should familiarise themselves with the migration path offered by 08-wasm [here](/ibc/latest/light-clients/wasm/governance#migrating-an-existing-wasm-light-client-contract).
