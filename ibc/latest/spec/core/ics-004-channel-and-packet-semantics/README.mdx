...
![Dataflow Visualisation](/ibc/latest/spec/core/ics-004-channel-and-packet-semantics/dataflow.png)
...
![Channel State Machine](/ibc/latest/spec/core/ics-004-channel-and-packet-semantics/channel-state-machine.png)
...
![Packet State Machine](/ibc/latest/spec/core/ics-004-channel-and-packet-semantics/packet-state-machine.png)
...
![Packet Transit](/ibc/latest/spec/core/ics-004-channel-and-packet-semantics/packet-transit.png)
