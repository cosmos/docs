...
![proof_generation.png](/ibc/latest/spec/core/ics-033-multi-hop/proof_generation.png)
Graphical depiction of proof generation.

![relayer_calc_update_heights.png](/ibc/latest/spec/core/ics-033-multi-hop/relayer_calc_update_heights.png)
...
![relayer_query_proof_and_submit.png](/ibc/latest/spec/core/ics-033-multi-hop/relayer_query_proof_and_submit.png)
...
![proof_query_algorithm.png](/ibc/latest/spec/core/ics-033-multi-hop/proof_query_algorithm.png)
Multi-hop proof query algorithm.

![proof_verification.png](/ibc/latest/spec/core/ics-033-multi-hop/proof_verification.png)
