...
To integrate the authentication module into your chain, please follow the steps outlined in [`app.go` integration](/ibc/latest/apps/interchain-accounts/integration#example-integration).
