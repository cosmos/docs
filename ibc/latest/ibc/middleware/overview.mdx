...
- [documentation on developing custom middleware](/ibc/latest/ibc/middleware/develop)
- [documentation on integrating middleware into a stack on a chain](/ibc/latest/ibc/middleware/integration)
...
- [IBC Integration](/ibc/latest/ibc/integration)
- [IBC Application Developer Guide](/ibc/latest/ibc/apps/apps)
...
- **The order of the middleware matters** (more on how to correctly define your stack in the code will follow in the [integration section](/ibc/latest/ibc/middleware/integration)).
