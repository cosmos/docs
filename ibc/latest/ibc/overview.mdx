...
- the [IBC module callback `OnChanCloseInit`](/ibc/latest/ibc/apps/ibcmodule#channel-closing-callbacks) returns `nil`.
...
- the [IBC module callback `OnChanCloseConfirm`](/ibc/latest/ibc/apps/ibcmodule#channel-closing-callbacks) returns `nil`.
