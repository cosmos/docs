...
More information on implementing the IBCModule Keepers can be found in the [keepers section](/ibc/latest/ibc/apps/keeper)
...
More information on implementing the IBC Router can be found in the [routing section](/ibc/latest/ibc/apps/routing).
