...
See section [`ClientState` of the light client module developer guide](/ibc/v8.5.x/light-clients/developer-guide/overview#clientstate) for more information about the `ClientState` interface.
...
See section [`ConsensusState` of the light client module developer guide](/ibc/v8.5.x/light-clients/developer-guide/overview#consensusstate) for more information about the `ConsensusState` interface.
...
See section [`ClientMessage` of the light client module developer guide](/ibc/v8.5.x/light-clients/developer-guide/overview#clientmessage) for more information about the `ClientMessage` interface.
