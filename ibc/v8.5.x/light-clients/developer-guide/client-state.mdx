...
For more information about client upgrades see the [Handling upgrades](/ibc/v8.5.x/light-clients/developer-guide/upgrades) section.
...
see the [Existence and non-existence proofs section](/ibc/v8.5.x/light-clients/developer-guide/proofs).
