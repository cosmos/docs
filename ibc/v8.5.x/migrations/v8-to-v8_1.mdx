---
noindex: true
canonical: 'https://docs.cosmos.network/ibc/latest/migrations/v8-to-v8_1'
title: IBC-Go v8 to v8.1
description: This guide provides instructions for migrating to version v8.1.0 of ibc-go.
---
