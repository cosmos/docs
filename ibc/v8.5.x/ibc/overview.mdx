...
- the [IBC module callback `OnChanCloseInit`](/ibc/v8.5.x/ibc/apps/ibcmodule#channel-closing-callbacks) returns `nil`.
...
- the [IBC module callback `OnChanCloseConfirm`](/ibc/v8.5.x/ibc/apps/ibcmodule#channel-closing-callbacks) returns `nil`.
