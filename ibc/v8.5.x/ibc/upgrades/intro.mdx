...
1. The [quick-guide](/ibc/v8.5.x/ibc/upgrades/quick-guide) describes how IBC-connected chains can perform client-breaking upgrades and how relayers can securely upgrade counterparty clients using the SDK.
2. The [developer-guide](/ibc/v8.5.x/ibc/upgrades/developer-guide) is a guide for developers intending to develop IBC client implementations with upgrade functionality.
