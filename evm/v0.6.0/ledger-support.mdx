---
noindex: true
canonical: 'https://docs.cosmos.network/evm/latest/ledger-support'
title: "Ledger Support"
description: "EIP-712 signing for Cosmos transactions using the Ethereum Ledger app"
---
...
- [EIP Compatibility](/evm/v0.6.0/documentation/evm-compatibility)
