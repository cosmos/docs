---
noindex: true
canonical: 'https://docs.cosmos.network/evm/latest/documentation/smart-contracts/precompiles/staking'
title: "Staking"
...
**Related Module**: [x/staking](/sdk/latest/modules/staking/README)
