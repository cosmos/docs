---
noindex: true
canonical: 'https://docs.cosmos.network/evm/latest/documentation/smart-contracts/precompiles/ics20'
title: "ICS20"
...
**Related Module**: [x/ibc-transfer](/ibc/latest/apps/transfer/overview)
...
<Info>
For detailed callback implementation, see [IBC Module](/evm/v0.6.0/documentation/cosmos-sdk/modules/ibc) and [Callbacks Interface](/evm/v0.6.0/documentation/smart-contracts/precompiles/callbacks).
</Info>
