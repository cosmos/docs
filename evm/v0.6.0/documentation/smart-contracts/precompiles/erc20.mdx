---
noindex: true
canonical: 'https://docs.cosmos.network/evm/latest/documentation/smart-contracts/precompiles/erc20'
title: "ERC20"
description: "Standard ERC20 token functionality for native Cosmos tokens"
icon: "refresh-cw"
keywords: ['erc20', 'token', 'precompile', 'cosmos sdk', 'native token', 'token pair', 'fungible token', 'allowance', 'transfer', 'approve', 'balance', 'total supply', 'decimals', 'token standard']
---
...
**Related Module**: [x/erc20](/evm/v0.6.0/documentation/cosmos-sdk/modules/erc20)
