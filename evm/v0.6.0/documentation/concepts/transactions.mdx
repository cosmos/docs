---
noindex: true
canonical: 'https://docs.cosmos.network/evm/latest/documentation/concepts/transactions'
title: "Transactions"
...
<Note>
For detailed transaction flow and mempool behavior, see [Mempool documentation](/evm/v0.6.0/documentation/concepts/mempool#transaction-flow) and [Cosmos SDK lifecycle](/sdk/latest/learn/concepts/lifecycle).
</Note>
...
<Info>
For detailed mempool behavior, see [Mempool Architecture](/evm/v0.6.0/documentation/concepts/mempool#architecture).
</Info>
...
- [Mempool](/evm/v0.6.0/documentation/concepts/mempool) - Transaction flow and mempool architecture
- [Gas and Fees](/evm/v0.6.0/documentation/concepts/gas-and-fees) - Fee calculation and gas metering
- [Accounts](/evm/v0.6.0/documentation/concepts/accounts) - Account structure and addressing
- [x/vm Module](/evm/v0.6.0/documentation/cosmos-sdk/modules/vm) - EVM implementation details
