---
noindex: true
canonical: 'https://docs.cosmos.network/evm/latest/documentation/concepts/replay-protection'
...
As documented in the [Chain ID](/evm/v0.6.0/documentation/concepts/chain-id) page, Cosmos EVM uses:
...
- [Chain ID Configuration](/evm/v0.6.0/documentation/concepts/chain-id)
- [Transaction Types](/evm/v0.6.0/documentation/concepts/transactions#ethereum-tx-type)
- [EVM Module Parameters](/evm/v0.6.0/documentation/cosmos-sdk/modules/vm#parameters)