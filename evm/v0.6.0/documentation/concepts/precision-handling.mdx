---
noindex: true
canonical: 'https://docs.cosmos.network/evm/latest/documentation/concepts/precision-handling'
...
The [PreciseBank module](/evm/v0.6.0/documentation/cosmos-sdk/modules/precisebank) solves this by decomposing balances into integer and fractional components:
...
- [PreciseBank Module Reference](/evm/v0.6.0/documentation/cosmos-sdk/modules/precisebank) - Full implementation details
- [VM Module Configuration](/evm/v0.6.0/documentation/cosmos-sdk/modules/vm) - Extended denomination setup
