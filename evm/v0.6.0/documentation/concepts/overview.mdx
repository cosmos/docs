---
noindex: true
canonical: 'https://docs.cosmos.network/evm/latest/documentation/concepts/overview'
title: "Overview"
...
For detailed technical implementation, see individual concept pages for [transactions](/evm/v0.6.0/documentation/concepts/transactions), [accounts](/evm/v0.6.0/documentation/concepts/accounts), [gas and fees](/evm/v0.6.0/documentation/concepts/gas-and-fees), and [precompiles](/evm/v0.6.0/documentation/smart-contracts/precompiles).
