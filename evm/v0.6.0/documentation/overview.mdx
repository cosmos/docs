---
noindex: true
canonical: 'https://docs.cosmos.network/evm/latest/documentation/overview'
title: "Overview"
---
...
<CardGroup cols={2}>
  <Card title="Getting Started" icon="book-open" href="/evm/v0.6.0/documentation/getting-started">
  ...
  <Card title="Ethereum Tooling & JSON-RPC" icon={<EthereumOutlineIcon />} href="/evm/v0.6.0/documentation/evm-compatibility">
    Deploy existing Solidity contracts and use MetaMask, Hardhat, Foundry, Remix, ethers.js, viem, and more
  </Card>
  <Card title="Cosmos-Native Capabilities" icon={<CosmosOutlineIcon />} href="/evm/v0.6.0/documentation/smart-contracts/precompiles/overview">
...
- **Native cross-chain:** Rather than relying on external bridge contracts, Cosmos EVM has [IBC (Inter-Blockchain Communication)](/evm/v0.6.0/documentation/concepts/ibc) built into the protocol. Cross-chain token transfers are a first-class feature, accessible from Solidity via the [IBC precompile](/evm/v0.6.0/documentation/smart-contracts/precompiles/ics20).
- **Precompiles:** Cosmos EVM exposes protocol-level functionality as precompiled contracts at fixed addresses. From Solidity, you can call into staking, distribution, governance, bank, IBC transfers (ICS-20), slashing, vesting, and address conversion utilities the same way you'd call any other contract. See the [precompiles reference](/evm/v0.6.0/documentation/smart-contracts/precompiles/overview) for the full list of addresses and interfaces.
...
The quickest way to get started is [running the example chain locally](/evm/v0.6.0/documentation/getting-started)— it takes less than 3 minutes and requires only Go and Make.
