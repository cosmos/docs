---
noindex: true
canonical: 'https://docs.cosmos.network/evm/latest/documentation/getting-started/build-a-chain/overview'
title: "Introduction"
---
...
<div style={{maxWidth: '600px'}}>
<Card title="Predeployed Contracts" href="/evm/v0.6.0/documentation/getting-started/build-a-chain/additional-configuration/predeployed-contracts">
