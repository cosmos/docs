---
noindex: true
canonical: 'https://docs.cosmos.network/evm/latest/documentation/cosmos-sdk/modules/vm'
title: "VM"
description: "Core EVM implementation for Ethereum compatibility on Cosmos chains"
---
...
**Related Configuration**: Requires [PreciseBank Module](/evm/v0.6.0/documentation/cosmos-sdk/modules/precisebank) to be included in app.go
...
- [Building Your Chain Guide](/evm/v0.6.0/documentation/getting-started/build-a-chain/overview) - Main configuration walkthrough
- [Fee Market Module](/evm/v0.6.0/documentation/cosmos-sdk/modules/feemarket) - EIP-1559 fee configuration
