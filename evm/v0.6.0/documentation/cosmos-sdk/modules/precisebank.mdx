---
noindex: true
canonical: 'https://docs.cosmos.network/evm/latest/documentation/cosmos-sdk/modules/precisebank'
title: "PreciseBank"
description: "High-precision bank module for 18-decimal EVM token accounting"
---
...
- [VM Module](/evm/v0.6.0/documentation/cosmos-sdk/modules/vm) - extended_denom_options setup
- [ERC20 Module](/evm/v0.6.0/documentation/cosmos-sdk/modules/erc20) - Token pair configuration
