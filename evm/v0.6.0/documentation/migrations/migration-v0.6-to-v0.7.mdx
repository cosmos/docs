...
If you're skipping a release, read the [v0.5.x → v0.6.0 guide](/evm/v0.6.0/documentation/migrations/migration-v0.5-to-v0.6) first — its StateDB / `callFromPrecompile` API break still applies.
