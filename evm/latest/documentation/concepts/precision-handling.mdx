...
The [PreciseBank module](/evm/latest/documentation/cosmos-sdk/modules/precisebank) solves this by decomposing balances into integer and fractional components:
...
- [PreciseBank Module Reference](/evm/latest/documentation/cosmos-sdk/modules/precisebank) - Full implementation details
- [VM Module Configuration](/evm/latest/documentation/cosmos-sdk/modules/vm) - Extended denomination setup
