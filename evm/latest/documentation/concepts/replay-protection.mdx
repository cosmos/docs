...
As documented in the [Chain ID](/evm/latest/documentation/concepts/chain-id) page, Cosmos EVM uses:
...
- [Chain ID Configuration](/evm/latest/documentation/concepts/chain-id)
- [Transaction Types](/evm/latest/documentation/concepts/transactions#ethereum-tx-type)
- [EVM Module Parameters](/evm/latest/documentation/cosmos-sdk/modules/vm#parameters)