...
<Info>
For detailed callback implementation, see [IBC Module](/evm/latest/documentation/cosmos-sdk/modules/ibc) and [Callbacks Interface](/evm/latest/documentation/smart-contracts/precompiles/callbacks).
</Info>
