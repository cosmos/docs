...
<Info>
  This page tracks releases and changes for Cosmos EVM. For the full release history, see the [CHANGELOG](https://github.com/cosmos/evm/blob/main/CHANGELOG.md) on GitHub.
</Info>

<Update label="Release" description="Latest" tags={["EVM", "Release"]}>
### IMPROVEMENTS
