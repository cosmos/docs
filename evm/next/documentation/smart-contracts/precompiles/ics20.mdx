...
<Info>
For detailed callback implementation, see [IBC Module](/evm/next/documentation/cosmos-sdk/modules/ibc) and [Callbacks Interface](/evm/next/documentation/smart-contracts/precompiles/callbacks).
</Info>
