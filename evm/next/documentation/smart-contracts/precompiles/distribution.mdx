---
noindex: true
canonical: 'https://docs.cosmos.network/evm/latest/documentation/smart-contracts/precompiles/distribution'
title: "Distribution"
...
**Related Module**: [x/distribution](/sdk/v0.53/build/modules/distribution)
