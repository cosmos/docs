---
noindex: true
canonical: 'https://docs.cosmos.network/evm/latest/documentation/smart-contracts/precompiles/slashing'
title: "Slashing"
...
**Related Module**: [x/slashing](/sdk/latest/modules/slashing/README)
