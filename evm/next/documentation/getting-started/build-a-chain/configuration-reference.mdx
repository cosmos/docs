...
<Info>
For step-by-step configuration guides, see [Pre-Genesis & Genesis Setup](/evm/v0.5.0/documentation/getting-started/build-a-chain/quick-start) and [Runtime Configuration & Launch](/evm/v0.5.0/documentation/getting-started/network-operators/node-configuration).
</Info>
...
<CardGroup cols={3}>
<Card title="Pre-Genesis Setup" icon="file-code" href="/evm/v0.5.0/documentation/getting-started/build-a-chain/quick-start">
Configuration guide
</Card>

<Card title="Runtime & Launch" icon="rocket" href="/evm/v0.5.0/documentation/getting-started/network-operators/node-configuration">
Launch procedures
</Card>
...
<Card title="FeeMarket Module" icon="chart-line" href="/evm/v0.5.0/documentation/cosmos-sdk/modules/feemarket">
Fee market docs
</Card>

<Card title="ERC20 Module" icon="arrows-left-right" href="/evm/v0.5.0/documentation/cosmos-sdk/modules/erc20">
ERC20 module docs
</Card>

<Card title="PreciseBank Module" icon="scale-balanced" href="/evm/v0.5.0/documentation/cosmos-sdk/modules/precisebank">
Precision handling
</Card>
</CardGroup>
