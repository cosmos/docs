...
- [Pre-Genesis & Genesis Setup](/evm/v0.5.0/documentation/getting-started/build-a-chain/quick-start) - Initial configuration and genesis preparation
...
<Info>
**Advanced Mempool Configuration**: For detailed information on integrating the EVM mempool, see the [EVM Mempool Integration](/evm/v0.5.0/documentation/getting-started/build-a-chain/additional-configuration/mempool-integration) guide.
</Info>
...
**Further resources:**
- [Configuration Reference](/evm/v0.5.0/documentation/getting-started/build-a-chain/quick-start) - Complete command reference and examples
- [VM Module Documentation](/evm/v0.5.0/documentation/cosmos-sdk/modules/vm) - EVM configuration details
