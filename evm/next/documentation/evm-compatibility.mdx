...
<CardGroup cols={2}>
  <Card title="Precompile Overview" icon="cube" href="/evm/next/documentation/smart-contracts/precompiles/overview">
...
All standard Ethereum cryptographic precompiles (ecrecover, sha256, etc.) are also supported — see [evm.codes/precompiled](https://www.evm.codes/precompiled) for the full reference.
...
<Card title="Predeployed Contracts" icon="box" href="/evm/next/documentation/getting-started/build-a-chain/additional-configuration/predeployed-contracts">
  Full list of preinstalled contracts and their addresses.
</Card>
