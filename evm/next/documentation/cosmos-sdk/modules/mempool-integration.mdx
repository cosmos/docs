---
noindex: true
canonical: 'https://docs.cosmos.network/evm/latest/documentation/cosmos-sdk/modules/mempool-integration'
...
- **Cosmos SDK Mempool**: [Application Mempool](/sdk/v0.53/build/building-apps/app-mempool)
