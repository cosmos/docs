...
**Related Configuration**: Requires [PreciseBank Module](/evm/next/documentation/cosmos-sdk/modules/precisebank) to be included in app.go
...
- [Fee Market Module](/evm/next/documentation/cosmos-sdk/modules/feemarket) - EIP-1559 fee configuration
