---
noindex: true
canonical: 'https://docs.cosmos.network/evm/latest/documentation/cosmos-sdk/protocol'
...
Cosmos EVM enables the full composability and modularity of the [Cosmos SDK](/). It includes standard modules from the Cosmos SDK that work side by side with EVM-specific modules. Check out the [list of modules](/evm/next/documentation/cosmos-sdk/modules) to get an overview of what each module is responsible for.
