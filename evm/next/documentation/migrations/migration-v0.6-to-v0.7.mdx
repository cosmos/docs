---
noindex: true
canonical: 'https://docs.cosmos.network/evm/latest/documentation/migrations/migration-v0.6-to-v0.7'
...
- [Krakatoa overview](https://docs.cosmos.network/evm/latest/documentation/concepts/mempool)
- [Krakatoa configuration](https://docs.cosmos.network/evm/latest/documentation/getting-started/build-a-chain/additional-configuration/mempool-integration)
...
If you're skipping a release, read the [v0.5.x → v0.6.0 guide](/evm/next/documentation/migrations/migration-v0.5-to-v0.6) first — its StateDB / `callFromPrecompile` API break still applies.
...
| `cosmos-sdk`  | v0.53.x | **v0.54.2**                       | [SDK][sdk-upgrade]  |
| `cometbft`    | v0.38.x | **v0.39.3**                       | [release notes][ct] |
| `ibc-go`      | v10     | **v11**                           | [v10→v11][ibc-v11]  |
| `go-ethereum` | v1.15   | **v1.17** via Cosmos fork         | [release notes][gh] |
...
[ct]: https://github.com/cometbft/cometbft/releases
...
If your chain has a 6-decimal staking denom, an alternative is to run a separate, natively 18-decimal gas denom backed by a converter precompile, with no precisebank dependency at all. See [Migrating off x/precisebank: Gas Converter Precompile](/evm/next/documentation/migrations/gas-converter-migration).
