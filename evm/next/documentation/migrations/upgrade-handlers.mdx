---
noindex: true
canonical: 'https://docs.cosmos.network/evm/latest/documentation/migrations/upgrade-handlers'
title: "Upgrade Handlers"
description: "Understanding and performing coordinated chain upgrades"
---
...
- [Cosmos SDK Upgrade Module](/sdk/latest/modules/upgrade/README)
- [Cosmovisor Documentation](/sdk/latest/guides/upgrades/cosmovisor)
