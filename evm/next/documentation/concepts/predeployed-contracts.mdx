...
- [Chain Customization Checklist](/evm/next/documentation/getting-started/build-a-chain/configuration-reference) - Step-by-step setup
</Note>
...
- [Chain Customization Checklist](/evm/next/documentation/getting-started/build-a-chain/configuration-reference) - Step-by-step setup checklist
