---
noindex: true
canonical: 'https://docs.cosmos.network/evm/latest/documentation/concepts/encoding'
title: "Encoding"
...
<CardGroup cols={2}>
  <Card title="Cosmos SDK Encoding" icon="code" href="/sdk/latest/learn/concepts/encoding">
...
```go "Transaction Encoding Implementation" expandable
