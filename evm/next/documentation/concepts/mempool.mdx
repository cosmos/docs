...
For chain developers integrating the mempool and looking for full configuration details, see the [EVM Mempool Integration Guide](/evm/next/documentation/getting-started/build-a-chain/additional-configuration/mempool-integration).
