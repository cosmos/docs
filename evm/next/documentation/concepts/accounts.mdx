...
**References**: [Cosmos SDK Accounts](https://docs.cosmos.network/main/learn/beginner/accounts), [Ethereum Accounts](https://ethereum.org/en/whitepaper/#ethereum-accounts)
...
The custom [EthAccount](https://github.com/cosmos/evm/blob/main/types/account.go#L28-L33) satisfies the Cosmos SDK `AccountI` interface with additional Ethereum-specific fields:
