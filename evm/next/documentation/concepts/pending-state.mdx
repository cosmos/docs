...
* [Mempool Architecture](/evm/next/documentation/concepts/mempool)
...
See the [JSON-RPC Methods](/evm/next/api-reference/ethereum-json-rpc/methods#txpool-methods) documentation for complete details.
...
* [`eth_getBalance`](/evm/next/api-reference/ethereum-json-rpc/methods#eth_getbalance) - Get balance considering pending transactions
* [`eth_getTransactionCount`](/evm/next/api-reference/ethereum-json-rpc/methods#eth_gettransactioncount) - Get next nonce considering pending transactions
* [`eth_getBlockTransactionCountByNumber`](/evm/next/api-reference/ethereum-json-rpc/methods#eth_getblocktransactioncountbynumber) - Count pending transactions
* [`eth_getBlockByNumber`](/evm/next/api-reference/ethereum-json-rpc/methods#eth_getblockbynumber) - Get pending block information
* [`eth_getTransactionByHash`](/evm/next/api-reference/ethereum-json-rpc/methods#eth_gettransactionbyhash) - Retrieve pending transactions
* [`eth_getTransactionByBlockNumberAndIndex`](/evm/next/api-reference/ethereum-json-rpc/methods#eth_gettransactionbyblockhashandindex) - Access specific pending transactions
* [`eth_sendTransaction`](/evm/next/api-reference/ethereum-json-rpc/methods#eth_sendtransaction) - Submit new transactions

Additionally, the `txpool_*` namespace provides specialized methods for mempool inspection:
* [`txpool_status`](/evm/next/api-reference/ethereum-json-rpc/methods#txpool_status) - Get pool statistics
* [`txpool_content`](/evm/next/api-reference/ethereum-json-rpc/methods#txpool_content) - View all pool transactions
* [`txpool_contentFrom`](/evm/next/api-reference/ethereum-json-rpc/methods#txpool_contentfrom) - Filter by address
* [`txpool_inspect`](/evm/next/api-reference/ethereum-json-rpc/methods#txpool_inspect) - Human-readable summaries
