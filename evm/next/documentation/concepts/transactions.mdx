...
<Note>
For detailed transaction flow and mempool behavior, see [Mempool documentation](/evm/next/documentation/concepts/mempool#transaction-flow) and [Cosmos SDK lifecycle](https://docs.cosmos.network/main/basics/tx-lifecycle).
</Note>
...
Transactions comprised of metadata held in contexts and `sdk.Msg`s that trigger state changes through Protobuf [Msg services](https://docs.cosmos.network/main/building-modules/msg-services).
