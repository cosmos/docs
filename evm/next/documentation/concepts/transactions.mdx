...
<Note>
For detailed transaction flow and mempool behavior, see the [Mempool documentation](/evm/next/documentation/concepts/mempool#transaction-flow) and [Cosmos SDK lifecycle](https://docs.cosmos.network/main/basics/tx-lifecycle).
</Note>
...
<Info>
For detailed mempool behavior and flow diagrams, see [Mempool Architecture](/evm/next/documentation/concepts/mempool#architecture).
</Info>
