...
<Note>
For detailed transaction flow and mempool behavior, see [Mempool documentation](/evm/next/documentation/concepts/mempool#transaction-flow) and [Cosmos SDK lifecycle](/sdk/latest/learn/concepts/lifecycle).
</Note>
