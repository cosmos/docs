...
<Info>
  This page tracks releases and changes for version 0.5.x from the [cosmos/evm](https://github.com/cosmos/evm) repository.
...
- [\#585](https://github.com/cosmos/evm/pull/585) Use zero constructor to avoid nil pointer panic when BaseFee is 0
