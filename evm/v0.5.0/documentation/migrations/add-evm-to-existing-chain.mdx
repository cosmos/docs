...
- A running Cosmos SDK chain with [governance enabled](/evm/v0.5.0/documentation/migrations/upgrade-handlers)
- Access to modify the chain's configuration and codebase
- Understanding of your chain's current [account derivation](/evm/v0.5.0/documentation/concepts/accounts) setup
- Knowledge of your gas token's [decimal configuration](/evm/v0.5.0/documentation/concepts/precision-handling)
...
- [Upgrade Handlers Guide](/evm/v0.5.0/documentation/migrations/upgrade-handlers)
- [PreciseBank Module](/evm/v0.5.0/documentation/cosmos-sdk/modules/precisebank)
- [Address Encoding](/evm/v0.5.0/documentation/concepts/encoding)
