...
- **[Cosmos SDK Modules](/evm/next/documentation/cosmos-sdk)** - Core blockchain functionality including staking, governance, and token management
- **[Precompiles](/evm/next/documentation/smart-contracts/precompiles)** - Smart contract interfaces that bridge EVM and Cosmos SDK capabilities
- **[Security & Audits](/evm/next/documentation/overview#audits)** - Third-party security assessments of the codebase
...
<Card title="Initial Setup" href="/evm/next/documentation/getting-started/build-a-chain/initial-setup">
...
<div style={{maxWidth: '600px'}}>
<Card title="Runtime Configuration & Launch" href="/evm/next/documentation/getting-started/build-a-chain/runtime-and-launch">
Set up node configuration and coordinate network launch
</Card>
</div>

These guides are designed to be followed in order, taking you from an empty repository to a running blockchain network. For a comprehensive reference of all commands and configuration options, see the [Configuration Reference](/evm/next/documentation/getting-started/build-a-chain/configuration-reference).
...
<div style={{maxWidth: '600px'}}>
<Card title="EVM Mempool Integration" href="/evm/next/documentation/getting-started/build-a-chain/additional-configuration/mempool-integration">
Configure the EVM mempool for nonce gap handling and transaction prioritization
</Card>
</div>

<div style={{maxWidth: '600px'}}>
<Card title="Predeployed Contracts" href="/evm/next/documentation/getting-started/build-a-chain/additional-configuration/predeployed-contracts">
...
<Card title="Precompiles Overview" icon="puzzle" href="/evm/next/documentation/smart-contracts/precompiles/overview">
