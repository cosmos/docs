...
For detailed configuration options, see the [Chain Configuration Parameters](/evm/v0.5.0/documentation/getting-started/build-a-chain/configuration-parameters) guide.
</Info>
...
<Info>
For detailed configuration instructions, see [Chain Configuration Parameters](/evm/v0.5.0/documentation/getting-started/build-a-chain/configuration-parameters).
</Info>
...
<Info>
Learn more in the [Precompiles Overview](/evm/v0.5.0/documentation/smart-contracts/precompiles/overview).
</Info>
...
<CardGroup cols={2}>
<Card title="Configuration Parameters" icon="gear" href="/evm/v0.5.0/documentation/getting-started/build-a-chain/configuration-parameters">
Detailed guide to all configuration options
</Card>

<Card title="Precompiles" icon="puzzle" href="/evm/v0.5.0/documentation/smart-contracts/precompiles/overview">
...
<Card title="ERC20 Module" icon="coins" href="/evm/v0.5.0/documentation/cosmos-sdk/modules/erc20">
