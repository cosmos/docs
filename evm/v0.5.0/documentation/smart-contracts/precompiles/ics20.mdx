...
<Info>
For detailed callback implementation, see [IBC Module](/evm/v0.5.0/documentation/cosmos-sdk/modules/ibc) and [Callbacks Interface](/evm/v0.5.0/documentation/smart-contracts/precompiles/callbacks).
</Info>
