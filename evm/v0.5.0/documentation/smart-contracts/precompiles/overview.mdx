...
| **ICS02**        | `0x0000000000000000000000000000000000000807` | IBC light client operations via ICS-02 standard                  | Coming Soon               |
...
<Note>
For complete genesis configuration including EVM and fee market parameters, see the [Node Configuration](/evm/v0.5.0/documentation/getting-started/network-operators/node-configuration) reference.
</Note>
