...
**Source**: [Token Configuration Guide](/evm/v0.5.0/documentation/getting-started/build-a-chain/quick-start)
...
- [Token Configuration Guide](/evm/v0.5.0/documentation/getting-started/build-a-chain/quick-start) - Decimal configuration
- [VM Module](/evm/v0.5.0/documentation/cosmos-sdk/modules/vm) - extended_denom_options setup
- [ERC20 Module](/evm/v0.5.0/documentation/cosmos-sdk/modules/erc20) - Token pair configuration
