...
- [VM Module](/evm/v0.5.0/documentation/cosmos-sdk/modules/vm) - EVM configuration
- [Token Configuration Guide](/evm/v0.5.0/documentation/getting-started/build-a-chain/quick-start) - Token economics setup
