...
**Related Configuration**: Requires [PreciseBank Module](/evm/v0.5.0/documentation/cosmos-sdk/modules/precisebank) to be included in app.go

**See Also**: [Token Configuration Guide](/evm/v0.5.0/documentation/getting-started/build-a-chain/quick-start) for complete decimal configuration details
...
- [Building Your Chain Guide](/evm/v0.5.0/documentation/getting-started/build-a-chain/overview) - Main configuration walkthrough
- [Chain Customization Checklist](/evm/v0.5.0/documentation/getting-started/build-a-chain/quick-start) - Complete parameter checklist
- [Token Configuration Guide](/evm/v0.5.0/documentation/getting-started/build-a-chain/quick-start) - Token decimals and evm_denom setup
- [Fee Market Module](/evm/v0.5.0/documentation/cosmos-sdk/modules/feemarket) - EIP-1559 fee configuration
