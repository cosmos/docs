...
<Info>
Smart contracts can initiate IBC transfers using the [ICS20 Precompile](/evm/v0.5.0/documentation/smart-contracts/precompiles/ics20), which provides the `transfer` function with memo field support for callbacks.
</Info>
...
- [IBC Overview](/evm/v0.5.0/documentation/concepts/ibc) - IBC concepts and fundamentals
- [ICS20 Precompile](/evm/v0.5.0/documentation/smart-contracts/precompiles/ics20) - Cross-chain token transfers
- [Callbacks Interface](/evm/v0.5.0/documentation/smart-contracts/precompiles/callbacks) - Smart contract callback interface
