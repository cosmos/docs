...
Cosmos EVM enables the full composability and modularity of the [Cosmos SDK](https://docs.cosmos.network/). It includes standard modules from the Cosmos SDK that work side by side with EVM-specific modules. Check out the [list of modules](/evm/v0.5.0/documentation/cosmos-sdk/modules) to get an overview of what each module is responsible for.
