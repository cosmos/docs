...
title: "Tokens"
description: "It is recommended to use 18 decimals for your base denomination to maintain parity with Ethereum. There are two types of assets to consider on a Cosmos EVM-based chain:"
icon: "coins"
---
