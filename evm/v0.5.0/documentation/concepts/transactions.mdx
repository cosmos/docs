...
<Note>
For detailed transaction flow and mempool behavior, see the [Mempool documentation](/evm/v0.5.0/documentation/concepts/mempool#transaction-flow) and [Cosmos SDK lifecycle](https://docs.cosmos.network/main/basics/tx-lifecycle).
</Note>
...
This is possible because the Cosmos EVM uses the [Cosmos-SDK](https://docs.cosmos.network/main) and implements the [Ethereum Virtual Machine](https://ethereum.org/en/developers/evm/) as a module. In this way, Cosmos EVM provides the features and functionalities of Ethereum and Cosmos chains combined, and more.
