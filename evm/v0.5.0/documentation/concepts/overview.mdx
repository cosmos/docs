...
For detailed technical implementation, see individual concept pages for [transactions](/evm/v0.5.0/documentation/concepts/transactions), [accounts](/evm/v0.5.0/documentation/concepts/accounts), [gas and fees](/evm/v0.5.0/documentation/concepts/gas-and-fees), and [precompiles](/evm/v0.5.0/documentation/smart-contracts/precompiles).
