...
<Info>
  This page tracks releases and changes for version 0.4.x from the [cosmos/evm](https://github.com/cosmos/evm) repository.
  For all releases, see the [next](/evm/next/changelog/release-notes) version.
</Info>

<Update label="Release" description="v0.4.1" tags={["EVM","Features","Bug Fixes","Improvements","Dependencies","API Breaking"]}>
## DEPENDENCIES
