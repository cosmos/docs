...
description: 'General information to connect with the network and get started.'
---
...
<footnote>
See the [wallet integration](/evm/v0.4.x/documentation/getting-started/tooling-and-resources/wallet-integration) page for more wallet-related resources.
</footnote>
...
See the [tooling and resources](/evm/v0.4.x/documentation/getting-started/tooling-and-resources/overview) section for more information.
