...
- A running Cosmos SDK chain with [governance enabled](/evm/v0.4.x/documentation/migrations/upgrade-handlers)
- Access to modify the chain's configuration and codebase
- Understanding of your chain's current [account derivation](/evm/v0.4.x/documentation/concepts/accounts) setup
- Knowledge of your gas token's [decimal configuration](/evm/v0.4.x/documentation/concepts/precision-handling)
...
- [Upgrade Handlers Guide](/evm/v0.4.x/documentation/migrations/upgrade-handlers)
- [PreciseBank Module](/evm/v0.4.x/documentation/cosmos-sdk/modules/precisebank)
- [Address Encoding](/evm/v0.4.x/documentation/concepts/encoding)
