...
<Note>
For conceptual understanding of predeployed contracts and how they differ from precompiles, see the [Predeployed Contracts concept page](/evm/v0.4.x/documentation/concepts/predeployed-contracts).
</Note>
