...
Cosmos EVM supports the full [Ethereum JSON-RPC](/evm/v0.4.x/api-reference/ethereum-json-rpc) API, enabling you to:
...
* Use [block explorers](/evm/v0.4.x/documentation/getting-started/tooling-and-resources/block-explorers) to debug and monitor your contracts
...
These precompiles open up functionality that would be impossible or prohibitively expensive with regular smart contracts. [View all available precompiles →](/evm/v0.4.x/documentation/smart-contracts/precompiles)
...
* **Documentation:** [Cosmos EVM Precompiles](/evm/v0.4.x/documentation/smart-contracts/precompiles) | [Tooling Guide](/evm/v0.4.x/documentation/getting-started/tooling-and-resources/overview)
