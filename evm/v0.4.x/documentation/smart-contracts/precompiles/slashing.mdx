...
icon: "gavel"
keywords: ['slashing', 'validator', 'jail', 'unjail', 'downtime', 'double-sign', 'precompile', 'cosmos sdk', 'signing info', 'tombstone', 'missed blocks', 'network security', 'validator penalty']
---
...
**Related Module**: [x/slashing](/sdk/v0.53/build/modules/slashing)
    ...
    "params": [
        {
            ...
            "data": "0x69e1f9df000000000000000000000000d8da6bf26964af9d7eed9e03e53415d37aa96045"
        },
        "latest"
    ],
    "id": 1
...
curl -X POST --data '{
    ...
    "params": [
        {
            "to": "0x0000000000000000000000000000000000000806",
            "data": ""
        },
        "latest"
    ],
    "id": 1
