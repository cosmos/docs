...
<Note>
  For conceptual understanding of EVM architecture and design, see [EVM Architecture](/evm/v0.4.x/documentation/concepts/overview).
</Note>
...
- [EVM Architecture](/evm/v0.4.x/documentation/concepts/overview) - Conceptual overview
- [Fee Market Module](/evm/v0.4.x/documentation/cosmos-sdk/modules/feemarket) - EIP-1559 implementation
- [ERC20 Module](/evm/v0.4.x/documentation/cosmos-sdk/modules/erc20) - Token conversions