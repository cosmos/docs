...
<Note>
  This is part of cosmos/evm, not standard Cosmos SDK. For conceptual understanding of EIP-1559, see [EIP-1559 Fee Market](/evm/v0.4.x/documentation/concepts/eip-1559-feemarket).
</Note>
