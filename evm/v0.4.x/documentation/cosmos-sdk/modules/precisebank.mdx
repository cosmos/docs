...
<Note>
  For conceptual understanding of precision handling and mathematical proofs, see [Precision Handling](/evm/v0.4.x/documentation/concepts/precision-handling).
</Note>
...
- [Precision Handling](/evm/v0.4.x/documentation/concepts/precision-handling) - Mathematical foundation
- [VM Module](/evm/v0.4.x/documentation/cosmos-sdk/modules/vm) - EVM integration
- [Bank Module](/sdk/v0.53/build/modules/bank) - Underlying module