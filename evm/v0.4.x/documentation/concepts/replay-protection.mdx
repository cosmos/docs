...
As documented in the [Chain ID](/evm/v0.4.x/documentation/concepts/chain-id) page, Cosmos EVM uses:
...
- [Chain ID Configuration](/evm/v0.4.x/documentation/concepts/chain-id)
- [Transaction Types](/evm/v0.4.x/documentation/concepts/transactions#ethereum-tx-type)
- [EVM Module Parameters](/evm/v0.4.x/documentation/cosmos-sdk/modules/vm#parameters)