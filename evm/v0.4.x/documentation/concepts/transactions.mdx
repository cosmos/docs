...
<Note>
For detailed transaction flow and mempool behavior, see the [Mempool documentation](/evm/v0.4.x/documentation/concepts/mempool#transaction-flow) and [Cosmos SDK lifecycle](https://docs.cosmos.network/main/basics/tx-lifecycle).
</Note>
