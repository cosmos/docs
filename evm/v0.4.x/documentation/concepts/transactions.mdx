...
<Note>
For detailed transaction flow and mempool behavior, see the [Mempool documentation](/evm/v0.4.x/documentation/concepts/mempool#transaction-flow) and [Cosmos SDK lifecycle](/sdk/v0.53/learn/beginner/tx-lifecycle).
</Note>
...
This is possible because the Cosmos EVM uses the [Cosmos-SDK](/sdk/v0.53) and implements the [Ethereum Virtual Machine](https://ethereum.org/en/developers/v0.4.x/evm/) as a module. In this way, Cosmos EVM provides the features and functionalities of Ethereum and Cosmos chains combined, and more.
...
<Info>
For detailed mempool behavior and flow diagrams, see [Mempool Architecture](/evm/v0.4.x/documentation/concepts/mempool#architecture).
</Info>
