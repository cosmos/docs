...
1. ALWAYS log meaningful changes as they are completed. Each branch gets its own file in `work-log/`. See [`work-log/AGENTS.md`](work-log/AGENTS.md).
...
Versioning, changelog, and migration scripts live in `scripts/`. See [`scripts/versioning/AGENTS.md`](scripts/versioning/AGENTS.md) for full documentation on the versioning scripts.
