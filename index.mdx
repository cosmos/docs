    ...
    <div className='w-full px-4 md:px-8 lg:px-12 pb-12 md:pb-16 max-w-[1920px] mx-auto'>
      <DocCardGrid>
        <DocCard
          ...
          description="New to Cosmos SDK? Learn where to start, or jump straight into building a chain."
          primaryLink="/sdk/latest/tutorials/example/00-overview"
          primaryLinkText="Build a chain"
          secondaryLink="/sdk/latest/learn/start-here"
          secondaryLinkText="Choose a path"
        />
        <DocCard
          title="Cosmos SDK"
