...
[**Install from source**](/hub/next/getting-started/installation)
...
You will find the tutorial on how to install `gaiad` [here](/hub/next/getting-started/installation), and the guide to run a full-node [here](/hub/next/hub-tutorials/join-mainnet).
...
<Warning>
**Before bonding Atoms, please read the [delegator faq](/hub/next/delegators/delegator-faq) to understand the risk and responsibilities involved with delegating**
</Warning>
