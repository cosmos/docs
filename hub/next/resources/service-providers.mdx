...
First, you need to [install the software](/hub/next/getting-started/installation).

Consider running your own [Cosmos Hub Full Node](/hub/next/hub-tutorials/join-mainnet).
...
with your full node. Learn [how to enable the REST API](/hub/next/hub-tutorials/join-mainnet#rest-api) on your full node.
