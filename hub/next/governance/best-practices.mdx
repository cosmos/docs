...
* **[Text](/hub/next/governance/proposal-types/text-prop)** - Proposal to agree to a certain strategy, plan, commitment, future upgrade or other statement. Text proposals do not directly cause any changes, but they can be used to take a record of the community's opinion or commitment to a future idea.
* [**Community Pool Spend**](/hub/next/governance/proposal-types/community-pool-spend) - Proposal to spend funds from the community pool on a project.
* [**Parameter Change**](/hub/next/governance/proposal-types/param-change) - Proposal to change a core on-chain parameter.
...
Before going on mainnet, you can test your proposal on the [testnet](/hub/next/governance/submitting#submitting-your-proposal-to-the-testnet).
