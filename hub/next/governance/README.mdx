...
---
The Cosmos Hub ("Gaia") has an on-chain governance mechanism for [signaling](/hub/next/governance/proposal-types/text-prop), changing [consensus parameters](/hub/next/governance/proposal-types/param-change), and spending [funds from the community pool](/hub/next/governance/proposal-types/community-pool-spend).
