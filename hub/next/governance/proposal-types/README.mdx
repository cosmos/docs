...
description: >-
  ...
  Client Update
---
* [**Text**](/hub/next/governance/proposal-types/text-prop)
* [**Community Pool Spend**](/hub/next/governance/proposal-types/community-pool-spend)
* [**Parameter Change**](/hub/next/governance/proposal-types/param-change)
* [**Software Upgrade**](/hub/next/governance/proposal-types/software-upgrade)
* **IBC Client Update**
...
1. [How the voting process and governance mechanism works](/hub/next/governance/process)
2. [How to draft your proposal and engage with the Cosmos community about it](/hub/next/governance/best-practices)
3. [How to format proposals](/hub/next/governance/formatting)
4. [How to submit your proposal](/hub/next/governance/submitting)
