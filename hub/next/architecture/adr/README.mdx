...
Read about the [PROCESS](/hub/next/architecture/adr/PROCESS).
...
* [ADR 003: Interchain Accounts Controller Module](/hub/next/architecture/adr/adr-003-ica-controller)
...
* [ADR 001: Interchain Accounts](/hub/next/architecture/adr/adr-001-interchain-accounts)

### Deprecated

* [ADR 002: Globalfee Module](/hub/next/architecture/adr/adr-002-globalfee)
