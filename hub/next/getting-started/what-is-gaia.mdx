...
For a full list of modules used on the Cosmos Hub follow this [link](/hub/next/modules/README).

Next, learn how to [install Gaia](/hub/next/getting-started/installation).
