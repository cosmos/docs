...
---
The Cosmos Hub ("Gaia") has an on-chain governance mechanism for [signaling](/hub/latest/governance/proposal-types/text-prop), changing [consensus parameters](/hub/latest/governance/proposal-types/param-change), and spending [funds from the community pool](/hub/latest/governance/proposal-types/community-pool-spend).
