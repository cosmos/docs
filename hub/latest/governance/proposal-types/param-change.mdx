...
Each cosmos-sdk module uses `MsgUpdateParams` for providing parameter changes. You can learn more about it in the cosmos-sdk documentation of each module (e.g. [Link](/sdk/latest/modules/staking/README#msgupdateparams))

## What are the current parameter values?

{/* markdown-link-check-enable */}
There are ways to query the current settings for each module's parameter(s). Some can be queried with the command line program [`gaiad`](/hub/latest/getting-started/installation).
