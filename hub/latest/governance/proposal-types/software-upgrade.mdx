...
Software upgrade proposals can be submitted using the [x/upgrade module](/sdk/latest/modules/upgrade/README#transactions). The end effect will be the same since the `x/gov` module routes the message to `x/upgrade` module.

## Additional information

Additional instructions with debugging information is available on the [submitting](/hub/latest/governance/submitting) page.
