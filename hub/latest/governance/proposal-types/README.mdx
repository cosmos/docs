...
description: >-
  ...
  Client Update
---
* [**Text**](/hub/latest/governance/proposal-types/text-prop)
* [**Community Pool Spend**](/hub/latest/governance/proposal-types/community-pool-spend)
* [**Parameter Change**](/hub/latest/governance/proposal-types/param-change)
* [**Software Upgrade**](/hub/latest/governance/proposal-types/software-upgrade)
* **IBC Client Update**
...
1. [How the voting process and governance mechanism works](/hub/latest/governance/process)
2. [How to draft your proposal and engage with the Cosmos community about it](/hub/latest/governance/best-practices)
3. [How to format proposals](/hub/latest/governance/formatting)
4. [How to submit your proposal](/hub/latest/governance/submitting)
