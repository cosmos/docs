...
First, you need to [install the software](/hub/latest/getting-started/installation).

Consider running your own [Cosmos Hub Full Node](/hub/latest/hub-tutorials/join-mainnet).
...
with your full node. Learn [how to enable the REST API](/hub/latest/hub-tutorials/join-mainnet#rest-api) on your full node.
