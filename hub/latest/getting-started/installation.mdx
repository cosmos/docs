...
---
This guide will explain how to install the `gaiad` binary and run the cli. With this binary installed on a server, you can participate on the mainnet as either a [Full Node](/hub/latest/hub-tutorials/join-mainnet) or a [Validator](/hub/latest/validators/validator-setup).
...
Now you can [join the mainnet](/hub/latest/hub-tutorials/join-mainnet), [the public testnet](/hub/latest/hub-tutorials/join-testnet).
