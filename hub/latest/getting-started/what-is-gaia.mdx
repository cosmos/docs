...
title: What is Gaia?
description: >-
  The Cosmos Hub is a public Proof-of-Stake chain that uses ATOM as its native
  staking token. It is the first blockchain launched in the Cosmos Network and
  developed using the cosmos-sdk development framework and ibc-go.
---
The Cosmos Hub is a public Proof-of-Stake chain that uses ATOM as its native staking token. It is the first blockchain launched in the Cosmos Network and developed using the [cosmos-sdk](/) development framework and [ibc-go](/ibc/latest/intro).
...
For a full list of modules used on the Cosmos Hub follow this [link](/hub/latest/modules/README).

Next, learn how to [install Gaia](/hub/latest/getting-started/installation).
