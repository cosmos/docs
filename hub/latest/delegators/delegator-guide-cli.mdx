...
[**Install from source**](/hub/latest/getting-started/installation)
...
You will find the tutorial on how to install `gaiad` [here](/hub/latest/getting-started/installation), and the guide to run a full-node [here](/hub/latest/hub-tutorials/join-mainnet).
...
<Warning>
**Before bonding Atoms, please read the [delegator faq](/hub/latest/delegators/delegator-faq) to understand the risk and responsibilities involved with delegating**
</Warning>
