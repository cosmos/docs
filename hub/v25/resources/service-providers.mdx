---
noindex: true
canonical: 'https://docs.cosmos.network/hub/latest/resources/service-providers'
title: Service Providers
description: >-
  'Service Providers' are defined as entities that provide services for
  end-users that involve some form of interaction with the Cosmos Hub. More
  specifically, this document is focused on interactions with tokens.
---
...
First, you need to [install the software](/hub/v25/getting-started/installation).

Consider running your own [Cosmos Hub Full Node](/hub/v25/hub-tutorials/join-mainnet).
...
with your full node. Learn [how to enable the REST API](/hub/v25/hub-tutorials/join-mainnet#rest-api) on your full node.
