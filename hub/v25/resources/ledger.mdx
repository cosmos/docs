---
noindex: true
canonical: 'https://docs.cosmos.network/hub/latest/resources/ledger'
...
3. On the Ledger Live application, navigate to the `Manager` menu.
   ![Ledger Live Manager](/assets/hub/images/images/ledger-tuto-manager.png)
4. Connect your Ledger Nano device and allow Ledger Manager from it.
5. On the Ledger Live application, search for `Cosmos`.
   ![Search for Cosmos app](/assets/hub/images/images/ledger-tuto-search.png)
...
![Enable Developer Mode](/assets/hub/images/images/ledger-tuto-dev-mode.png)
...
To learn more about using Keplr, we suggest you have a look at their [documentation](https://docs.keplr.app).
{/* markdown-link-check-disable */}
...
* [Install Gaia](/hub/v25/getting-started/installation)
...
Cosmos uses [HD Wallets](/hub/v25/resources/hd-wallets). This means you can setup many accounts using the same Ledger seed. To create another account from your Ledger device, run (change the integer i to some value `>=` 0 to choose the account for HD derivation):
...
<Tip>
To run your own full node locally [read more here.](/hub/v25/hub-tutorials/join-mainnet).
</Tip>
...
Now, you are all set to start [sending transactions on the network](/hub/v25/delegators/delegator-guide-cli#sending-transactions).
