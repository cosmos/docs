---
noindex: true
canonical: 'https://docs.cosmos.network/hub/latest/modules/liquid'
title: x/liquid
description: >-
  The x/liquid module used by the Hub includes types and APIs that enable liquid
  staking. You can read more about it in our module documentation.
---
