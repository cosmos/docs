---
noindex: true
canonical: 'https://docs.cosmos.network/hub/latest/modules/metaprotocols'
title: Metaprotocol
description: >-
  The x/metaprotocol module adds support for encoding and decoding additional
  fields attached to transactions.
---
