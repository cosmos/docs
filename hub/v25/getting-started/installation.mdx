---
noindex: true
canonical: 'https://docs.cosmos.network/hub/latest/getting-started/installation'
title: Installing Gaia
description: >-
  This guide will explain how to install the gaiad binary and run the cli. With
  this binary installed on a server, you can participate on the mainnet as
  either a Full Node or a Validator.
---
This guide will explain how to install the `gaiad` binary and run the cli. With this binary installed on a server, you can participate on the mainnet as either a [Full Node](/hub/v25/hub-tutorials/join-mainnet) or a [Validator](/hub/v25/validators/validator-setup).
...
* [Link](https://github.com/CosmWasm/wasmvm?tab=readme-ov-file#builds-of-libwasmvm)
...
| static\_wasm/muslc | Used for statically linked wasmd dependencies   |
...
Now you can [join the mainnet](/hub/v25/hub-tutorials/join-mainnet), [the public testnet](/hub/v25/hub-tutorials/join-testnet).
