---
noindex: true
canonical: 'https://docs.cosmos.network/hub/latest/hub-tutorials/join-testnet'
title: Joining Testnet
description: >-
  Visit the testnets repo for the most up-to-date information on the currently
  available public testnets:
---
...
* Interchain Security (ICS) Testnet: [`provider`](https://github.com/cosmos/testnets/tree/master/interchain-security)
