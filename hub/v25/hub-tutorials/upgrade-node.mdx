---
noindex: true
canonical: 'https://docs.cosmos.network/hub/latest/hub-tutorials/upgrade-node'
...
<Warning>
If the new version you are upgrading to has breaking changes, you will have to restart your chain. If it is not breaking, you can skip to [Restart](/hub/v25/hub-tutorials/upgrade-node#restart)
</Warning>
...
<Warning>
If the version {'<'}new\_version{'>'} you are upgrading to is not breaking from the previous one, you should not reset the data. If it is not breaking, you can skip to [Restart](#restart)
</Warning>
