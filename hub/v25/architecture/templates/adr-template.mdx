---
noindex: true
canonical: 'https://docs.cosmos.network/hub/latest/architecture/templates/adr-template'
---
...
> Please have a look at the [PROCESS](/hub/v25/architecture/adr/PROCESS#adr-status) page.
