---
noindex: true
canonical: 'https://docs.cosmos.network/hub/latest/architecture/adr/README'
...
Read about the [PROCESS](/hub/v25/architecture/adr/PROCESS).
...
* [ADR 003: Interchain Accounts Controller Module](/hub/v25/architecture/adr/adr-003-ica-controller)
...
* [ADR 001: Interchain Accounts](/hub/v25/architecture/adr/adr-001-interchain-accounts)

### Deprecated

* [ADR 002: Globalfee Module](/hub/v25/architecture/adr/adr-002-globalfee)
