---
noindex: true
canonical: 'https://docs.cosmos.network/hub/latest/architecture/adr/adr-003-ica-controller'
title: 'ADR 003: Interchain Accounts Controller Module'
---
## Changelog
...
[Link](https://github.com/cosmos/gaia/issues/2869)
