---
noindex: true
canonical: 'https://docs.cosmos.network/hub/latest/architecture/PROCESS'
...
4. Add an entry to a list in the README file [Table of Contents](/hub/v25/architecture/README#adr-table-of-contents).
