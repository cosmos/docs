---
noindex: true
canonical: 'https://docs.cosmos.network/hub/latest/delegators/delegator-guide-cli'
title: Delegator Guide (CLI)
description: >-
  This document contains all the necessary information for delegators to
  interact with the Cosmos Hub through the Command-Line Interface (CLI).
---
...
[**Install from source**](/hub/v25/getting-started/installation)
...
You will find the tutorial on how to install `gaiad` [here](/hub/v25/getting-started/installation), and the guide to run a full-node [here](/hub/v25/hub-tutorials/join-mainnet).
...
<Warning>
**Before bonding Atoms, please read the [delegator faq](/hub/v25/delegators/delegator-faq) to understand the risk and responsibilities involved with delegating**
</Warning>
