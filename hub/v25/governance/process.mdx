---
noindex: true
canonical: 'https://docs.cosmos.network/hub/latest/governance/process'
...
Deposits are burned only when proposals are vetoed as documented in the [Cosmos SDK gov module spec](/sdk/v0.53/build/modules/gov#deposit-refund-and-burn). Deposits are not burned for failing to meet quorum or for being rejected.
