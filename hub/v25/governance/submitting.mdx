---
noindex: true
canonical: 'https://docs.cosmos.network/hub/latest/governance/submitting'
title: Submitting a Proposal
description: >-
  If you have a final draft of your proposal ready to submit, you may want to
  push your proposal live on the testnet first. These are the three primary
  steps to getting your proposal live on-chain.
---
...
* You will need to compile [`gaiad`](/hub/v25/getting-started/installation) from source into a binary file executable by your operating system eg. MacOS, Windows, Linux
...
2. By using a service such as [Link](https://pinata.cloud)

Ensure that you "pin" the file so that it continues to be available on the network. You should get a URL like this: [Link](https://ipfs.io/ipfs/QmbkQNtCAdR1CNbFE8ujub2jcpwUcmSRpSCg8gVWrTHSWD)
...
Prior to sending the transaction that submits your proposal on-chain, you must create a JSON file. This file will contain the information that will be stored on-chain as the governance proposal. Begin by creating a new text (.txt) file to enter this information. Use [these best practices](/hub/v25/governance/best-practices) as a guide for the contents of your proposal. When you're done, save the file as a .json file.
...
* [Text Proposals](/hub/v25/governance/formatting#text)
* [Community Pool Spend Proposals](/hub/v25/governance/formatting#community-pool-spend)
* [Parameter Change Proposals](/hub/v25/governance/formatting#legacy-param-change)
...
For information on how to use gaiad (the command line interface) to submit an on-chain proposal through the governance module, please refer to the [gaiad CLI tutorials](/hub/v25/hub-tutorials/gaiad) for the Cosmos Hub documentation.
...
You can read more about submitting a legacy proposal in the [cosmos-sdk docs](/sdk/v0.53/build/modules/gov#submit-legacy-proposal)
...
You can read more about submitting a proposal in the [cosmos-sdk docs](/sdk/v0.53/build/modules/gov#submit-proposal)
...
4. `--node` is using an established node to send the transaction to the Cosmos Hub 4 network. For available nodes, please look at the [Chain Registry](https://github.com/cosmos/chain-registry/blob/master/cosmoshub/chain.json).
...
If you encounter a problem, try to troubleshoot it first, and then ask for help on the Cosmos Hub forum: [Link](https://forum.cosmos.network). We can learn from failed attempts and use them to improve upon this guide.
