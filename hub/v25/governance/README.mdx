---
noindex: true
canonical: 'https://docs.cosmos.network/hub/latest/governance/README'
...
---
The Cosmos Hub ("Gaia") has an on-chain governance mechanism for [signaling](/hub/v25/governance/proposal-types/text-prop), changing [consensus parameters](/hub/v25/governance/proposal-types/param-change), and spending [funds from the community pool](/hub/v25/governance/proposal-types/community-pool-spend).
