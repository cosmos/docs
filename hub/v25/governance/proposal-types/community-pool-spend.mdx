---
noindex: true
canonical: 'https://docs.cosmos.network/hub/latest/governance/proposal-types/community-pool-spend'
...
Alternatively, popular Cosmos explorers such as [Mintscan](https://www.mintscan.io/cosmos) display the ongoing Community Pool balance.
