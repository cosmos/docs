---
noindex: true
canonical: 'https://docs.cosmos.network/hub/latest/governance/proposal-types/text-prop'
title: Text (Signaling)
description: >-
  Signaling proposals are used to make an on-chain record of support or
  agreement on a certain topic or ideas. Text proposals do not contain any code.
  That is, they do not directly cause any changes to the Hub once passed.
---
