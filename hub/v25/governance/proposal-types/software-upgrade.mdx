---
noindex: true
canonical: 'https://docs.cosmos.network/hub/latest/governance/proposal-types/software-upgrade'
title: Software Upgrade
description: >-
  Software upgrade proposals are submitted to signal that a Cosmos Hub release
  with new features, bugfixes and various other improvements is available and
...
Software upgrade proposals can be submitted using the [x/upgrade module](/sdk/v0.53/build/modules/upgrade#transactions). The end effect will be the same since the `x/gov` module routes the message to `x/upgrade` module.

## Additional information

Additional instructions with debugging information is available on the [submitting](/hub/v25/governance/submitting) page.
