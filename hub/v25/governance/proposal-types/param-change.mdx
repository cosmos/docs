---
noindex: true
canonical: 'https://docs.cosmos.network/hub/latest/governance/proposal-types/param-change'
...
Each cosmos-sdk module uses `MsgUpdateParams` for providing parameter changes. You can learn more about it in the cosmos-sdk documentation of each module (e.g. [Link](/sdk/v0.53/build/modules/staking#msgupdateparams))

## What are the current parameter values?

{/* markdown-link-check-enable */}
There are ways to query the current settings for each module's parameter(s). Some can be queried with the command line program [`gaiad`](/hub/v25/getting-started/installation).
