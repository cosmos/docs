...
Each cosmos-sdk module uses `MsgUpdateParams` for providing parameter changes. You can learn more about it in the cosmos-sdk documentation of each module (e.g. [Link](https://docs.cosmos.network/v0.47/build/modules/staking#msgupdateparams))
