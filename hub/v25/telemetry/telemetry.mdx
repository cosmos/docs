---
noindex: true
canonical: 'https://docs.cosmos.network/hub/latest/telemetry/telemetry'
title: Gaia Telemetry
---
...
* Cosmos SDK: [Link](/sdk/v0.53/learn/advanced/telemetry)
* CometBFT: [Link](/cometbft/v0.38/docs/core/metrics)
