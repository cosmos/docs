---
noindex: true
canonical: 'https://docs.cosmos.network/hub/latest/validators/kms/kms'
title: KMS - Key Management System
description: >-
  Tendermint KMS is a key management service that allows separating key
  management from Tendermint nodes. In addition it provides other advantages
  such as:
---
...
Detailed information on how to setup a KMS with Ledger Tendermint App can be found [here](/hub/v25/validators/kms/kms_ledger)
