...
You can find more details about the requirements in the [Joining Mainnet Tutorial](/hub/v26/hub-tutorials/join-mainnet).

### What is a delegator?

Delegators are ATOM holders who cannot, or do not want to, run a validator themselves. ATOM holders can delegate ATOM to a validator and obtain a part of their revenue in exchange. For details on how revenue is distributed, see [What is the incentive to stake?](/hub/v26/validators/validator-faq#what-is-the-incentive-to-stake) and [What are validators commission?](/hub/v26/validators/validator-faq#what-is-a-validator-commission) in this document.
...
Testnet participation is a great way to signal to the community that you are ready and able to operate a validator. For details, see [Join the Public Testnet](/hub/v26/hub-tutorials/join-testnet) documentation.
...
A modest level of hardware specifications is initially required and rises as network use increases. Participating in the testnet is the best way to learn more. You can find the current hardware recommendations in the [Joining Mainnet documentation](/hub/v26/hub-tutorials/join-mainnet).
