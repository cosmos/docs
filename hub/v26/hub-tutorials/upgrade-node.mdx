...
<Warning>
If the new version you are upgrading to has breaking changes, you will have to restart your chain. If it is not breaking, you can skip to [Restart](/hub/v26/hub-tutorials/upgrade-node#restart)
</Warning>
