...
* You will need to compile [`gaiad`](/hub/v26/getting-started/installation) from source into a binary file executable by your operating system eg. MacOS, Windows, Linux
...
Prior to sending the transaction that submits your proposal on-chain, you must create a JSON file. This file will contain the information that will be stored on-chain as the governance proposal. Begin by creating a new text (.txt) file to enter this information. Use [these best practices](/hub/v26/governance/best-practices) as a guide for the contents of your proposal. When you're done, save the file as a .json file.
...
* [Text Proposals](/hub/v26/governance/formatting#text)
* [Community Pool Spend Proposals](/hub/v26/governance/formatting#community-pool-spend)
* [Parameter Change Proposals](/hub/v26/governance/formatting#legacy-param-change)
...
For information on how to use gaiad (the command line interface) to submit an on-chain proposal through the governance module, please refer to the [gaiad CLI tutorials](/hub/v26/hub-tutorials/gaiad) for the Cosmos Hub documentation.
