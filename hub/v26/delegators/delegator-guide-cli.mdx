...
[**Install from source**](/hub/v26/getting-started/installation)
...
You will find the tutorial on how to install `gaiad` [here](/hub/v26/getting-started/installation), and the guide to run a full-node [here](/hub/v26/hub-tutorials/join-mainnet).
...
<Warning>
**Before bonding Atoms, please read the [delegator faq](/hub/v26/delegators/delegator-faq) to understand the risk and responsibilities involved with delegating**
</Warning>
