...
First, you need to [install the software](/hub/v26/getting-started/installation).

Consider running your own [Cosmos Hub Full Node](/hub/v26/hub-tutorials/join-mainnet).
...
with your full node. Learn [how to enable the REST API](/hub/v26/hub-tutorials/join-mainnet#rest-api) on your full node.
