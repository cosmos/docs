...
For a full list of modules used on the Cosmos Hub follow this [link](/hub/v26/modules/README).

Next, learn how to [install Gaia](/hub/v26/getting-started/installation).
