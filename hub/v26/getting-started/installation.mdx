...
---
This guide will explain how to install the `gaiad` binary and run the cli. With this binary installed on a server, you can participate on the mainnet as either a [Full Node](/hub/v26/hub-tutorials/join-mainnet) or a [Validator](/hub/v26/validators/validator-setup).
...
Now you can [join the mainnet](/hub/v26/hub-tutorials/join-mainnet), [the public testnet](/hub/v26/hub-tutorials/join-testnet).
