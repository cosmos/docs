...
[Architecture Decision Records (ADR)](/sdk/v0.47/build/architecture/README).
...
The [rfc-template.md](/sdk/v0.47/build/rfc/rfc-template) file includes placeholders for these
sections.
