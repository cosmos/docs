...
<Note>
**Synopsis**
A Protobuf Query service processes [`queries`](/sdk/v0.47/build/building-modules/messages-and-queries#queries). Query services are specific to the module in which they are defined, and only process `queries` defined within said module. They are called from `BaseApp`'s [`Query` method](/sdk/v0.47/learn/advanced/baseapp#query).
</Note>
...
* [Messages and Queries](/sdk/v0.47/build/building-modules/messages-and-queries)
