...
* [Cosmos Blockchain Simulator](/sdk/v0.47/learn/advanced/simulation)
</Note>
...
Operations on the simulation are simulated using the full [transaction cycle](/sdk/v0.47/learn/advanced/transactions) of a
