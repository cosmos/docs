...
In [ADR 021](/sdk/v0.47/build/architecture/adr-021-protobuf-query-encoding), gRPC was adopted for Protobuf
...
[ADR 021](/sdk/v0.47/build/architecture/adr-021-protobuf-query-encoding) specifies that modules should
