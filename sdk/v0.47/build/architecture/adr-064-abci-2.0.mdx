...
description: >-
  2023-01-17: Initial Draft (@alexanderbez) 2023-04-06: Add upgrading section
  (@alexanderbez) 2023-04-10: Simplify vote extension state persistence
  (@alexanderbez)
---
...
SDK outlined in [ADR 060: ABCI 1.0 (Phase I)](/sdk/v0.47/build/architecture/adr-060-abci-1.0).
