...
as defined in [ADR 007](/sdk/v0.47/build/architecture/adr-007-specialization-groups). This will include the
implementation of:
...
[Specialization Groups ADR](/sdk/v0.47/build/architecture/adr-007-specialization-groups)
