...
**Note:** The auth module is different from the [authz module](/sdk/v0.47/build/modules/authz/README).
...
[Learn more about tip transaction](/sdk/v0.53/build/modules/auth/auth).
