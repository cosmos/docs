...
Location: off-chain as json object stored on IPFS (mirrors [group proposal](/sdk/v0.47/build/modules/group/README#metadata))
...
Location: on-chain as json within 255 character limit (mirrors [group vote](/sdk/v0.47/build/modules/group/README#metadata))
