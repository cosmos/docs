...
type Handler func(sdk.Context, Evidence)
...
```protobuf
// Reference: https://github.com/cosmos/cosmos-sdk/blob/v0.47.0-rc1/proto/cosmos/evidence/v1beta1/evidence.proto#L12-L32
```
...
on slashing and jailing in [State Transitions](/sdk/v0.47/build/modules/staking/README#state-transitions).
