...
If you are running through this tutorial as a test, continue to [Run a node](/sdk/v0.53/user/run-node/run-node) to initialize your blockchain and start your node.
