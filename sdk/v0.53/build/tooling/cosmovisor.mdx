...
Migration plans are defined using the `x/upgrade` module and described in [In-Place Store Migrations](/sdk/v0.53/learn/advanced/upgrade). Migrations can perform any deterministic state change.
