...
* Perform upgrades in place, which significantly decrease the upgrade time for chains with a larger state. Use the [Module Upgrade Guide](/sdk/v0.47/build/building-modules/upgrade) to set up your application modules to take advantage of in-place upgrades.
...
To learn more about configuring migration scripts for your modules, see the [Module Upgrade Guide](/sdk/v0.47/build/building-modules/upgrade).
...
To learn more about Cosmovisor, see the [Cosmovisor Quick Start](/sdk/v0.47/build/tooling/cosmovisor).
