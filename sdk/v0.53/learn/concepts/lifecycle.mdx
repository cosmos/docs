...
- [ABCI](/sdk/v0.53/learn/intro/sdk-app-architecture#abci-application-blockchain-interface) (Application-Blockchain Interface) — the protocol CometBFT uses to talk to the Cosmos SDK application
...
- The [SDK application](/sdk/v0.53/learn/intro/sdk-app-architecture#cosmos-sdk-application) handles state: executing transactions and updating the chain's data. 
