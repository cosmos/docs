...
* [Understanding Front-Running](/sdk/v0.53/tutorials/vote-extensions/auction-frontrunning/understanding-frontrunning)
* [Mitigating Front-running with Vote Extensions](/sdk/v0.53/tutorials/vote-extensions/auction-frontrunning/mitigating-front-running-with-vote-extensions)
* [Demo of Mitigating Front-Running](/sdk/v0.53/tutorials/vote-extensions/auction-frontrunning/mitigating-front-running-with-vote-extesions)
...
More information about vote extensions can be seen [here](/sdk/v0.53/build/abci/vote-extensions).
...
* Familiarity with the concepts of front-running and MEV, as detailed in [Understanding Front-Running](/sdk/v0.53/tutorials/vote-extensions/auction-frontrunning/understanding-frontrunning)
* Understanding of Vote Extensions as described [here](/sdk/v0.53/build/abci/vote-extensions)
