---
noindex: true
canonical: 'https://docs.cosmos.network/sdk/latest/security/bug-bounty'
...
**Last sync:** Mar 30, 2026 | [View source](https://github.com/cosmos/security/blob/main/SECURITY.md)
</Info>
...
- If HackerOne submission is not possible, reports may be sent to
  `security@cosmos.network` with sufficient technical detail, including
