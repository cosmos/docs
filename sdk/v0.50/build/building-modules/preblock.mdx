...
<Note>
**Synopsis**
`PreBlocker` is optional method module developers can implement in their module. They will be triggered before [`BeginBlock`](/sdk/v0.50/learn/advanced/baseapp#beginblock).
</Note>
