...
<Note>
**Synopsis**
[In-Place Store Migrations](/sdk/v0.50/learn/advanced/upgrade) allow your modules to upgrade to new versions that include breaking changes. This document outlines how to build modules to take advantage of this functionality.
</Note>

<Note>
**Pre-requisite Readings**

* [In-Place Store Migration](/sdk/v0.50/learn/advanced/upgrade)
