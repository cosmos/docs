...
The rationale behind testing can be found in [ADR-59](/sdk/v0.50/build/architecture/adr-059-test-scopes).
...
Simulations uses as well a minimal application, built with [`depinject`](/sdk/v0.50/build/packages/depinject):
...
<Note>
**warning**
The SDK is in the process of creating its E2E tests, as defined in [ADR-59](/sdk/v0.50/build/architecture/adr-059-test-scopes). This page will eventually be updated with better examples.
</Note>

## Learn More

Learn more about testing scope in [ADR-59](/sdk/v0.50/build/architecture/adr-059-test-scopes).
