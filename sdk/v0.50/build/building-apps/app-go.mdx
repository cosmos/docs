...
description: >-
  This section is intended to provide an overview of the SimApp app.go file and
  is still a work in progress. For now please instead read the tutorials for a
  deep dive on how to build a chain.
---
