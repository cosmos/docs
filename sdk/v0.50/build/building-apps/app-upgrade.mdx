...
<Note>
This document describes how to upgrade your application. If you are looking specifically for the changes to perform between SDK versions, see the [SDK migrations documentation](/sdk/v0.50/build/migrations/intro).
</Note>
...
* [`x/upgrade` Documentation](/sdk/v0.50/build/migrations/intro)
...
also potentially doing a backup. The SDK tool for doing such, is called [Cosmovisor](/sdk/v0.50/build/tooling/cosmovisor).
...
Read more about [Cosmovisor](/sdk/v0.50/build/tooling/cosmovisor), the tool for automating upgrades.
