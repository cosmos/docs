...
The Cosmos SDK allows much easier wiring of an `app.go` thanks to App Wiring and [`depinject`](/sdk/v0.50/build/packages/depinject).
Learn more about the rationale of App Wiring in [ADR-057](/sdk/v0.50/build/architecture/adr-057-app-wiring).
...
* [Depinject Documentation](/sdk/v0.50/build/packages/depinject)
* [Modules depinject-ready](/sdk/v0.50/build/building-modules/depinject)
