...
* [ADR 033: Protobuf-based Inter-Module Communication](/sdk/v0.50/build/architecture/adr-033-protobuf-inter-module-comm) clients.
...
implementations of these services to modules via both [dependency injection](/sdk/v0.50/build/architecture/adr-057-app-wiring) and
...
The [ORM](/sdk/v0.50/build/architecture/adr-055-orm) and [collections](/sdk/v0.50/build/architecture/adr-062-collections-state-layer) both support
...
as possible during initialization and in [ADR 057: App Wiring](/sdk/v0.50/build/architecture/adr-057-app-wiring), protobuf type registration\
...
[autocli](/sdk/v0.50/build/architecture/adr-058-auto-generated-cli) framework.

#### Example Usage

Here is an example of setting up a hypothetical `foo` v2 module which uses the [ORM](/sdk/v0.50/build/architecture/adr-055-orm) for its state
...
semantically versioned Cosmos SDK module as described in [ADR 057: App Wiring](/sdk/v0.50/build/architecture/adr-057-app-wiring).
...
* [ADR 033: Protobuf-based Inter-Module Communication](/sdk/v0.50/build/architecture/adr-033-protobuf-inter-module-comm)
