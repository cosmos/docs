...
modules for Cosmos SDK modules as described in [ADR 053: Go Module Refactoring](/sdk/v0.50/build/architecture/adr-053-go-module-refactoring).
...
Several attempts were made to improve the current situation including [ADR 033: Internal-Module Communication](/sdk/v0.50/build/architecture/adr-033-protobuf-inter-module-comm)
...
described in [ADR 063: Core Module API](/sdk/v0.50/build/architecture/adr-063-core-module-api).
...
defined here are described in [ADR 063: Core Module API](/sdk/v0.50/build/architecture/adr-063-core-module-api).
...
[ADR 054: Module Semantic Versioning](/sdk/v0.50/build/architecture/adr-054-semver-compatible-modules) are
