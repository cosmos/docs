...
<Check>
  For more information on SDK modules, see the [SDK Modules](/sdk/v0.50/build/modules/module) section. For more information on SDK tooling, see the [Tooling](/sdk/v0.50/build/tooling) section.
</Check>

## Core[​](#core "Direct link to Core")

* [Core](https://pkg.go.dev/cosmossdk.io/core) - Core library defining SDK interfaces ([ADR-063](/sdk/v0.50/build/architecture/adr-063-core-module-api))
...
* [Collections](/sdk/v0.50/build/packages/collections) - State management library
* [ORM](/sdk/v0.50/build/packages/README#orm) - State management library

## Automation[​](#automation "Direct link to Automation")

* [Depinject](/sdk/v0.50/build/packages/depinject) - Dependency injection framework
