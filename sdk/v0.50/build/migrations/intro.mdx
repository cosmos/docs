...
When migrating from a previous version, refer to the [`UPGRADING.md`](/sdk/v0.50/build/migrations/upgrading) and the `CHANGELOG.md` of the version you are migrating to.
