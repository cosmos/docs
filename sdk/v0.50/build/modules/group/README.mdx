...
Location: off-chain as json object stored on IPFS (mirrors [gov proposal](/sdk/v0.50/build/modules/gov/README#metadata))
...
Location: on-chain as json within 255 character limit (mirrors [gov vote](/sdk/v0.50/build/modules/gov/README#metadata))
