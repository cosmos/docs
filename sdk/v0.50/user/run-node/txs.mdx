...
CosmJS is the official JavaScript/TypeScript client library for generating, signing, and broadcasting transactions on Cosmos SDK chains. See the dedicated [CosmJS guide](/cosmjs/v0.38.x/quick-start) for full setup and usage examples.
