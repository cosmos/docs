...
CosmJS is the official JavaScript/TypeScript client library for generating, signing, and broadcasting transactions on Cosmos SDK chains. See the dedicated [CosmJS guide](/cosmjs/getting-started) for full setup and usage examples.
