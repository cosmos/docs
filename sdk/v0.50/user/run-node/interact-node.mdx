...
CosmJS is the official JavaScript/TypeScript client library for Cosmos SDK chains. See the dedicated [CosmJS guide](/cosmjs/getting-started) for setup, querying, and transaction examples.
