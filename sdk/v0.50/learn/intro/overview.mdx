...
What's more, the Cosmos SDK is a capabilities-based system that allows developers to better reason about the security of interactions between modules. For a deeper look at capabilities, jump to [Object-Capability Model](/sdk/v0.50/learn/advanced/ocap).
...
Learn more about [application-specific blockchains](/sdk/v0.50/learn/intro/why-app-specific).
...
* The Cosmos SDK is open-source and designed to make it easy to build blockchains out of composable [modules](/sdk/v0.50/build/modules/module). As the ecosystem of open-source Cosmos SDK modules grows, it will become increasingly easier to build complex decentralized platforms with it.
...
* Learn more about the [architecture of a Cosmos SDK application](/sdk/v0.50/learn/intro/sdk-app-architecture)
