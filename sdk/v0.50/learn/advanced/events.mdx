...
*Typed Events* are Protobuf-defined [messages](/sdk/v0.50/build/architecture/adr-032-typed-events) used by the Cosmos SDK
...
They are triggered from the module's Protobuf [`Msg` service](/sdk/v0.50/build/building-modules/msg-services)
...
* [`BeginBlock`](/sdk/v0.50/learn/advanced/baseapp#beginblock)
* [`EndBlock`](/sdk/v0.50/learn/advanced/baseapp#endblock)
* [`CheckTx`](/sdk/v0.50/learn/advanced/baseapp#checktx)
* [`Transaction Execution`](/sdk/v0.50/learn/advanced/baseapp#transactionexecution)
...
| `message.action='/cosmos.bank.v1beta1.Msg/Send'` | Query all transactions containing a x/bank `Send` [Service `Msg`](/sdk/v0.50/build/building-modules/msg-services). Note the `'`s around the value. |
| `message.module='bank'`                          | Query all transactions containing messages from the x/bank module. Note the `'`s around the value.                                                          |
| `create_validator.validator='cosmosval1...'`     | x/staking-specific Event, see [x/staking SPEC](/sdk/v0.50/build/modules/staking/README).                                                              |
...
the [`Context`](/sdk/v0.50/learn/advanced/context), where Event should be already registered, and emitted like this:
...
Where the `EventManager` is accessed via the [`Context`](/sdk/v0.50/learn/advanced/context).

See the [`Msg` services](/sdk/v0.50/build/building-modules/msg-services) concept doc for a more detailed
...
where `ownerAddress` is an address following the [`AccAddress`](/sdk/v0.50/learn/beginner/accounts#addresses) format.
