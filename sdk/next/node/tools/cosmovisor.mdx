...
Migration plans are defined using the `x/upgrade` module and described in [Upgrading Modules](/sdk/next/build/building-modules/upgrade). Migrations can perform any deterministic state change.
