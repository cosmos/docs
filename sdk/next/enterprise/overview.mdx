---
noindex: true
canonical: 'https://docs.cosmos.network/sdk/latest/enterprise/overview'
title: "Overview"
...
The module source is published in the [`enterprise` directory of the Cosmos SDK repository](https://github.com/cosmos/cosmos-sdk/tree/release/v0.55.x/enterprise).

## Available modules

<CardGroup cols={2}>
  <Card title="Permissioned consensus" icon="graduation-cap" href="/sdk/next/enterprise/poa/overview">
  ...
  <Card title="Multi-sig" icon="users" href="/sdk/next/enterprise/group/overview">
