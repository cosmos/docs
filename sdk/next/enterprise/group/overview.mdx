...
- **[API Reference](/sdk/next/enterprise/group/api)** - Complete API reference for queries and messages
- **[Architecture](/sdk/next/enterprise/group/architecture)** - System architecture, core concepts, and module integration details
