...
Cosmos-KMS is designed to work with existing validator infrastructure. If you run [TMKMS](https://github.com/iqlusioninc/tmkms) today, Cosmos-KMS is its successor: TMKMS is deprecated, and operators should [migrate](/sdk/next/kms/migrate-from-tmkms). If you run [Horcrux](https://github.com/strangelove-ventures/horcrux), nothing changes. Horcrux solves availability by sharding a key across signers; Cosmos-KMS solves custody by keeping one key inside your KMS or HSM. A single signer instance is a single point of failure by design.
