...
<CardGroup cols={2}>
  <Card title="Chain Development" icon="code" href="/sdk/next/build/building-apps/app-go">
  ...
  <Card title="Building Transactions" icon="file-contract" href="/sdk/next/tutorials/transactions/building-a-transaction">
