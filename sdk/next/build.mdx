...
<CardGroup cols={2}>
  <Card title="Chain Development" icon="code" href="/sdk/next/guides/abci/app-mempool">
    Build your blockchain application with guides on mempool configuration, upgrades, and vote extensions.
  </Card>
  <Card title="SDK Packages" icon="package" href="/sdk/next/guides/reference/packages">
  ...
  <Card title="Simulation Testing" icon="vial" href="/sdk/next/guides/testing/simulator">
    Test your chain with fuzz testing and simulation frameworks to ensure robustness and catch edge cases.
  </Card>
  <Card title="ABCI" icon="repeat" href="/sdk/next/guides/abci/abci">
    Customize blockchain behavior with ABCI methods including PrepareProposal, ProcessProposal, and vote extensions.
  </Card>
  <Card title="Build a Module" icon="box" href="/sdk/next/guides/module-design/module-design-considerations">
