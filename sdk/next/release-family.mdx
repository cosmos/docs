---
noindex: true
canonical: 'https://docs.cosmos.network/sdk/latest/release-family'
...
| Component | Version |
| --------- | ------- |
| [Cosmos SDK](https://github.com/cosmos/cosmos-sdk) | 0.55.x |
| [Enterprise Groups](https://github.com/cosmos/cosmos-sdk/tree/release/v0.55.x/enterprise/group) | 1.x.y |
| [Enterprise PoA](https://github.com/cosmos/cosmos-sdk/tree/release/v0.55.x/enterprise/poa) | 1.x.y |
| [CometBFT](https://github.com/cometbft/cometbft) | 0.40.x |
| [Cosmos EVM](https://github.com/cosmos/evm) | 0.7.x |
| [IBC Go](https://github.com/cosmos/ibc-go) | v11.x.y |
| [Solidity IBC Eureka](https://github.com/cosmos/solidity-ibc-eureka) | 3.0.x |
| [Relayer](https://github.com/cosmos/ibc-relayer) | 1.1.x |
| [Attestor](https://github.com/cosmos/ibc-attestor) | 1.0.x |
...
| [Cosmos EVM](https://github.com/cosmos/evm) | 0.6.x |
