...
For the operational procedure, see [Rotate a validator consensus key, x/staking](/sdk/next/keys/rotate-validator-key). For the concepts, see [Key rotation](/sdk/next/keys/key-rotation).
