...
Location: off-chain as json object stored on IPFS (mirrors [group proposal](/sdk/next/modules/group/README#metadata))
...
Location: on-chain as json within 255 character limit (mirrors [group vote](/sdk/next/modules/group/README#metadata))
