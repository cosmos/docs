...
We document the [0.54 to 0.55 upgrade path](/sdk/next/upgrade/v0.55), which also includes a [section on upgrading from 0.53 directly to 0.55](/sdk/next/upgrade/v0.55#upgrading-from-v053x). Module upgrades work across the last two SDK versions.
