...
{/* TODO: add the ship date to the Overview, and the exact TMKMS deprecation date, once the release date is locked. */}
{/* TODO: the v0.54 release notes carried Upcoming items for IBC on any EVM network, IFT, and the IBC v2 relayer. Those belong to the interop release and need re-dating before they appear here. Not carried forward yet. */}
