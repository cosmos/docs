...
The [`cosmos.msg.v1.signer` protobuf annotation](/sdk/next/build/reference/protobuf-annotations) defines the signer field of the message.
...
AutoCLI checks the [`cosmos_proto.method_added_in` protobuf annotation](/sdk/next/build/reference/protobuf-annotations) and skips commands that were introduced in a newer SDK version than the one currently running.
