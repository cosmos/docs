...
Keep extensions small — large extensions increase consensus latency. See [CometBFT QA results](/cometbft/v0.38/docs/qa/CometBFT-QA-38#vote-extensions-testbed) for benchmarks.
