...
* [ABCI](/sdk/next/build/abci/introduction)
...
By default, the SDK uses the [No-op Mempool](#no-op-mempool), but it can be replaced by the application developer in [`app.go`](/sdk/next/build/building-apps/app-go-di):
