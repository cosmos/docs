...
Learn more about wiring `runtime` in the [next section](/sdk/next/build/building-apps/app-go-di).
...
Runtime has built-in support for [`depinject`-enabled modules](/sdk/next/build/building-modules/depinject).
...
More information on building applications can be found in the [next section](/sdk/next/build/building-apps/app-go).
