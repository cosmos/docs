...
<Note>
**Synopsis**
`BeginBlocker` and `EndBlocker` are optional methods module developers can implement in their module. They will be triggered at the beginning and at the end of each block respectively, when the [`BeginBlock`](/sdk/next/learn/advanced/baseapp#beginblock) and [`EndBlock`](/sdk/next/learn/advanced/baseapp#endblock) ABCI messages are received from the underlying consensus engine.
</Note>
...
* They generally use the [`keeper`](/sdk/next/build/building-modules/keeper) and [`ctx`](/sdk/next/learn/advanced/context) to retrieve information about the latest state.
