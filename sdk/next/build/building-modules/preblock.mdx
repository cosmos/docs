...
<Note>
**Synopsis**
`PreBlocker` is optional method module developers can implement in their module. They will be triggered before [`BeginBlock`](/sdk/next/learn/advanced/baseapp#beginblock).
</Note>
