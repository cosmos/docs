...
```proto
// Reference: https://github.com/cosmos/cosmos-sdk/blob/release/v0.53.x/proto/cosmos/bank/v1beta1/tx.proto#L40
...
```proto
// https://github.com/cosmos/cosmos-sdk/blob/release/v0.53.x/proto/cosmos/bank/v1beta1/tx.proto#L46
...
```proto
// https://github.com/cosmos/cosmos-sdk/blob/release/v0.53.x/proto/cosmos/distribution/v1beta1/query.proto#L108
...
```proto
// https://github.com/cosmos/cosmos-sdk/blob/release/v0.53.x/proto/cosmos/distribution/v1beta1/distribution.proto#L17
...
```proto
// https://github.com/cosmos/cosmos-sdk/blob/release/v0.53.x/proto/cosmos/gov/v1/gov.proto#L127
...
```proto
// https://github.com/cosmos/cosmos-sdk/blob/release/v0.53.x/proto/cosmos/bank/v1beta1/tx.proto#L41
...
```proto
// https://github.com/cosmos/cosmos-sdk/blob/release/v0.53.x/proto/cosmos/distribution/v1beta1/distribution.proto#L165
...
```proto
// https://github.com/cosmos/cosmos-sdk/blob/release/v0.53.x/proto/cosmos/bank/v1beta1/tx.proto#L48
repeated cosmos.base.v1beta1.Coin amount = 3 [(amino.dont_omitempty) = true];
```

### Encoding

Encoding instructs the amino json marshaler how to encode certain fields that may differ from the standard encoding behavior. The most common example of this is how `repeated cosmos.base.v1beta1.Coin` is encoded when using the amino json encoding format. The `legacy_coins` option tells the json marshaler [how to encode a null slice](https://github.com/cosmos/cosmos-sdk/blob/release/v0.53.x/x/tx/signing/aminojson/json_marshal.go#L85) of `cosmos.base.v1beta1.Coin`.

```proto
// https://github.com/cosmos/cosmos-sdk/blob/release/v0.53.x/proto/cosmos/bank/v1beta1/genesis.proto#L23
(amino.encoding) = "legacy_coins",
```

## Module Query Safe

The `cosmos.query.v1.module_query_safe` annotation ([source](https://github.com/cosmos/cosmos-sdk/blob/release/v0.53.x/proto/cosmos/query/v1/query.proto)) marks a query method as safe to call from within the state machine — for example from another module's keeper, via ADR-033 intermodule calls, or from CosmWasm contracts.
