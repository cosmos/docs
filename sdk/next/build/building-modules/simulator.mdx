...
* [Module Simulation](/sdk/next/build/building-modules/simulator)
...
3. **From a `params.json` file** — initial state is pseudo-randomly generated but module and simulation parameters are set manually. Available parameters are listed [here](https://github.com/cosmos/cosmos-sdk/blob/release/v0.53.x/x/simulation/client/cli/flags.go#L43-L70).
...
The full list of available flags is defined [here](https://github.com/cosmos/cosmos-sdk/blob/release/v0.53.x/x/simulation/client/cli/flags.go#L43-L70). For Makefile examples, see the Cosmos SDK [`Makefile`](https://github.com/cosmos/cosmos-sdk/blob/release/v0.53.x/Makefile#L280-L340).
...
* **Add a [`Logger`](https://github.com/cosmos/cosmos-sdk/blob/release/v0.53.x/x/staking/keeper/keeper.go#L77-L81)** to operations that are not being logged.
