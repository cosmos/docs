...
* [Cosmos Blockchain Simulator](/sdk/next/learn/advanced/simulation)
...
Operations on the simulation are simulated using the full [transaction cycle](/sdk/next/learn/advanced/transactions) of a
