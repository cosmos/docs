...
* [Store](/sdk/next/build/spec/store/store) - The core Merkle store that holds the state.
* [Bech32](/sdk/next/advanced/bech32) - Address format for Cosmos SDK applications.
