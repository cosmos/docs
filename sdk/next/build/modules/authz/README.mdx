...
**Note:** The authz module is different from the [auth (authentication)](/sdk/next/build/modules/auth/auth/) module that is responsible for specifying the base transaction and account types.
