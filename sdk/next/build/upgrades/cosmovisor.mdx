...
Migration plans are defined using the `x/upgrade` module and described in [Upgrading Modules](/sdk/next/build/upgrades/upgrade). Migrations can perform any deterministic state change.
