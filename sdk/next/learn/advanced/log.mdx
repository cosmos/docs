...
The [`cosmossdk.io/log/v2`](https://github.com/cosmos/cosmos-sdk/tree/main/log) package provides a zerolog logging implementation for the Cosmos SDK and Cosmos SDK modules.
