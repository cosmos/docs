...
In the Cosmos SDK, you can see the application of this principle in [`simapp/app.go`](https://github.com/cosmos/cosmos-sdk/blob/release/v0.53.x/simapp/app.go).
