...
On the Cosmos SDK, this functionality is provided by [`SimApp`](https://github.com/cosmos/cosmos-sdk/blob/v0.53.0-rc.2/simapp/app.go), which is a
...
* [Building modules: Simulator](/sdk/next/build/building-modules/simulator)
* Simulator tests
