...
* [`BeginBlock`](/sdk/next/learn/advanced/baseapp#beginblock)
* [`EndBlock`](/sdk/next/learn/advanced/baseapp#endblock)
* [`CheckTx`](/sdk/next/learn/advanced/baseapp#checktx)
* [`Transaction Execution`](/sdk/next/learn/advanced/baseapp#transactionexecution)
...
the [`Context`](/sdk/next/learn/advanced/context), where Events should be already registered and emitted like this:
...
The `EventManager` is accessed via the [`Context`](/sdk/next/learn/advanced/context).
...
where `ownerAddress` is an address following the [`AccAddress`](/sdk/next/learn/beginner/accounts#addresses) format.
