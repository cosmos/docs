...
* [Anatomy of an SDK application](/sdk/next/learn/beginner/app-anatomy)
...
* Then, the `config` is retrieved and config parameters are set. This mainly involves setting the Bech32 prefixes for [addresses](/sdk/next/learn/beginner/accounts#addresses).
...
In practice, the [constructor of the application](/sdk/next/learn/beginner/app-anatomy#constructor-function) is passed as the `appCreator`.
