...
* `bls12_381`, as implemented in the [Cosmos SDK `crypto/keys/bls12_381` package](https://github.com/cosmos/cosmos-sdk/blob/main/crypto/keys/bls12_381/key_cgo.go). This scheme requires specific build flags and is supported on Linux, macOS, and Windows platforms (amd64 and arm64 architectures).
...
|  `bls12_381` |            32           |             48             |                 yes                 |              yes              |

<Info>
As of v0.54, full BLS 12-381 signature scheme support has been added, and sr25519 support has been removed. The sr25519 scheme was removed because it is no longer supported in CometBFT v1.x.
</Info>
