...
To learn more about the transactions and messages, visit the [Transactions page](/sdk/next/learn/advanced/transactions). For more in-depth information on creating modules, visit the [Build a module section](/sdk/next/build/building-modules/intro).
