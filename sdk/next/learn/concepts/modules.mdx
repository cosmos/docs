...
Before writing a module, review [Module Design Considerations](/sdk/next/build/building-modules/module-design-considerations) for guidance on state structure, message surface, inter-module dependencies, and upgrade planning. When you are ready to build, follow the [Build a Module tutorial](/sdk/next/tutorials/example/00-overview) for a step-by-step walkthrough.
