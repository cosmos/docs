...
[Cosmos Enterprise](/sdk/next/enterprise/overview) provides additional hardened modules for production networks with more demanding requirements:

| Module | What it does |
| --- | --- |
| [Permissioned Consensus](/sdk/next/enterprise/poa/overview) | Permissioned validator set managed by an on-chain authority, replacing token-based staking |
| [Multi-sig](/sdk/next/enterprise/group/overview) | On-chain multisig accounts and collective decision-making with configurable voting policies |
