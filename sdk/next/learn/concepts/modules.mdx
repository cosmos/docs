...
| Module | What it does |
| --- | --- |
| [x/auth](/sdk/next/build/modules/auth) | Accounts, authentication, and transaction signing |
| [x/bank](/sdk/next/build/modules/bank) | Token balances and transfers |
| [x/staking](/sdk/next/build/modules/staking) | Validator set and delegations |
| [x/gov](/sdk/next/build/modules/gov) | On-chain governance and proposals |
| [x/distribution](/sdk/next/build/modules/distribution) | Staking reward distribution |
| [x/slashing](/sdk/next/build/modules/slashing) | Validator penalty enforcement |
| [x/mint](/sdk/next/build/modules/mint) | Token issuance |
| [x/evidence](/sdk/next/build/modules/evidence) | Submission and handling of validator misbehavior |
| [x/upgrade](/sdk/next/build/modules/upgrade) | Coordinated chain upgrades |
| [x/authz](/sdk/next/build/modules/authz) | Delegated message authorization |
| [x/feegrant](/sdk/next/build/modules/feegrant) | Fee allowances between accounts |
| [x/consensus](/sdk/next/build/modules/consensus) | On-chain management of CometBFT consensus params |

The above are just a few of the modules available. Applications can include any subset of these modules and can define entirely new custom modules. For the full list, see [List of Modules](/sdk/next/build/modules/modules).
