...
If you are planning to build a production module, see [Module Design Considerations](/sdk/next/build/building-modules/module-design-considerations) for guidance on state structure, message surface, dependencies, and upgrade planning before you ship.
