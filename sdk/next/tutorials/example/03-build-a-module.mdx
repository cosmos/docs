...
If you are planning to build a production module, see [Module Design Considerations](/sdk/next/guides/module-design/module-design-considerations) for guidance on state structure, message surface, dependencies, and upgrade planning before you ship.
