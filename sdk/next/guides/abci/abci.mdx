...
Vote extensions are only available at the height after they are enabled. See [Vote Extensions](/sdk/next/guides/abci/vote-extensions) for details.
...
See [Vote Extensions](/sdk/next/guides/abci/vote-extensions) for implementation details.
