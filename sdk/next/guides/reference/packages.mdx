...
For more information on SDK tooling, see the [Tooling](/sdk/next/guides/tooling/tool-guide) section.
</Tip>
...
* [Collections](https://pkg.go.dev/cosmossdk.io/collections) - Typed state management library with automatic key encoding, iteration, and secondary indexes. See the [Collections guide](/sdk/next/guides/state/collections).
...
* [Client/v2](https://pkg.go.dev/cosmossdk.io/client/v2) - Library powering [AutoCLI](/sdk/next/guides/tooling/autocli)
