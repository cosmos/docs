...
* [gRPC, REST and CometBFT Endpoints](/sdk/next/learn/advanced/grpc_rest)
...
- Explore the [gRPC and REST guide](/sdk/next/learn/advanced/grpc_rest) for more advanced querying techniques
