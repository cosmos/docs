...
If you are running through this tutorial as a test, continue to [Run a node](/sdk/next/user/run-node/run-node) to initialize your blockchain and start your node.
