...
- (x/auth) [#14650](https://github.com/cosmos/cosmos-sdk/pull/14650) Add Textual SignModeHandler. Enable `SIGN_MODE_TEXTUAL` by following the [UPGRADING.mdx](https://github.com/cosmos/cosmos-sdk/blob/main/UPGRADING.md) instructions.
