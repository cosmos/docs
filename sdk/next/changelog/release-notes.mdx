...
<Info>
  This page tracks releases and changes for v0.54.0. For the full release history, see the [CHANGELOG](https://github.com/cosmos/cosmos-sdk/blob/main/CHANGELOG.md) on GitHub.
</Info>

<Update label="Release" description="v0.54.0" tags={["SDK", "Release"]}>
## Breaking Changes
