...
The [rfc-template.md](/sdk/next/reference/rfc/rfc-template) file includes placeholders for these sections.

## Table of Contents[​](#table-of-contents "Direct link to Table of Contents")

* [RFC-001: Tx Validation](/sdk/next/reference/rfc/rfc-001-tx-validation)
