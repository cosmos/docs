...
* [Store](/sdk/next/reference/spec/store/store) - The core Merkle store that holds the state.
* [Bech32](/sdk/next/build/bech32) - Address format for Cosmos SDK applications.

## Modules specifications[​](#modules-specifications "Direct link to Modules specifications")

Go the [module directory](/sdk/next/build/modules/modules)
