...
* [Store](/sdk/next/build/building-modules/store) - The core Merkle store that holds the state.
* [Bech32](/sdk/next/build/building-modules/bech32) - Address format for Cosmos SDK applications.
