...
In the current Cosmos SDK documentation on the [Object-Capability Model](/sdk/next/build/building-modules/ocap), it is stated that:
...
* [Object-Capability Model](/sdk/next/build/building-modules/ocap)
