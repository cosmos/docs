...
In the current Cosmos SDK documentation on the [Object-Capability Model](/sdk/next/guides/module-design/ocap), it is stated that:
...
* [Object-Capability Model](/sdk/next/guides/module-design/ocap)
