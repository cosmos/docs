...
<Note>To rotate to a post-quantum key, pass `ml_dsa_65` instead of `ed25519` in the command above. See [Migrate a validator to ML-DSA](/sdk/next/keys/migrate-validator-ml-dsa).</Note>
