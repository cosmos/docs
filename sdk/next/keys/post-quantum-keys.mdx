...
- Upgrade first; every flow on this page requires SDK 0.55 and CometBFT 0.40. See the [release notes](/sdk/next/upgrade/v0.55-release).
- Create a post-quantum user account and move funds into it. See [Create an ML-DSA account](/sdk/next/keys/create-ml-dsa-account).
