...
* [Events](#events)
  ...
  * [Handlers](#handlers)
* [Hooks](#hooks)
  * [AfterProposalSubmission](#afterproposalsubmission)
  * [AfterProposalDeposit](#afterproposaldeposit)
  * [AfterProposalVote](#afterproposalvote)
  * [AfterProposalFailedMinDeposit](#afterproposalfailedmindeposit)
  * [AfterProposalVotingPeriodEnded](#afterproposalvotingperiodended)
...
[ADR-037](https://github.com/cosmos/cosmos-sdk/blob/release/v0.55.x/docs/architecture/adr-037-gov-split-vote.md) introduces the weighted vote feature which allows a staker to split their votes into several voting options. For example, it could use 70% of its voting power to vote Yes and 30% of its voting power to vote No.
...
```protobuf
// Reference: https://github.com/cosmos/cosmos-sdk/blob/release/v0.55.x/proto/cosmos/gov/v1beta1/gov.proto#L32-L45
```

```protobuf
// Reference: https://github.com/cosmos/cosmos-sdk/blob/release/v0.55.x/proto/cosmos/gov/v1beta1/gov.proto#L180-L198
```
...
`NoWithVeto` votes.  Note, both of these values are derived from the `Params`
...
```protobuf
// Reference: https://github.com/cosmos/cosmos-sdk/blob/release/v0.55.x/proto/cosmos/gov/v1/gov.proto#L50-L101
```
...
```protobuf
// Reference: https://github.com/cosmos/cosmos-sdk/blob/release/v0.55.x/proto/cosmos/gov/v1/gov.proto#L193-L255
```
...
```protobuf
// Reference: https://github.com/cosmos/cosmos-sdk/blob/release/v0.55.x/proto/cosmos/gov/v1/gov.proto#L37-L48
```
...
tmpValMap(voterAddress).Vote = vote
      ...
      tallyingParam = load(Params, 'TallyingParam')
...
```protobuf
// Reference: https://github.com/cosmos/cosmos-sdk/blob/release/v0.55.x/proto/cosmos/gov/v1/tx.proto#L57-L88
```
...
```protobuf
// Reference: https://github.com/cosmos/cosmos-sdk/blob/release/v0.55.x/proto/cosmos/gov/v1/tx.proto#L153-L166
```
...
```protobuf
// Reference: https://github.com/cosmos/cosmos-sdk/blob/release/v0.55.x/proto/cosmos/gov/v1/tx.proto#L111-L127
```
...
Called after a proposal is submitted. The hook receives the proposal ID and the proposer's address.

**Note:** The `proposerAddr` parameter was added in a recent release. If you are implementing `GovHooks`, you must update your `AfterProposalSubmission` method signature to include `proposerAddr sdk.AccAddress` as a third parameter.
...
Location: off-chain as json object stored on IPFS (mirrors [group proposal](/sdk/latest/modules/group/README#metadata))
...
Location: on-chain as json within 255 character limit (mirrors [group vote](/sdk/latest/modules/group/README#metadata))
