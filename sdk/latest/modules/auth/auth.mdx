...
**Note:** The auth module is different from the [authz module](/sdk/latest/modules/authz/README).
...
See [Vesting](/sdk/latest/modules/auth/auth).
...
The `AnteHandler` can be seen as a set of decorators that check transactions within the current context, per [ADR 010](https://github.com/cosmos/cosmos-sdk/blob/release/v0.55.x/docs/architecture/adr-010-modular-antehandler.md).
...
| SigVerifyCostMlDsa65   | uint64 | 750     |
