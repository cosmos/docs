...
- **[API Reference](/sdk/latest/enterprise/group/api)** - Complete API reference for queries and messages
- **[Architecture](/sdk/latest/enterprise/group/architecture)** - System architecture, core concepts, and module integration details
