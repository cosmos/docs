...
| Module | What it does |
| --- | --- |
| [Permissioned Consensus](/enterprise/components/poa/overview) | Permissioned validator set managed by an on-chain authority, replacing token-based staking |
| [Multi-sig](/enterprise/components/group/overview) | On-chain multisig accounts and collective decision-making with configurable voting policies |
