---
noindex: true
canonical: 'https://docs.cosmos.network/sdk/latest/guides/testing/log'
title: Log v2
---
...
3. `log.NewMultiLogger(...)` fans one log call out to multiple SDK loggers. The SDK uses this during server startup when OpenTelemetry log exporting is enabled. To learn more about how we support OpenTelemetry, read the [Telemetry docs](/sdk/v0.54/guides/testing/telemetry).
