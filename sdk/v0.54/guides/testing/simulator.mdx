---
noindex: true
canonical: 'https://docs.cosmos.network/sdk/latest/guides/testing/simulator'
...
* [Testing in the SDK](/sdk/v0.54/learn/concepts/testing)
...
Operations on the simulation are simulated using the full [transaction cycle](/sdk/v0.54/learn/concepts/lifecycle) of a
