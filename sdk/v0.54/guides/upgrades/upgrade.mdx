---
noindex: true
canonical: 'https://docs.cosmos.network/sdk/latest/guides/upgrades/upgrade'
...
See the [Cosmovisor](/sdk/v0.54/guides/upgrades/cosmovisor) guide for setup and configuration.
