---
noindex: true
canonical: 'https://docs.cosmos.network/sdk/latest/guides/state/store'
title: Module Store Internals
---
...
The bulk of the store interfaces are defined [here](https://github.com/cosmos/cosmos-sdk/blob/release/v0.54.x/store/types/store.go),
...
```text
rootmulti.Store -> cachemulti.Store -> gaskv.Store -> cachekv.Store -> iavl.Store
```
