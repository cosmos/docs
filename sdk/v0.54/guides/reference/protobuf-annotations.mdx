---
noindex: true
canonical: 'https://docs.cosmos.network/sdk/latest/guides/reference/protobuf-annotations'
...
Read more about the signer field [here](/sdk/v0.54/learn/concepts/encoding#message-signers).
