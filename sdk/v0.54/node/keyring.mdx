---
noindex: true
canonical: 'https://docs.cosmos.network/sdk/latest/node/keyring'
...
If you are running through this tutorial as a test, continue to [Run a node](/sdk/v0.54/node/run-node) to initialize your blockchain and start your node.
