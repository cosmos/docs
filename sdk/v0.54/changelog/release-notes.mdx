...
<Info>
  This page tracks releases and changes for v0.54.2. For the full release history, see the [CHANGELOG](https://github.com/cosmos/cosmos-sdk/blob/main/CHANGELOG.md) on GitHub.
</Info>

<Update label="2026-04-15" description="v0.54.2" tags={["SDK", "Release"]}>
