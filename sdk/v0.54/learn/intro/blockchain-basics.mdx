---
noindex: true
canonical: 'https://docs.cosmos.network/sdk/latest/learn/intro/blockchain-basics'
...
In [Blockchain Architecture](/sdk/v0.54/learn/intro/sdk-app-architecture), you'll explore:
