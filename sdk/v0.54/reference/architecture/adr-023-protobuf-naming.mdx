---
noindex: true
canonical: 'https://docs.cosmos.network/sdk/latest/reference/architecture/adr-023-protobuf-naming'
...
In [ADR 021](/sdk/v0.54/reference/architecture/adr-021-protobuf-query-encoding), gRPC was adopted for Protobuf
...
[ADR 021](/sdk/v0.54/reference/architecture/adr-021-protobuf-query-encoding) specifies that modules should
