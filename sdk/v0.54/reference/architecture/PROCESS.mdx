---
noindex: true
canonical: 'https://docs.cosmos.network/sdk/latest/reference/architecture/PROCESS'
...
4. Add an entry to the list in the [README](/sdk/v0.54/reference/architecture/README) file.
