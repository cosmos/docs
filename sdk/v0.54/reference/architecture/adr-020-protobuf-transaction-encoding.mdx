---
noindex: true
canonical: 'https://docs.cosmos.network/sdk/latest/reference/architecture/adr-020-protobuf-transaction-encoding'
...
Since interface values are encoded with `google.protobuf.Any` in state (see [ADR 019](/sdk/v0.54/reference/architecture/adr-019-protobuf-state-encoding)),
