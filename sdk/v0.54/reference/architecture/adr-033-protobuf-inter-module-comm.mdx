---
noindex: true
canonical: 'https://docs.cosmos.network/sdk/latest/reference/architecture/adr-033-protobuf-inter-module-comm'
...
In the current Cosmos SDK documentation on the [Object-Capability Model](/sdk/v0.54/guides/module-design/ocap), it is stated that:
...
* [Object-Capability Model](/sdk/v0.54/guides/module-design/ocap)
