---
noindex: true
canonical: 'https://docs.cosmos.network/sdk/latest/reference/architecture/adr-040-storage-and-smt-state-commitments'
...
Most of the alternative designs were evaluated in a prior state commitments and storage report.
