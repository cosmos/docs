---
noindex: true
canonical: 'https://docs.cosmos.network/sdk/latest/reference/architecture/adr-064-abci-2.0'
...
SDK outlined in [ADR 060: ABCI 1.0 (Phase I)](/sdk/v0.54/reference/architecture/adr-060-abci-1.0).
