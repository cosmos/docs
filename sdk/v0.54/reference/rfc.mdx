---
noindex: true
canonical: 'https://docs.cosmos.network/sdk/latest/reference/rfc'
...
* [RFC-001: Tx Validation](/sdk/v0.54/reference/rfc/rfc-001-tx-validation)
