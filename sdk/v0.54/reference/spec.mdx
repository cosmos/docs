---
noindex: true
canonical: 'https://docs.cosmos.network/sdk/latest/reference/spec'
...
* [Store](/sdk/v0.54/guides/state/store) - The core Merkle store that holds the state.
* [Bech32](/sdk/v0.54/guides/reference/bech32) - Address format for Cosmos SDK applications.

## Modules specifications[​](#modules-specifications "Direct link to Modules specifications")

Go the [module directory](/sdk/v0.54/modules/modules)
