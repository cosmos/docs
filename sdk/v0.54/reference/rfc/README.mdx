---
noindex: true
canonical: 'https://docs.cosmos.network/sdk/latest/reference/rfc/README'
...
[Architecture Decision Records (ADR)](/sdk/v0.54/reference/architecture/README).
...
The `rfc-template.md` file includes placeholders for these
sections.
