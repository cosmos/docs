---
noindex: true
canonical: 'https://docs.cosmos.network/sdk/latest/modules/authz/README'
title: 'x/authz'
---
...
**Note:** The authz module is different from the [auth (authentication)](/sdk/v0.54/modules/auth/auth/) module that is responsible for specifying the base transaction and account types.
