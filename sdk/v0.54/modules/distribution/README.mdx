---
noindex: true
canonical: 'https://docs.cosmos.network/sdk/latest/modules/distribution/README'
...
external community pool maintained by the Cosmos SDK is [`x/protocolpool`](/sdk/v0.54/modules/protocolpool/README).
