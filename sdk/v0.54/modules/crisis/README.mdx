---
noindex: true
canonical: 'https://docs.cosmos.network/sdk/latest/modules/crisis/README'
title: 'x/crisis'
description: >-
...
<Warning>
`x/crisis` has been moved to [`./contrib/x/crisis`](https://github.com/cosmos/cosmos-sdk/tree/main/contrib/x/crisis) and is no longer actively maintained as part of the core Cosmos SDK. It is still available for use but is not included in the SDK Bug Bounty program. The module was moved because it never worked as intended.
</Warning>
