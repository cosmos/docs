---
noindex: true
canonical: 'https://docs.cosmos.network/sdk/latest/modules/evidence/README'
title: 'x/evidence'
...
on slashing and jailing in [State Transitions](/sdk/v0.54/modules/staking/README#state-transitions).
