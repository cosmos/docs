---
noindex: true
canonical: 'https://docs.cosmos.network/sdk/latest/modules/genutil/README'
title: 'x/genutil'
description: >-
...
Add a genesis account to `genesis.json`. Learn more [here](/sdk/v0.54/node/run-node#adding-genesis-accounts).
