---
noindex: true
canonical: 'https://docs.cosmos.network/sdk/latest/modules/auth/auth'
title: 'x/auth'
...
**Note:** The auth module is different from the [authz module](/sdk/v0.54/modules/authz/README).
...
See [Vesting](/sdk/v0.54/modules/auth/auth).
