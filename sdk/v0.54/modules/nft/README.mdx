---
noindex: true
canonical: 'https://docs.cosmos.network/sdk/latest/modules/nft/README'
title: 'x/nft'
description: '## Abstract'
---

<Warning>
`x/nft` has been moved to [`./contrib/x/nft`](https://github.com/cosmos/cosmos-sdk/tree/main/contrib/x/nft) and is no longer actively maintained as part of the core Cosmos SDK. It is still available for use but is not included in the SDK Bug Bounty program. It was moved because it was never widely adopted.
</Warning>
