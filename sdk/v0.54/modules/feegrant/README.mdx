---
noindex: true
canonical: 'https://docs.cosmos.network/sdk/latest/modules/feegrant/README'
title: 'x/feegrant'
description: >-
...
Fees are deducted from grants in the `x/auth` ante handler. To learn more about how ante handlers work, read the [Auth Module AnteHandlers Guide](/sdk/v0.54/modules/auth/auth#antehandlers).
