...
<CardGroup cols={2}>
  <Card title="Permissioned consensus" icon="graduation-cap" href="/sdk/v0.54/enterprise/poa/overview">
  ...
  <Card title="Multi-sig" icon="users" href="/sdk/v0.54/enterprise/group/overview">
