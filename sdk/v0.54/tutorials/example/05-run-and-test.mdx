...
Once the chain is running, these are the core [CLI](/sdk/v0.54/learn/concepts/cli-grpc-rest#cli) commands you'll use to inspect state and submit transactions.
...
Start here when you want fast feedback on module logic without running a chain. These tests isolate the [keeper](/sdk/v0.54/learn/concepts/testing#keeper-unit-tests) and gRPC servers from the rest of the app.
...
Run [E2E tests](/sdk/v0.54/learn/concepts/testing#integration-tests) when you want to verify the full request path against a real node. They give you higher confidence than unit tests, but take longer to complete.
