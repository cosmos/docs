---
noindex: true
canonical: 'https://docs.cosmos.network/sdk/latest/security/security-policy'
...
The canonical source of truth for release family lifecycle, active support windows, and retirement policy is the [Release Families](/sdk/v0.54/release-family) page.
...
- **Lifecycle and Retirement:** Lifecycle windows and retirement details are maintained on the [Release Families](/sdk/v0.54/release-family) page.
...
Current and historical EOL notices for release families are maintained on the [Release Families](/sdk/v0.54/release-family) page to keep lifecycle policy centralized in one place.
